...
801000e4:	e8 17 4f 00 00       	call   80105000 <acquire>
...
801001be:	e8 1d 4c 00 00       	call   80104de0 <holdingsleep>
...
801001ff:	e8 dc 4b 00 00       	call   80104de0 <holdingsleep>
...
8010020f:	e8 8c 4b 00 00       	call   80104da0 <releasesleep>

  acquire(&bcache.lock);
80100214:	c7 04 24 20 b5 10 80 	movl   $0x8010b520,(%esp)
8010021b:	e8 e0 4d 00 00       	call   80105000 <acquire>
  b->refcnt--;
...
8010026b:	5d                   	pop    %ebp
  release(&bcache.lock);
8010026c:	e9 2f 4d 00 00       	jmp    80104fa0 <release>
    panic("brelse");
...
801002a0:	e8 5b 4d 00 00       	call   80105000 <acquire>
  while(n > 0){
...
801002f6:	e8 a5 4c 00 00       	call   80104fa0 <release>
        ilock(ip);
801002fb:	5a                   	pop    %edx
...
8010034c:	e8 4f 4c 00 00       	call   80104fa0 <release>
  ilock(ip);
80100351:	58                   	pop    %eax
...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 94 83 10 80 	movl   $0x80108394,(%esp)
...
801003c8:	e8 83 4a 00 00       	call   80104e50 <getcallerpcs>
  for(i=0; i<10; i++)
...
8010041a:	e8 e1 64 00 00       	call   80106900 <uartputc>
...
80100505:	e8 f6 63 00 00       	call   80106900 <uartputc>
8010050a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100511:	e8 ea 63 00 00       	call   80106900 <uartputc>
80100516:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010051d:	e8 de 63 00 00       	call   80106900 <uartputc>
...
80100551:	e8 0a 4c 00 00       	call   80105160 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100566:	e8 55 4b 00 00       	call   801050c0 <memset>
  outb(CRTPORT+1, pos);
...
801005ab:	e8 50 4a 00 00       	call   80105000 <acquire>
  for(i = 0; i < n; i++)
...
801005e4:	e8 b7 49 00 00       	call   80104fa0 <release>
  ilock(ip);
801005e9:	58                   	pop    %eax
...
801007e8:	e8 13 48 00 00       	call   80105000 <acquire>
...
8010085b:	e8 40 47 00 00       	call   80104fa0 <release>
...
80100893:	e8 68 47 00 00       	call   80105000 <acquire>
  while((c = getc()) >= 0){
...
801009d0:	e8 cb 45 00 00       	call   80104fa0 <release>
  if(doprocdump) {
...
80100a70:	e8 bb 43 00 00       	call   80104e30 <initlock>
...
80100b32:	75 d2                	jne    80100b06 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100b34:	e8 57 6f 00 00       	call   80107a90 <setupkvm>
...
80100ba3:	e8 08 6d 00 00       	call   801078b0 <allocuvm>
...
80100bd9:	e8 e2 6b 00 00       	call   801077c0 <loaduvm>
...
80100c1b:	e8 f0 6d 00 00       	call   80107a10 <freevm>
  if(ip){
...
80100c62:	e8 49 6c 00 00       	call   801078b0 <allocuvm>
...
80100c81:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c83:	e8 a8 6e 00 00       	call   80107b30 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cd3:	e8 e8 45 00 00       	call   801052c0 <strlen>
...
80100ce4:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100ce7:	e8 d4 45 00 00       	call   801052c0 <strlen>
...
80100cf8:	e8 03 70 00 00       	call   80107d00 <copyout>
...
80100d11:	e8 fa 6c 00 00       	call   80107a10 <freevm>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 98 6f 00 00       	call   80107d00 <copyout>
...
80100da1:	e8 da 44 00 00       	call   80105280 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100dcd:	e8 5e 68 00 00       	call   80107630 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 36 6c 00 00       	call   80107a10 <freevm>
  return 0;
...
80100e20:	e8 0b 40 00 00       	call   80104e30 <initlock>
}
...
80100e41:	e8 ba 41 00 00       	call   80105000 <acquire>
...
80100e71:	e8 2a 41 00 00       	call   80104fa0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 11 41 00 00       	call   80104fa0 <release>
}
...
80100eaf:	e8 4c 41 00 00       	call   80105000 <acquire>
  if(f->ref < 1)
...
80100ecc:	e8 cf 40 00 00       	call   80104fa0 <release>
  return f;
}
...
80100f01:	e8 fa 40 00 00       	call   80105000 <acquire>
  if(f->ref < 1)
...
80100f39:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f3c:	e8 5f 40 00 00       	call   80104fa0 <release>
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 2d 40 00 00       	jmp    80104fa0 <release>
...
80101325:	e8 96 3d 00 00       	call   801050c0 <memset>
  log_write(bp);
...
8010136a:	e8 91 3c 00 00       	call   80105000 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013d7:	e8 c4 3b 00 00       	call   80104fa0 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 96 3b 00 00       	call   80104fa0 <release>
      return ip;
...
80101541:	e8 1a 3c 00 00       	call   80105160 <memmove>
  brelse(bp);
...
80101576:	e8 b5 38 00 00       	call   80104e30 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 6c 37 00 00       	call   80104d00 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 9f 3b 00 00       	call   80105160 <memmove>
  brelse(bp);
...
8010168e:	e8 2d 3a 00 00       	call   801050c0 <memset>
      dip->type = type;
...
80101731:	e8 2a 3a 00 00       	call   80105160 <memmove>
  log_write(bp);
...
8010175f:	e8 9c 38 00 00       	call   80105000 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010176f:	e8 2c 38 00 00       	call   80104fa0 <release>
}
...
801017a2:	e8 99 35 00 00       	call   80104d40 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 43 39 00 00       	call   80105160 <memmove>
    brelse(bp);
...
80101873:	e8 68 35 00 00       	call   80104de0 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 0c 35 00 00       	jmp    80104da0 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 7b 34 00 00       	call   80104d40 <acquiresleep>
...
801018da:	e8 c1 34 00 00       	call   80104da0 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
801018e6:	e8 15 37 00 00       	call   80105000 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 9b 36 00 00       	jmp    80104fa0 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 09 11 80       	push   $0x80110960
80101910:	e8 eb 36 00 00       	call   80105000 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010191f:	e8 7c 36 00 00       	call   80104fa0 <release>
    if(r == 1){
...
80101a23:	e8 b8 33 00 00       	call   80104de0 <holdingsleep>
...
80101a3a:	e8 61 33 00 00       	call   80104da0 <releasesleep>
  iput(ip);
...
80101b37:	e8 24 36 00 00       	call   80105160 <memmove>
    brelse(bp);
...
80101c33:	e8 28 35 00 00       	call   80105160 <memmove>
    log_write(bp);
...
80101cce:	e8 fd 34 00 00       	call   801051d0 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 9e 34 00 00       	call   801051d0 <strncmp>
      continue;
...
80101dba:	e8 41 32 00 00       	call   80105000 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
80101dca:	e8 d1 31 00 00       	call   80104fa0 <release>
...
80101e27:	e8 34 33 00 00       	call   80105160 <memmove>
...
80101e8c:	e8 4f 2f 00 00       	call   80104de0 <holdingsleep>
...
80101eae:	e8 ed 2e 00 00       	call   80104da0 <releasesleep>
  iput(ip);
...
80101edb:	e8 80 32 00 00       	call   80105160 <memmove>
    name[len] = 0;
...
80101f2b:	e8 b0 2e 00 00       	call   80104de0 <holdingsleep>
...
80101f4a:	e8 51 2e 00 00       	call   80104da0 <releasesleep>
  iput(ip);
...
80101f6d:	e8 6e 2e 00 00       	call   80104de0 <holdingsleep>
...
80101f90:	e8 4b 2e 00 00       	call   80104de0 <holdingsleep>
...
80101fa7:	e8 f4 2d 00 00       	call   80104da0 <releasesleep>
}
...
8010203d:	e8 de 31 00 00       	call   80105220 <strncpy>
...
80102088:	68 e2 85 10 80       	push   $0x801085e2
...
801021d0:	e8 5b 2c 00 00       	call   80104e30 <initlock>
...
8010224e:	e8 ad 2d 00 00       	call   80105000 <acquire>
...
801022cb:	e8 d0 2c 00 00       	call   80104fa0 <release>
...
801022ee:	e8 ed 2a 00 00       	call   80104de0 <holdingsleep>
...
80102328:	e8 d3 2c 00 00       	call   80105000 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 15 2c 00 00       	jmp    80104fa0 <release>
...
801024f2:	e8 c9 2b 00 00       	call   801050c0 <memset>
...
80102528:	e8 d3 2a 00 00       	call   80105000 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 58 2a 00 00       	jmp    80104fa0 <release>
    panic("kfree");
...
80102625:	e8 06 28 00 00       	call   80104e30 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 48 29 00 00       	call   80105000 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 ba 28 00 00       	call   80104fa0 <release>
  return (char*)r;
...
80102af7:	e8 14 26 00 00       	call   80105110 <memcmp>
...
80102c24:	e8 37 25 00 00       	call   80105160 <memmove>
...
80102cd4:	e8 57 21 00 00       	call   80104e30 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 90 22 00 00       	call   80105000 <acquire>
...
80102dbc:	e8 df 21 00 00       	call   80104fa0 <release>
      break;
    }
  }
}
...
80102dde:	e8 1d 22 00 00       	call   80105000 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 7f 21 00 00       	call   80104fa0 <release>
}
...
80102e36:	e8 c5 21 00 00       	call   80105000 <acquire>
    wakeup(&log);
...
80102e58:	e8 43 21 00 00       	call   80104fa0 <release>
...
80102eb4:	e8 a7 22 00 00       	call   80105160 <memmove>
...
80102f14:	e8 87 20 00 00       	call   80104fa0 <release>
...
80102f76:	e8 85 20 00 00       	call   80105000 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 e6 1f 00 00       	jmp    80104fa0 <release>
...
80103022:	e8 a9 34 00 00       	call   801064d0 <idtinit>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 d5 45 00 00       	call   80107620 <switchkvm>
  seginit();
8010304b:	e8 40 45 00 00       	call   80107590 <seginit>
  lapicinit();
...
80103081:	e8 8a 4a 00 00       	call   80107b10 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 fb 44 00 00       	call   80107590 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 77 37 00 00       	call   80106820 <uartinit>
  pinit();         // process table
801030a9:	e8 d2 0a 00 00       	call   80103b80 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 7d 33 00 00       	call   80106430 <tvinit>
  binit();         // buffer cache
...
801030d4:	e8 87 20 00 00       	call   80105160 <memmove>
...
801031c4:	e8 47 1f 00 00       	call   80105110 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 8c 1e 00 00       	call   80105110 <memcmp>
...
801033c8:	e8 43 1d 00 00       	call   80105110 <memcmp>
...
801034a9:	e8 82 19 00 00       	call   80104e30 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 bc 1a 00 00       	call   80105000 <acquire>
  if(writable){
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 17 1a 00 00       	jmp    80104fa0 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 07 1a 00 00       	call   80104fa0 <release>
    kfree((char*)p);
...
801035dd:	e8 1e 1a 00 00       	call   80105000 <acquire>
  for(i = 0; i < n; i++){
...
8010366c:	e8 2f 19 00 00       	call   80104fa0 <release>
        return -1;
...
801036c2:	e8 d9 18 00 00       	call   80104fa0 <release>
  return n;
...
801036e6:	e8 15 19 00 00       	call   80105000 <acquire>
...
8010377e:	e8 1d 18 00 00       	call   80104fa0 <release>
  return i;
...
80103799:	e8 02 18 00 00       	call   80104fa0 <release>
      return -1;
...
801037c1:	e8 3a 18 00 00       	call   80105000 <acquire>
...
80103828:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
8010382e:	e8 6d 17 00 00       	call   80104fa0 <release>
...
80103850:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103853:	c7 40 14 17 64 10 80 	movl   $0x80106417,0x14(%eax)
  p->context = (struct context*)sp;
...
80103862:	e8 59 18 00 00       	call   801050c0 <memset>
...
8010388a:	e8 11 17 00 00       	call   80104fa0 <release>
}
...
801038bb:	e8 e0 16 00 00       	call   80104fa0 <release>
...
801039a1:	68 80 83 10 80       	push   $0x80108380
...
801039d0:	68 78 84 10 80       	push   $0x80108478
...
801039e3:	7d db                	jge    801039c0 <printq+0x30>
  cprintf("end\n\n");
801039e5:	c7 45 08 90 83 10 80 	movl   $0x80108390,0x8(%ebp)
}
...
80103b86:	68 96 83 10 80       	push   $0x80108396
80103b8b:	68 20 2d 11 80       	push   $0x80112d20
80103b90:	e8 9b 12 00 00       	call   80104e30 <initlock>
}
...
80103c24:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103c27:	e8 84 12 00 00       	call   80104eb0 <pushcli>
  c = mycpu();
80103c2c:	e8 6f ff ff ff       	call   80103ba0 <mycpu>
  p = c->proc;
80103c31:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c37:	e8 c4 12 00 00       	call   80104f00 <popcli>
}
...
80103cc7:	e8 c4 3d 00 00       	call   80107a90 <setupkvm>
...
80103ce5:	e8 56 3a 00 00       	call   80107740 <inituvm>
...
80103cfa:	e8 c1 13 00 00       	call   801050c0 <memset>
...
80103d53:	68 c6 83 10 80       	push   $0x801083c6
80103d58:	50                   	push   %eax
80103d59:	e8 22 15 00 00       	call   80105280 <safestrcpy>
  p->cwd = namei("/");
80103d5e:	c7 04 24 cf 83 10 80 	movl   $0x801083cf,(%esp)
...
80103d74:	e8 87 12 00 00       	call   80105000 <acquire>
  p->state = RUNNABLE;
...
80103da5:	e8 f6 11 00 00       	call   80104fa0 <release>
}
...
80103db5:	68 ad 83 10 80       	push   $0x801083ad
...
80103dc5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103dc8:	e8 e3 10 00 00       	call   80104eb0 <pushcli>
  c = mycpu();
80103dcd:	e8 ce fd ff ff       	call   80103ba0 <mycpu>
  p = c->proc;
80103dd2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103dd8:	e8 23 11 00 00       	call   80104f00 <popcli>
  sz = curproc->sz;
...
80103deb:	e8 40 38 00 00       	call   80107630 <switchuvm>
  return 0;
...
80103e0a:	e8 a1 3a 00 00       	call   801078b0 <allocuvm>
...
80103e2a:	e8 b1 3b 00 00       	call   801079e0 <deallocuvm>
...
80103e46:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103e49:	e8 62 10 00 00       	call   80104eb0 <pushcli>
  c = mycpu();
80103e4e:	e8 4d fd ff ff       	call   80103ba0 <mycpu>
  p = c->proc;
80103e53:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e59:	e8 a2 10 00 00       	call   80104f00 <popcli>
  if((np = allocproc()) == 0){
...
80103e78:	e8 03 3d 00 00       	call   80107b80 <copyuvm>
...
80103ef1:	e8 8a 13 00 00       	call   80105280 <safestrcpy>
  pid = np->pid;
80103ef6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103ef9:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103f00:	e8 fb 10 00 00       	call   80105000 <acquire>
  np->state = RUNNABLE;
...
80103f31:	e8 6a 10 00 00       	call   80104fa0 <release>
  return pid;
...
80104092:	e8 69 0f 00 00       	call   80105000 <acquire>
  ticks = 0;
  release(&tickslock);
...
801040c9:	e8 32 0f 00 00       	call   80105000 <acquire>
    if(monopoly){
...
80104110:	e8 1b 35 00 00       	call   80107630 <switchuvm>
  p->state = RUNNING;
...
80104125:	e8 b1 11 00 00       	call   801052db <swtch>
  switchkvm();
8010412a:	e8 f1 34 00 00       	call   80107620 <switchkvm>
      if(!moq.size)
...
801041a1:	e8 8a 34 00 00       	call   80107630 <switchuvm>
  p->state = RUNNING;
...
801041b6:	e8 20 11 00 00       	call   801052db <swtch>
  switchkvm();
801041bb:	e8 60 34 00 00       	call   80107620 <switchkvm>
}
...
801041e9:	e8 42 34 00 00       	call   80107630 <switchuvm>
  p->state = RUNNING;
...
801041fe:	e8 d8 10 00 00       	call   801052db <swtch>
  switchkvm();
80104203:	e8 18 34 00 00       	call   80107620 <switchkvm>
}
...
80104283:	e8 53 10 00 00       	call   801052db <swtch>
  mycpu()->intena = intena;
...
8010434a:	e8 b1 0c 00 00       	call   80105000 <acquire>
...
801043f7:	68 1e 84 10 80       	push   $0x8010841e
801043fc:	e8 7f bf ff ff       	call   80100380 <panic>
    panic("init exiting");
80104401:	83 ec 0c             	sub    $0xc,%esp
80104404:	68 11 84 10 80       	push   $0x80108411
...
80104414:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104417:	e8 94 0a 00 00       	call   80104eb0 <pushcli>
  c = mycpu();
8010441c:	e8 7f f7 ff ff       	call   80103ba0 <mycpu>
  p = c->proc;
80104421:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104427:	e8 d4 0a 00 00       	call   80104f00 <popcli>
  level = p->level;
...
80104551:	0f 85 8f 00 00 00    	jne    801045e6 <wait+0x106>
  pushcli();
80104557:	e8 54 09 00 00       	call   80104eb0 <pushcli>
  c = mycpu();
8010455c:	e8 3f f6 ff ff       	call   80103ba0 <mycpu>
  p = c->proc;
80104561:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104567:	e8 94 09 00 00       	call   80104f00 <popcli>
  if(p == 0)
...
801045a9:	e8 62 34 00 00       	call   80107a10 <freevm>
        p->pid = 0;
...
801045d5:	e8 c6 09 00 00       	call   80104fa0 <release>
        return pid;
...
8010461c:	e8 df 09 00 00       	call   80105000 <acquire>
  pushcli();
80104621:	e8 8a 08 00 00       	call   80104eb0 <pushcli>
  c = mycpu();
80104626:	e8 75 f5 ff ff       	call   80103ba0 <mycpu>
  p = c->proc;
8010462b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104631:	e8 ca 08 00 00       	call   80104f00 <popcli>
...
80104647:	74 57                	je     801046a0 <yield+0x90>
  pushcli();
80104649:	e8 62 08 00 00       	call   80104eb0 <pushcli>
  c = mycpu();
8010464e:	e8 4d f5 ff ff       	call   80103ba0 <mycpu>
  p = c->proc;
80104653:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104659:	e8 a2 08 00 00       	call   80104f00 <popcli>
  enqueue(&mlfq[p->level], p);
...
80104692:	e8 09 09 00 00       	call   80104fa0 <release>
}
...
801046bc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
801046bf:	e8 ec 07 00 00       	call   80104eb0 <pushcli>
  c = mycpu();
801046c4:	e8 d7 f4 ff ff       	call   80103ba0 <mycpu>
  p = c->proc;
801046c9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801046cf:	e8 2c 08 00 00       	call   80104f00 <popcli>
  if(p == 0)
...
801046f0:	e8 0b 09 00 00       	call   80105000 <acquire>
    release(lk);
801046f5:	89 34 24             	mov    %esi,(%esp)
801046f8:	e8 a3 08 00 00       	call   80104fa0 <release>
  p->chan = chan;
...
8010471a:	e8 81 08 00 00       	call   80104fa0 <release>
    acquire(lk);
...
8010472b:	5d                   	pop    %ebp
    acquire(lk);
8010472c:	e9 cf 08 00 00       	jmp    80105000 <acquire>
...
80104759:	68 30 84 10 80       	push   $0x80108430
8010475e:	e8 1d bc ff ff       	call   80100380 <panic>
    panic("sleep");
80104763:	83 ec 0c             	sub    $0xc,%esp
80104766:	68 2a 84 10 80       	push   $0x8010842a
...
8010477f:	e8 7c 08 00 00       	call   80105000 <acquire>
...
801047c4:	c9                   	leave  
  release(&ptable.lock);
801047c5:	e9 d6 07 00 00       	jmp    80104fa0 <release>
...
801047df:	e8 1c 08 00 00       	call   80105000 <acquire>
...
8010481d:	e8 7e 07 00 00       	call   80104fa0 <release>
}
...
80104838:	e8 63 07 00 00       	call   80104fa0 <release>
}
...
8010486b:	68 94 83 10 80       	push   $0x80108394
...
8010488f:	74 e7                	je     80104878 <procdump+0x28>
      state = "???";
80104891:	ba 41 84 10 80       	mov    $0x80108441,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104896:	83 f8 05             	cmp    $0x5,%eax
80104899:	77 11                	ja     801048ac <procdump+0x5c>
8010489b:	8b 14 85 c4 84 10 80 	mov    -0x7fef7b3c(,%eax,4),%edx
      state = "???";
801048a2:	b8 41 84 10 80       	mov    $0x80108441,%eax
...
801048b1:	68 45 84 10 80       	push   $0x80108445
...
801048d8:	e8 73 05 00 00       	call   80104e50 <getcallerpcs>
...
801048ed:	68 81 7e 10 80       	push   $0x80107e81
...
8010491c:	e8 df 06 00 00       	call   80105000 <acquire>
  pushcli();
80104921:	e8 8a 05 00 00       	call   80104eb0 <pushcli>
  c = mycpu();
80104926:	e8 75 f2 ff ff       	call   80103ba0 <mycpu>
  p = c->proc;
8010492b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104931:	e8 ca 05 00 00       	call   80104f00 <popcli>
  if (p->level == 99){
...
80104959:	e8 42 06 00 00       	call   80104fa0 <release>
}
...
80104988:	75 c7                	jne    80104951 <proctimer+0x41>
  pushcli();
8010498a:	e8 21 05 00 00       	call   80104eb0 <pushcli>
  c = mycpu();
8010498f:	e8 0c f2 ff ff       	call   80103ba0 <mycpu>
  p = c->proc;
80104994:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010499a:	e8 61 05 00 00       	call   80104f00 <popcli>
  enqueue(&mlfq[p->level], p);
...
801049e1:	e8 1a 06 00 00       	call   80105000 <acquire>
  if (monopoly){
...
80104a9e:	e8 fd 04 00 00       	call   80104fa0 <release>
}
...
80104abc:	e8 3f 05 00 00       	call   80105000 <acquire>
  pushcli();
80104ac1:	e8 ea 03 00 00       	call   80104eb0 <pushcli>
  c = mycpu();
80104ac6:	e8 d5 f0 ff ff       	call   80103ba0 <mycpu>
  p = c->proc;
80104acb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104ad1:	e8 2a 04 00 00       	call   80104f00 <popcli>
  level = myproc()->level;
80104ad6:	8b 5b 7c             	mov    0x7c(%ebx),%ebx
  release(&ptable.lock);
80104ad9:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104ae0:	e8 bb 04 00 00       	call   80104fa0 <release>
}
...
80104b08:	e8 f3 04 00 00       	call   80105000 <acquire>
...
80104b3f:	e8 5c 04 00 00       	call   80104fa0 <release>
      return 0;
...
80104b58:	e8 43 04 00 00       	call   80104fa0 <release>
  return -1;
...
80104b90:	e8 6b 04 00 00       	call   80105000 <acquire>
  pushcli();
80104b95:	e8 16 03 00 00       	call   80104eb0 <pushcli>
  c = mycpu();
80104b9a:	e8 01 f0 ff ff       	call   80103ba0 <mycpu>
  p = c->proc;
80104b9f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104ba5:	e8 56 03 00 00       	call   80104f00 <popcli>
  if (pid == myproc()->pid){
80104baa:	83 c4 10             	add    $0x10,%esp
80104bad:	39 5e 10             	cmp    %ebx,0x10(%esi)
80104bb0:	0f 84 a8 00 00 00    	je     80104c5e <setmonopoly+0xde>
  if (password != studentid){
80104bb6:	81 7d 0c 10 00 77 78 	cmpl   $0x78770010,0xc(%ebp)
80104bbd:	75 71                	jne    80104c30 <setmonopoly+0xb0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104c10:	e8 eb ed ff ff       	call   80103a00 <enqueue>
    release(&ptable.lock);
80104c15:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104c1c:	e8 7f 03 00 00       	call   80104fa0 <release>
    return moq.size;
80104c21:	a1 64 51 11 80       	mov    0x80115164,%eax
...
80104c33:	68 20 2d 11 80       	push   $0x80112d20
80104c38:	e8 63 03 00 00       	call   80104fa0 <release>
    return -2;
80104c3d:	83 c4 10             	add    $0x10,%esp
80104c40:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
80104c45:	eb e2                	jmp    80104c29 <setmonopoly+0xa9>
      release(&ptable.lock);
80104c47:	83 ec 0c             	sub    $0xc,%esp
80104c4a:	68 20 2d 11 80       	push   $0x80112d20
80104c4f:	e8 4c 03 00 00       	call   80104fa0 <release>
      return -3;
80104c54:	83 c4 10             	add    $0x10,%esp
80104c57:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
80104c5c:	eb cb                	jmp    80104c29 <setmonopoly+0xa9>
    release(&ptable.lock);
80104c5e:	83 ec 0c             	sub    $0xc,%esp
80104c61:	68 20 2d 11 80       	push   $0x80112d20
80104c66:	e8 35 03 00 00       	call   80104fa0 <release>
    return -4;
80104c6b:	83 c4 10             	add    $0x10,%esp
80104c6e:	b8 fc ff ff ff       	mov    $0xfffffffc,%eax
80104c73:	eb b4                	jmp    80104c29 <setmonopoly+0xa9>
80104c75:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80104c83:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);
80104c86:	68 20 2d 11 80       	push   $0x80112d20
80104c8b:	e8 70 03 00 00       	call   80105000 <acquire>
  release(&ptable.lock);
80104c90:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  monopoly = 1;
80104c97:	c7 05 54 50 11 80 01 	movl   $0x1,0x80115054
80104c9e:	00 00 00 
  release(&ptable.lock);
80104ca1:	e8 fa 02 00 00       	call   80104fa0 <release>
}
...
80104cbb:	e8 40 03 00 00       	call   80105000 <acquire>
  acquire(&tickslock);
80104cc0:	c7 04 24 00 56 11 80 	movl   $0x80115600,(%esp)
  monopoly = 0;
80104cc7:	c7 05 54 50 11 80 00 	movl   $0x0,0x80115054
80104cce:	00 00 00 
  acquire(&tickslock);
80104cd1:	e8 2a 03 00 00       	call   80105000 <acquire>
  release(&tickslock);
80104cd6:	c7 04 24 00 56 11 80 	movl   $0x80115600,(%esp)
  ticks = 0;
80104cdd:	c7 05 e0 55 11 80 00 	movl   $0x0,0x801155e0
80104ce4:	00 00 00 
  release(&tickslock);
80104ce7:	e8 b4 02 00 00       	call   80104fa0 <release>
  unmonopolize1();
  acquire(&ptable.lock);
80104cec:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104cf3:	e8 08 03 00 00       	call   80105000 <acquire>
...
80104d0a:	68 dc 84 10 80       	push   $0x801084dc
...
80104d4f:	e8 ac 02 00 00       	call   80105000 <acquire>
  while (lk->locked) {
...
80104d65:	e8 46 f9 ff ff       	call   801046b0 <sleep>
  while (lk->locked) {
...
80104d73:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104d79:	e8 a2 ee ff ff       	call   80103c20 <myproc>
...
80104d8c:	5d                   	pop    %ebp
  release(&lk->lk);
80104d8d:	e9 0e 02 00 00       	jmp    80104fa0 <release>
...
80104da5:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80104da8:	8d 73 04             	lea    0x4(%ebx),%esi
80104dab:	83 ec 0c             	sub    $0xc,%esp
80104dae:	56                   	push   %esi
80104daf:	e8 4c 02 00 00       	call   80105000 <acquire>
  lk->locked = 0;
...
80104dc4:	e8 a7 f9 ff ff       	call   80104770 <wakeup>
  release(&lk->lk);
...
80104dd4:	5d                   	pop    %ebp
  release(&lk->lk);
80104dd5:	e9 c6 01 00 00       	jmp    80104fa0 <release>
...
80104df2:	e8 09 02 00 00       	call   80105000 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104df7:	8b 03                	mov    (%ebx),%eax
80104df9:	83 c4 10             	add    $0x10,%esp
80104dfc:	85 c0                	test   %eax,%eax
80104dfe:	75 18                	jne    80104e18 <holdingsleep+0x38>
  release(&lk->lk);
80104e00:	83 ec 0c             	sub    $0xc,%esp
80104e03:	56                   	push   %esi
80104e04:	e8 97 01 00 00       	call   80104fa0 <release>
  return r;
}
80104e09:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104e0c:	89 f8                	mov    %edi,%eax
80104e0e:	5b                   	pop    %ebx
80104e0f:	5e                   	pop    %esi
80104e10:	5f                   	pop    %edi
80104e11:	5d                   	pop    %ebp
...
80104e17:	90                   	nop
  r = lk->locked && (lk->pid == myproc()->pid);
80104e18:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80104e1b:	e8 00 ee ff ff       	call   80103c20 <myproc>
80104e20:	39 58 10             	cmp    %ebx,0x10(%eax)
80104e23:	0f 94 c0             	sete   %al
80104e26:	0f b6 c0             	movzbl %al,%eax
80104e29:	89 c7                	mov    %eax,%edi
80104e2b:	eb d3                	jmp    80104e00 <holdingsleep+0x20>
...
80104e8b:	8d 51 28             	lea    0x28(%ecx),%edx
...
80104eb9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
80104eba:	e8 e1 ec ff ff       	call   80103ba0 <mycpu>
80104ebf:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80104ec5:	85 c0                	test   %eax,%eax
80104ec7:	74 17                	je     80104ee0 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80104ec9:	e8 d2 ec ff ff       	call   80103ba0 <mycpu>
80104ece:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
80104eda:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80104ee0:	e8 bb ec ff ff       	call   80103ba0 <mycpu>
80104ee5:	81 e3 00 02 00 00    	and    $0x200,%ebx
80104eeb:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80104ef1:	eb d6                	jmp    80104ec9 <pushcli+0x19>
...
80104f07:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80104f08:	f6 c4 02             	test   $0x2,%ah
80104f0b:	75 35                	jne    80104f42 <popcli+0x42>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80104f0d:	e8 8e ec ff ff       	call   80103ba0 <mycpu>
80104f12:	83 a8 a4 00 00 00 01 	subl   $0x1,0xa4(%eax)
80104f19:	78 34                	js     80104f4f <popcli+0x4f>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104f1b:	e8 80 ec ff ff       	call   80103ba0 <mycpu>
80104f20:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80104f26:	85 d2                	test   %edx,%edx
80104f28:	74 06                	je     80104f30 <popcli+0x30>
    sti();
}
80104f2a:	c9                   	leave  
80104f2b:	c3                   	ret    
80104f2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104f30:	e8 6b ec ff ff       	call   80103ba0 <mycpu>
80104f35:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
80104f3b:	85 c0                	test   %eax,%eax
80104f3d:	74 eb                	je     80104f2a <popcli+0x2a>
  asm volatile("sti");
80104f3f:	fb                   	sti    
}
80104f40:	c9                   	leave  
...
80104f45:	68 e7 84 10 80       	push   $0x801084e7
80104f4a:	e8 31 b4 ff ff       	call   80100380 <panic>
    panic("popcli");
80104f4f:	83 ec 0c             	sub    $0xc,%esp
80104f52:	68 fe 84 10 80       	push   $0x801084fe
80104f57:	e8 24 b4 ff ff       	call   80100380 <panic>
...
80104f68:	31 db                	xor    %ebx,%ebx
  pushcli();
80104f6a:	e8 41 ff ff ff       	call   80104eb0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104f6f:	8b 06                	mov    (%esi),%eax
80104f71:	85 c0                	test   %eax,%eax
80104f73:	75 0b                	jne    80104f80 <holding+0x20>
  popcli();
80104f75:	e8 86 ff ff ff       	call   80104f00 <popcli>
}
...
80104f7f:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
80104f80:	8b 5e 08             	mov    0x8(%esi),%ebx
80104f83:	e8 18 ec ff ff       	call   80103ba0 <mycpu>
80104f88:	39 c3                	cmp    %eax,%ebx
80104f8a:	0f 94 c3             	sete   %bl
  popcli();
80104f8d:	e8 6e ff ff ff       	call   80104f00 <popcli>
  r = lock->locked && lock->cpu == mycpu();
80104f92:	0f b6 db             	movzbl %bl,%ebx
}
...
80104fa5:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80104fa8:	e8 03 ff ff ff       	call   80104eb0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104fad:	8b 03                	mov    (%ebx),%eax
80104faf:	85 c0                	test   %eax,%eax
80104fb1:	75 15                	jne    80104fc8 <release+0x28>
  popcli();
80104fb3:	e8 48 ff ff ff       	call   80104f00 <popcli>
    panic("release");
80104fb8:	83 ec 0c             	sub    $0xc,%esp
80104fbb:	68 05 85 10 80       	push   $0x80108505
80104fc0:	e8 bb b3 ff ff       	call   80100380 <panic>
80104fc5:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80104fc8:	8b 73 08             	mov    0x8(%ebx),%esi
80104fcb:	e8 d0 eb ff ff       	call   80103ba0 <mycpu>
80104fd0:	39 c6                	cmp    %eax,%esi
80104fd2:	75 df                	jne    80104fb3 <release+0x13>
  popcli();
80104fd4:	e8 27 ff ff ff       	call   80104f00 <popcli>
  lk->pcs[0] = 0;
80104fd9:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104fe0:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104fe7:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80104fec:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
...
80104ff7:	5d                   	pop    %ebp
  popcli();
80104ff8:	e9 03 ff ff ff       	jmp    80104f00 <popcli>
...
80105007:	e8 a4 fe ff ff       	call   80104eb0 <pushcli>
  if(holding(lk))
8010500c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
8010500f:	e8 9c fe ff ff       	call   80104eb0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80105014:	8b 03                	mov    (%ebx),%eax
80105016:	85 c0                	test   %eax,%eax
80105018:	75 7e                	jne    80105098 <acquire+0x98>
  popcli();
8010501a:	e8 e1 fe ff ff       	call   80104f00 <popcli>
  asm volatile("lock; xchgl %0, %1" :
8010501f:	b9 01 00 00 00       	mov    $0x1,%ecx
80105024:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  while(xchg(&lk->locked, 1) != 0)
80105028:	8b 55 08             	mov    0x8(%ebp),%edx
8010502b:	89 c8                	mov    %ecx,%eax
8010502d:	f0 87 02             	lock xchg %eax,(%edx)
80105030:	85 c0                	test   %eax,%eax
80105032:	75 f4                	jne    80105028 <acquire+0x28>
  __sync_synchronize();
80105034:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80105039:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010503c:	e8 5f eb ff ff       	call   80103ba0 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80105041:	8b 4d 08             	mov    0x8(%ebp),%ecx
  ebp = (uint*)v - 2;
80105044:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
80105046:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
80105049:	31 c0                	xor    %eax,%eax
8010504b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010504f:	90                   	nop
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105050:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80105056:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
8010505c:	77 1a                	ja     80105078 <acquire+0x78>
    pcs[i] = ebp[1];     // saved %eip
8010505e:	8b 5a 04             	mov    0x4(%edx),%ebx
80105061:	89 5c 81 0c          	mov    %ebx,0xc(%ecx,%eax,4)
  for(i = 0; i < 10; i++){
80105065:	83 c0 01             	add    $0x1,%eax
    ebp = (uint*)ebp[0]; // saved %ebp
80105068:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
8010506a:	83 f8 0a             	cmp    $0xa,%eax
...
80105074:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
80105078:	8d 44 81 0c          	lea    0xc(%ecx,%eax,4),%eax
8010507c:	8d 51 34             	lea    0x34(%ecx),%edx
8010507f:	90                   	nop
    pcs[i] = 0;
80105080:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
80105086:	83 c0 04             	add    $0x4,%eax
80105089:	39 c2                	cmp    %eax,%edx
8010508b:	75 f3                	jne    80105080 <acquire+0x80>
}
...
80105092:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80105098:	8b 5b 08             	mov    0x8(%ebx),%ebx
8010509b:	e8 00 eb ff ff       	call   80103ba0 <mycpu>
801050a0:	39 c3                	cmp    %eax,%ebx
801050a2:	0f 85 72 ff ff ff    	jne    8010501a <acquire+0x1a>
  popcli();
801050a8:	e8 53 fe ff ff       	call   80104f00 <popcli>
    panic("acquire");
801050ad:	83 ec 0c             	sub    $0xc,%esp
801050b0:	68 0d 85 10 80       	push   $0x8010850d
801050b5:	e8 c6 b2 ff ff       	call   80100380 <panic>
...
801050c7:	8b 4d 10             	mov    0x10(%ebp),%ecx
801050ca:	53                   	push   %ebx
801050cb:	8b 45 0c             	mov    0xc(%ebp),%eax
  if ((int)dst%4 == 0 && n%4 == 0){
801050ce:	89 d7                	mov    %edx,%edi
801050d0:	09 cf                	or     %ecx,%edi
801050d2:	83 e7 03             	and    $0x3,%edi
801050d5:	75 29                	jne    80105100 <memset+0x40>
    c &= 0xFF;
801050d7:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
801050da:	c1 e0 18             	shl    $0x18,%eax
801050dd:	89 fb                	mov    %edi,%ebx
801050df:	c1 e9 02             	shr    $0x2,%ecx
801050e2:	c1 e3 10             	shl    $0x10,%ebx
801050e5:	09 d8                	or     %ebx,%eax
801050e7:	09 f8                	or     %edi,%eax
801050e9:	c1 e7 08             	shl    $0x8,%edi
801050ec:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
801050ee:	89 d7                	mov    %edx,%edi
801050f0:	fc                   	cld    
801050f1:	f3 ab                	rep stos %eax,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
...
80105114:	8b 75 10             	mov    0x10(%ebp),%esi
...
8010511b:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  s2 = v2;
  while(n-- > 0){
8010511e:	85 f6                	test   %esi,%esi
80105120:	74 2e                	je     80105150 <memcmp+0x40>
80105122:	01 c6                	add    %eax,%esi
80105124:	eb 14                	jmp    8010513a <memcmp+0x2a>
...
80105164:	8b 55 08             	mov    0x8(%ebp),%edx
80105167:	8b 4d 10             	mov    0x10(%ebp),%ecx
8010516a:	56                   	push   %esi
8010516b:	8b 75 0c             	mov    0xc(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
8010516e:	39 d6                	cmp    %edx,%esi
80105170:	73 26                	jae    80105198 <memmove+0x38>
80105172:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
80105175:	39 fa                	cmp    %edi,%edx
80105177:	73 1f                	jae    80105198 <memmove+0x38>
80105179:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
8010517c:	85 c9                	test   %ecx,%ecx
8010517e:	74 0c                	je     8010518c <memmove+0x2c>
      *--d = *--s;
80105180:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
80105184:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
80105187:	83 e8 01             	sub    $0x1,%eax
8010518a:	73 f4                	jae    80105180 <memmove+0x20>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
8010518c:	5e                   	pop    %esi
8010518d:	89 d0                	mov    %edx,%eax
8010518f:	5f                   	pop    %edi
80105190:	5d                   	pop    %ebp
80105191:	c3                   	ret    
80105192:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
80105198:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
8010519b:	89 d7                	mov    %edx,%edi
8010519d:	85 c9                	test   %ecx,%ecx
8010519f:	74 eb                	je     8010518c <memmove+0x2c>
801051a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
801051a8:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
801051a9:	39 c6                	cmp    %eax,%esi
801051ab:	75 fb                	jne    801051a8 <memmove+0x48>
}
801051ad:	5e                   	pop    %esi
...
801051c0:	eb 9e                	jmp    80105160 <memmove>
...
801051d4:	8b 75 10             	mov    0x10(%ebp),%esi
801051d7:	8b 4d 08             	mov    0x8(%ebp),%ecx
801051da:	53                   	push   %ebx
801051db:	8b 55 0c             	mov    0xc(%ebp),%edx
  while(n > 0 && *p && *p == *q)
801051de:	85 f6                	test   %esi,%esi
801051e0:	74 2e                	je     80105210 <strncmp+0x40>
801051e2:	01 d6                	add    %edx,%esi
801051e4:	eb 18                	jmp    801051fe <strncmp+0x2e>
801051e6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801051ed:	8d 76 00             	lea    0x0(%esi),%esi
801051f0:	38 d8                	cmp    %bl,%al
801051f2:	75 14                	jne    80105208 <strncmp+0x38>
    n--, p++, q++;
801051f4:	83 c2 01             	add    $0x1,%edx
801051f7:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
801051fa:	39 f2                	cmp    %esi,%edx
801051fc:	74 12                	je     80105210 <strncmp+0x40>
801051fe:	0f b6 01             	movzbl (%ecx),%eax
80105201:	0f b6 1a             	movzbl (%edx),%ebx
80105204:	84 c0                	test   %al,%al
80105206:	75 e8                	jne    801051f0 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80105208:	29 d8                	sub    %ebx,%eax
}
8010520a:	5b                   	pop    %ebx
8010520b:	5e                   	pop    %esi
8010520c:	5d                   	pop    %ebp
...
80105229:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
8010522c:	89 f0                	mov    %esi,%eax
8010522e:	eb 15                	jmp    80105245 <strncpy+0x25>
80105230:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105234:	8b 7d 0c             	mov    0xc(%ebp),%edi
80105237:	83 c0 01             	add    $0x1,%eax
8010523a:	0f b6 57 ff          	movzbl -0x1(%edi),%edx
8010523e:	88 50 ff             	mov    %dl,-0x1(%eax)
80105241:	84 d2                	test   %dl,%dl
80105243:	74 09                	je     8010524e <strncpy+0x2e>
80105245:	89 cb                	mov    %ecx,%ebx
80105247:	83 e9 01             	sub    $0x1,%ecx
8010524a:	85 db                	test   %ebx,%ebx
8010524c:	7f e2                	jg     80105230 <strncpy+0x10>
    ;
  while(n-- > 0)
8010524e:	89 c2                	mov    %eax,%edx
80105250:	85 c9                	test   %ecx,%ecx
80105252:	7e 17                	jle    8010526b <strncpy+0x4b>
80105254:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    *s++ = 0;
80105258:	83 c2 01             	add    $0x1,%edx
8010525b:	89 c1                	mov    %eax,%ecx
8010525d:	c6 42 ff 00          	movb   $0x0,-0x1(%edx)
  while(n-- > 0)
80105261:	29 d1                	sub    %edx,%ecx
80105263:	8d 4c 0b ff          	lea    -0x1(%ebx,%ecx,1),%ecx
80105267:	85 c9                	test   %ecx,%ecx
80105269:	7f ed                	jg     80105258 <strncpy+0x38>
  return os;
}
8010526b:	5b                   	pop    %ebx
...
80105284:	8b 55 10             	mov    0x10(%ebp),%edx
80105287:	8b 75 08             	mov    0x8(%ebp),%esi
...
80105290:	7e 25                	jle    801052b7 <safestrcpy+0x37>
80105292:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
80105296:	89 f2                	mov    %esi,%edx
80105298:	eb 16                	jmp    801052b0 <safestrcpy+0x30>
...
801052c5:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
801052c8:	80 3a 00             	cmpb   $0x0,(%edx)
801052cb:	74 0c                	je     801052d9 <strlen+0x19>
801052cd:	8d 76 00             	lea    0x0(%esi),%esi
801052d0:	83 c0 01             	add    $0x1,%eax
801052d3:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
801052d7:	75 f7                	jne    801052d0 <strlen+0x10>
    ;
  return n;
}
801052d9:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
801052db:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801052df:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801052e6:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
801052e7:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801052e9:	89 d4                	mov    %edx,%esp
...
801052f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801052fa:	e8 21 e9 ff ff       	call   80103c20 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
801052ff:	8b 00                	mov    (%eax),%eax
80105301:	39 d8                	cmp    %ebx,%eax
80105303:	76 1b                	jbe    80105320 <fetchint+0x30>
80105305:	8d 53 04             	lea    0x4(%ebx),%edx
80105308:	39 d0                	cmp    %edx,%eax
8010530a:	72 14                	jb     80105320 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
8010530c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010530f:	8b 13                	mov    (%ebx),%edx
...
80105325:	eb ee                	jmp    80105315 <fetchint+0x25>
...
80105337:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010533a:	e8 e1 e8 ff ff       	call   80103c20 <myproc>

  if(addr >= curproc->sz)
8010533f:	39 18                	cmp    %ebx,(%eax)
80105341:	76 2d                	jbe    80105370 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
80105343:	8b 55 0c             	mov    0xc(%ebp),%edx
80105346:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80105348:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
8010534a:	39 d3                	cmp    %edx,%ebx
8010534c:	73 22                	jae    80105370 <fetchstr+0x40>
8010534e:	89 d8                	mov    %ebx,%eax
80105350:	eb 0d                	jmp    8010535f <fetchstr+0x2f>
80105352:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105358:	83 c0 01             	add    $0x1,%eax
8010535b:	39 c2                	cmp    %eax,%edx
8010535d:	76 11                	jbe    80105370 <fetchstr+0x40>
    if(*s == 0)
8010535f:	80 38 00             	cmpb   $0x0,(%eax)
80105362:	75 f4                	jne    80105358 <fetchstr+0x28>
      return s - *pp;
80105364:	29 d8                	sub    %ebx,%eax
  }
  return -1;
}
80105366:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105369:	c9                   	leave  
8010536a:	c3                   	ret    
...
80105385:	e8 96 e8 ff ff       	call   80103c20 <myproc>
8010538a:	8b 55 08             	mov    0x8(%ebp),%edx
8010538d:	8b 40 18             	mov    0x18(%eax),%eax
80105390:	8b 40 44             	mov    0x44(%eax),%eax
80105393:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80105396:	e8 85 e8 ff ff       	call   80103c20 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
8010539b:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801053d6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
801053d9:	e8 42 e8 ff ff       	call   80103c20 <myproc>
801053de:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801053e0:	e8 3b e8 ff ff       	call   80103c20 <myproc>
801053e5:	8b 55 08             	mov    0x8(%ebp),%edx
801053e8:	8b 40 18             	mov    0x18(%eax),%eax
801053eb:	8b 40 44             	mov    0x44(%eax),%eax
801053ee:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801053f1:	e8 2a e8 ff ff       	call   80103c20 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801053f6:	8d 7b 04             	lea    0x4(%ebx),%edi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
801053f9:	8b 00                	mov    (%eax),%eax
801053fb:	39 c7                	cmp    %eax,%edi
801053fd:	73 31                	jae    80105430 <argptr+0x60>
801053ff:	8d 4b 08             	lea    0x8(%ebx),%ecx
80105402:	39 c8                	cmp    %ecx,%eax
80105404:	72 2a                	jb     80105430 <argptr+0x60>
 
  if(argint(n, &i) < 0)
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80105406:	8b 55 10             	mov    0x10(%ebp),%edx
  *ip = *(int*)(addr);
80105409:	8b 43 04             	mov    0x4(%ebx),%eax
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
8010540c:	85 d2                	test   %edx,%edx
8010540e:	78 20                	js     80105430 <argptr+0x60>
80105410:	8b 16                	mov    (%esi),%edx
80105412:	39 c2                	cmp    %eax,%edx
80105414:	76 1a                	jbe    80105430 <argptr+0x60>
80105416:	8b 5d 10             	mov    0x10(%ebp),%ebx
80105419:	01 c3                	add    %eax,%ebx
8010541b:	39 da                	cmp    %ebx,%edx
8010541d:	72 11                	jb     80105430 <argptr+0x60>
    return -1;
  *pp = (char*)i;
...
80105435:	eb ef                	jmp    80105426 <argptr+0x56>
...
80105444:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80105445:	e8 d6 e7 ff ff       	call   80103c20 <myproc>
8010544a:	8b 55 08             	mov    0x8(%ebp),%edx
8010544d:	8b 40 18             	mov    0x18(%eax),%eax
80105450:	8b 40 44             	mov    0x44(%eax),%eax
80105453:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80105456:	e8 c5 e7 ff ff       	call   80103c20 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
8010545b:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
8010545e:	8b 00                	mov    (%eax),%eax
80105460:	39 c6                	cmp    %eax,%esi
80105462:	73 44                	jae    801054a8 <argstr+0x68>
80105464:	8d 53 08             	lea    0x8(%ebx),%edx
80105467:	39 d0                	cmp    %edx,%eax
80105469:	72 3d                	jb     801054a8 <argstr+0x68>
  *ip = *(int*)(addr);
8010546b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
8010546e:	e8 ad e7 ff ff       	call   80103c20 <myproc>
  if(addr >= curproc->sz)
80105473:	3b 18                	cmp    (%eax),%ebx
80105475:	73 31                	jae    801054a8 <argstr+0x68>
  *pp = (char*)addr;
80105477:	8b 55 0c             	mov    0xc(%ebp),%edx
8010547a:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
8010547c:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
8010547e:	39 d3                	cmp    %edx,%ebx
80105480:	73 26                	jae    801054a8 <argstr+0x68>
80105482:	89 d8                	mov    %ebx,%eax
80105484:	eb 11                	jmp    80105497 <argstr+0x57>
...
80105495:	76 11                	jbe    801054a8 <argstr+0x68>
    if(*s == 0)
80105497:	80 38 00             	cmpb   $0x0,(%eax)
8010549a:	75 f4                	jne    80105490 <argstr+0x50>
      return s - *pp;
8010549c:	29 d8                	sub    %ebx,%eax
  int addr;
  if(argint(n, &addr) < 0)
    return -1;
...
801054c4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801054c7:	e8 54 e7 ff ff       	call   80103c20 <myproc>
801054cc:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
801054ce:	8b 40 18             	mov    0x18(%eax),%eax
801054d1:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801054d4:	8d 50 ff             	lea    -0x1(%eax),%edx
801054d7:	83 fa 1d             	cmp    $0x1d,%edx
801054da:	77 24                	ja     80105500 <syscall+0x40>
801054dc:	8b 14 85 40 85 10 80 	mov    -0x7fef7ac0(,%eax,4),%edx
801054e3:	85 d2                	test   %edx,%edx
801054e5:	74 19                	je     80105500 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
801054e7:	ff d2                	call   *%edx
801054e9:	89 c2                	mov    %eax,%edx
801054eb:	8b 43 18             	mov    0x18(%ebx),%eax
801054ee:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80105500:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80105501:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80105504:	50                   	push   %eax
80105505:	ff 73 10             	push   0x10(%ebx)
80105508:	68 15 85 10 80       	push   $0x80108515
8010550d:	e8 8e b1 ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
80105512:	8b 43 18             	mov    0x18(%ebx),%eax
80105515:	83 c4 10             	add    $0x10,%esp
80105518:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
8010551f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105522:	c9                   	leave  
80105523:	c3                   	ret    
80105524:	66 90                	xchg   %ax,%ax
...
80105535:	8d 7d da             	lea    -0x26(%ebp),%edi
{
80105538:	53                   	push   %ebx
80105539:	83 ec 34             	sub    $0x34,%esp
8010553c:	89 4d d0             	mov    %ecx,-0x30(%ebp)
8010553f:	8b 4d 08             	mov    0x8(%ebp),%ecx
  if((dp = nameiparent(path, name)) == 0)
80105542:	57                   	push   %edi
80105543:	50                   	push   %eax
{
80105544:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80105547:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010554a:	e8 71 cb ff ff       	call   801020c0 <nameiparent>
8010554f:	83 c4 10             	add    $0x10,%esp
80105552:	85 c0                	test   %eax,%eax
80105554:	0f 84 46 01 00 00    	je     801056a0 <create+0x170>
    return 0;
  ilock(dp);
8010555a:	83 ec 0c             	sub    $0xc,%esp
8010555d:	89 c3                	mov    %eax,%ebx
8010555f:	50                   	push   %eax
80105560:	e8 1b c2 ff ff       	call   80101780 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80105565:	83 c4 0c             	add    $0xc,%esp
80105568:	6a 00                	push   $0x0
8010556a:	57                   	push   %edi
8010556b:	53                   	push   %ebx
8010556c:	e8 6f c7 ff ff       	call   80101ce0 <dirlookup>
80105571:	83 c4 10             	add    $0x10,%esp
80105574:	89 c6                	mov    %eax,%esi
80105576:	85 c0                	test   %eax,%eax
80105578:	74 56                	je     801055d0 <create+0xa0>
    iunlockput(dp);
8010557a:	83 ec 0c             	sub    $0xc,%esp
8010557d:	53                   	push   %ebx
8010557e:	e8 8d c4 ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80105583:	89 34 24             	mov    %esi,(%esp)
80105586:	e8 f5 c1 ff ff       	call   80101780 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
8010558b:	83 c4 10             	add    $0x10,%esp
8010558e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105593:	75 1b                	jne    801055b0 <create+0x80>
80105595:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
8010559a:	75 14                	jne    801055b0 <create+0x80>
...
801055d0:	0f bf 45 d4          	movswl -0x2c(%ebp),%eax
801055d4:	83 ec 08             	sub    $0x8,%esp
801055d7:	50                   	push   %eax
801055d8:	ff 33                	push   (%ebx)
801055da:	e8 31 c0 ff ff       	call   80101610 <ialloc>
801055df:	83 c4 10             	add    $0x10,%esp
801055e2:	89 c6                	mov    %eax,%esi
801055e4:	85 c0                	test   %eax,%eax
801055e6:	0f 84 cd 00 00 00    	je     801056b9 <create+0x189>
  ilock(ip);
801055ec:	83 ec 0c             	sub    $0xc,%esp
801055ef:	50                   	push   %eax
801055f0:	e8 8b c1 ff ff       	call   80101780 <ilock>
  ip->major = major;
801055f5:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
801055f9:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
801055fd:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80105601:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
80105605:	b8 01 00 00 00       	mov    $0x1,%eax
8010560a:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
8010560e:	89 34 24             	mov    %esi,(%esp)
80105611:	e8 ba c0 ff ff       	call   801016d0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80105616:	83 c4 10             	add    $0x10,%esp
80105619:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
8010561e:	74 30                	je     80105650 <create+0x120>
  if(dirlink(dp, name, ip->inum) < 0)
80105620:	83 ec 04             	sub    $0x4,%esp
80105623:	ff 76 04             	push   0x4(%esi)
80105626:	57                   	push   %edi
80105627:	53                   	push   %ebx
80105628:	e8 b3 c9 ff ff       	call   80101fe0 <dirlink>
8010562d:	83 c4 10             	add    $0x10,%esp
80105630:	85 c0                	test   %eax,%eax
80105632:	78 78                	js     801056ac <create+0x17c>
  iunlockput(dp);
80105634:	83 ec 0c             	sub    $0xc,%esp
80105637:	53                   	push   %ebx
80105638:	e8 d3 c3 ff ff       	call   80101a10 <iunlockput>
  return ip;
8010563d:	83 c4 10             	add    $0x10,%esp
}
80105640:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105643:	89 f0                	mov    %esi,%eax
80105645:	5b                   	pop    %ebx
80105646:	5e                   	pop    %esi
80105647:	5f                   	pop    %edi
80105648:	5d                   	pop    %ebp
...
80105650:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink++;  // for ".."
80105653:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
    iupdate(dp);
80105658:	53                   	push   %ebx
80105659:	e8 72 c0 ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010565e:	83 c4 0c             	add    $0xc,%esp
80105661:	ff 76 04             	push   0x4(%esi)
80105664:	68 d8 85 10 80       	push   $0x801085d8
80105669:	56                   	push   %esi
8010566a:	e8 71 c9 ff ff       	call   80101fe0 <dirlink>
8010566f:	83 c4 10             	add    $0x10,%esp
80105672:	85 c0                	test   %eax,%eax
80105674:	78 18                	js     8010568e <create+0x15e>
80105676:	83 ec 04             	sub    $0x4,%esp
80105679:	ff 73 04             	push   0x4(%ebx)
8010567c:	68 d7 85 10 80       	push   $0x801085d7
80105681:	56                   	push   %esi
80105682:	e8 59 c9 ff ff       	call   80101fe0 <dirlink>
80105687:	83 c4 10             	add    $0x10,%esp
8010568a:	85 c0                	test   %eax,%eax
8010568c:	79 92                	jns    80105620 <create+0xf0>
      panic("create dots");
8010568e:	83 ec 0c             	sub    $0xc,%esp
80105691:	68 cb 85 10 80       	push   $0x801085cb
80105696:	e8 e5 ac ff ff       	call   80100380 <panic>
...
801056af:	68 da 85 10 80       	push   $0x801085da
801056b4:	e8 c7 ac ff ff       	call   80100380 <panic>
    panic("create: ialloc");
801056b9:	83 ec 0c             	sub    $0xc,%esp
801056bc:	68 bc 85 10 80       	push   $0x801085bc
801056c1:	e8 ba ac ff ff       	call   80100380 <panic>
...
80105716:	74 18                	je     80105730 <sys_dup+0x60>
  for(fd = 0; fd < NOFILE; fd++){
80105718:	83 c3 01             	add    $0x1,%ebx
8010571b:	83 fb 10             	cmp    $0x10,%ebx
8010571e:	75 f0                	jne    80105710 <sys_dup+0x40>
}
80105720:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return -1;
80105723:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
...
80105730:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105733:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
80105737:	56                   	push   %esi
80105738:	e8 63 b7 ff ff       	call   80100ea0 <filedup>
  return fd;
8010573d:	83 c4 10             	add    $0x10,%esp
}
80105740:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
801057cd:	eb ed                	jmp    801057bc <sys_read+0x6c>
801057cf:	90                   	nop
...
8010584d:	eb ed                	jmp    8010583c <sys_write+0x6c>
8010584f:	90                   	nop
...
8010585e:	e8 1d fb ff ff       	call   80105380 <argint>
80105863:	83 c4 10             	add    $0x10,%esp
80105866:	85 c0                	test   %eax,%eax
80105868:	78 3e                	js     801058a8 <sys_close+0x58>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
8010586a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
8010586e:	77 38                	ja     801058a8 <sys_close+0x58>
80105870:	e8 ab e3 ff ff       	call   80103c20 <myproc>
80105875:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105878:	8d 5a 08             	lea    0x8(%edx),%ebx
8010587b:	8b 74 98 08          	mov    0x8(%eax,%ebx,4),%esi
8010587f:	85 f6                	test   %esi,%esi
80105881:	74 25                	je     801058a8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105883:	e8 98 e3 ff ff       	call   80103c20 <myproc>
  fileclose(f);
80105888:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
8010588b:	c7 44 98 08 00 00 00 	movl   $0x0,0x8(%eax,%ebx,4)
80105892:	00 
  fileclose(f);
...
801058ad:	eb ef                	jmp    8010589e <sys_close+0x4e>
801058af:	90                   	nop
...
80105915:	eb ec                	jmp    80105903 <sys_fstat+0x53>
...
80105925:	8d 45 d4             	lea    -0x2c(%ebp),%eax
{
...
8010592f:	e8 0c fb ff ff       	call   80105440 <argstr>
80105934:	83 c4 10             	add    $0x10,%esp
80105937:	85 c0                	test   %eax,%eax
80105939:	0f 88 fb 00 00 00    	js     80105a3a <sys_link+0x11a>
8010593f:	83 ec 08             	sub    $0x8,%esp
80105942:	8d 45 d0             	lea    -0x30(%ebp),%eax
80105945:	50                   	push   %eax
80105946:	6a 01                	push   $0x1
80105948:	e8 f3 fa ff ff       	call   80105440 <argstr>
8010594d:	83 c4 10             	add    $0x10,%esp
80105950:	85 c0                	test   %eax,%eax
80105952:	0f 88 e2 00 00 00    	js     80105a3a <sys_link+0x11a>
  begin_op();
80105958:	e8 03 d4 ff ff       	call   80102d60 <begin_op>
  if((ip = namei(old)) == 0){
8010595d:	83 ec 0c             	sub    $0xc,%esp
80105960:	ff 75 d4             	push   -0x2c(%ebp)
80105963:	e8 38 c7 ff ff       	call   801020a0 <namei>
80105968:	83 c4 10             	add    $0x10,%esp
8010596b:	89 c3                	mov    %eax,%ebx
8010596d:	85 c0                	test   %eax,%eax
8010596f:	0f 84 e4 00 00 00    	je     80105a59 <sys_link+0x139>
  ilock(ip);
80105975:	83 ec 0c             	sub    $0xc,%esp
80105978:	50                   	push   %eax
80105979:	e8 02 be ff ff       	call   80101780 <ilock>
  if(ip->type == T_DIR){
8010597e:	83 c4 10             	add    $0x10,%esp
80105981:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105986:	0f 84 b5 00 00 00    	je     80105a41 <sys_link+0x121>
  iupdate(ip);
8010598c:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
8010598f:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80105994:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80105997:	53                   	push   %ebx
80105998:	e8 33 bd ff ff       	call   801016d0 <iupdate>
  iunlock(ip);
8010599d:	89 1c 24             	mov    %ebx,(%esp)
801059a0:	e8 bb be ff ff       	call   80101860 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
801059a5:	58                   	pop    %eax
801059a6:	5a                   	pop    %edx
801059a7:	57                   	push   %edi
801059a8:	ff 75 d0             	push   -0x30(%ebp)
801059ab:	e8 10 c7 ff ff       	call   801020c0 <nameiparent>
801059b0:	83 c4 10             	add    $0x10,%esp
801059b3:	89 c6                	mov    %eax,%esi
801059b5:	85 c0                	test   %eax,%eax
801059b7:	74 5b                	je     80105a14 <sys_link+0xf4>
  ilock(dp);
801059b9:	83 ec 0c             	sub    $0xc,%esp
801059bc:	50                   	push   %eax
801059bd:	e8 be bd ff ff       	call   80101780 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
801059c2:	8b 03                	mov    (%ebx),%eax
801059c4:	83 c4 10             	add    $0x10,%esp
801059c7:	39 06                	cmp    %eax,(%esi)
801059c9:	75 3d                	jne    80105a08 <sys_link+0xe8>
801059cb:	83 ec 04             	sub    $0x4,%esp
801059ce:	ff 73 04             	push   0x4(%ebx)
801059d1:	57                   	push   %edi
801059d2:	56                   	push   %esi
801059d3:	e8 08 c6 ff ff       	call   80101fe0 <dirlink>
801059d8:	83 c4 10             	add    $0x10,%esp
801059db:	85 c0                	test   %eax,%eax
801059dd:	78 29                	js     80105a08 <sys_link+0xe8>
  iunlockput(dp);
801059df:	83 ec 0c             	sub    $0xc,%esp
801059e2:	56                   	push   %esi
801059e3:	e8 28 c0 ff ff       	call   80101a10 <iunlockput>
  iput(ip);
801059e8:	89 1c 24             	mov    %ebx,(%esp)
801059eb:	e8 c0 be ff ff       	call   801018b0 <iput>
  end_op();
801059f0:	e8 db d3 ff ff       	call   80102dd0 <end_op>
  return 0;
801059f5:	83 c4 10             	add    $0x10,%esp
801059f8:	31 c0                	xor    %eax,%eax
}
...
80105a0c:	e8 ff bf ff ff       	call   80101a10 <iunlockput>
    goto bad;
80105a11:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80105a14:	83 ec 0c             	sub    $0xc,%esp
80105a17:	53                   	push   %ebx
80105a18:	e8 63 bd ff ff       	call   80101780 <ilock>
  ip->nlink--;
80105a1d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105a22:	89 1c 24             	mov    %ebx,(%esp)
80105a25:	e8 a6 bc ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
80105a2a:	89 1c 24             	mov    %ebx,(%esp)
80105a2d:	e8 de bf ff ff       	call   80101a10 <iunlockput>
  end_op();
80105a32:	e8 99 d3 ff ff       	call   80102dd0 <end_op>
  return -1;
80105a37:	83 c4 10             	add    $0x10,%esp
80105a3a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a3f:	eb b9                	jmp    801059fa <sys_link+0xda>
    iunlockput(ip);
80105a41:	83 ec 0c             	sub    $0xc,%esp
80105a44:	53                   	push   %ebx
80105a45:	e8 c6 bf ff ff       	call   80101a10 <iunlockput>
    end_op();
80105a4a:	e8 81 d3 ff ff       	call   80102dd0 <end_op>
    return -1;
80105a4f:	83 c4 10             	add    $0x10,%esp
80105a52:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a57:	eb a1                	jmp    801059fa <sys_link+0xda>
    end_op();
80105a59:	e8 72 d3 ff ff       	call   80102dd0 <end_op>
    return -1;
80105a5e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a63:	eb 95                	jmp    801059fa <sys_link+0xda>
...
80105a74:	56                   	push   %esi
  if(argstr(0, &path) < 0)
80105a75:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
80105a78:	53                   	push   %ebx
80105a79:	83 ec 54             	sub    $0x54,%esp
  if(argstr(0, &path) < 0)
80105a7c:	50                   	push   %eax
80105a7d:	6a 00                	push   $0x0
80105a7f:	e8 bc f9 ff ff       	call   80105440 <argstr>
80105a84:	83 c4 10             	add    $0x10,%esp
80105a87:	85 c0                	test   %eax,%eax
80105a89:	0f 88 7a 01 00 00    	js     80105c09 <sys_unlink+0x199>
  begin_op();
80105a8f:	e8 cc d2 ff ff       	call   80102d60 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105a94:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80105a97:	83 ec 08             	sub    $0x8,%esp
80105a9a:	53                   	push   %ebx
80105a9b:	ff 75 c0             	push   -0x40(%ebp)
80105a9e:	e8 1d c6 ff ff       	call   801020c0 <nameiparent>
80105aa3:	83 c4 10             	add    $0x10,%esp
80105aa6:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80105aa9:	85 c0                	test   %eax,%eax
80105aab:	0f 84 62 01 00 00    	je     80105c13 <sys_unlink+0x1a3>
  ilock(dp);
80105ab1:	8b 7d b4             	mov    -0x4c(%ebp),%edi
80105ab4:	83 ec 0c             	sub    $0xc,%esp
80105ab7:	57                   	push   %edi
80105ab8:	e8 c3 bc ff ff       	call   80101780 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105abd:	58                   	pop    %eax
80105abe:	5a                   	pop    %edx
80105abf:	68 d8 85 10 80       	push   $0x801085d8
80105ac4:	53                   	push   %ebx
80105ac5:	e8 f6 c1 ff ff       	call   80101cc0 <namecmp>
80105aca:	83 c4 10             	add    $0x10,%esp
80105acd:	85 c0                	test   %eax,%eax
80105acf:	0f 84 fb 00 00 00    	je     80105bd0 <sys_unlink+0x160>
80105ad5:	83 ec 08             	sub    $0x8,%esp
80105ad8:	68 d7 85 10 80       	push   $0x801085d7
80105add:	53                   	push   %ebx
80105ade:	e8 dd c1 ff ff       	call   80101cc0 <namecmp>
80105ae3:	83 c4 10             	add    $0x10,%esp
80105ae6:	85 c0                	test   %eax,%eax
80105ae8:	0f 84 e2 00 00 00    	je     80105bd0 <sys_unlink+0x160>
  if((ip = dirlookup(dp, name, &off)) == 0)
80105aee:	83 ec 04             	sub    $0x4,%esp
80105af1:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80105af4:	50                   	push   %eax
80105af5:	53                   	push   %ebx
80105af6:	57                   	push   %edi
80105af7:	e8 e4 c1 ff ff       	call   80101ce0 <dirlookup>
80105afc:	83 c4 10             	add    $0x10,%esp
80105aff:	89 c3                	mov    %eax,%ebx
80105b01:	85 c0                	test   %eax,%eax
80105b03:	0f 84 c7 00 00 00    	je     80105bd0 <sys_unlink+0x160>
  ilock(ip);
...
80105b15:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80105b1a:	0f 8e 1c 01 00 00    	jle    80105c3c <sys_unlink+0x1cc>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105b20:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105b25:	8d 7d d8             	lea    -0x28(%ebp),%edi
80105b28:	74 66                	je     80105b90 <sys_unlink+0x120>
  memset(&de, 0, sizeof(de));
80105b2a:	83 ec 04             	sub    $0x4,%esp
80105b2d:	6a 10                	push   $0x10
80105b2f:	6a 00                	push   $0x0
80105b31:	57                   	push   %edi
80105b32:	e8 89 f5 ff ff       	call   801050c0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105b37:	6a 10                	push   $0x10
80105b39:	ff 75 c4             	push   -0x3c(%ebp)
80105b3c:	57                   	push   %edi
80105b3d:	ff 75 b4             	push   -0x4c(%ebp)
80105b40:	e8 4b c0 ff ff       	call   80101b90 <writei>
80105b45:	83 c4 20             	add    $0x20,%esp
80105b48:	83 f8 10             	cmp    $0x10,%eax
80105b4b:	0f 85 de 00 00 00    	jne    80105c2f <sys_unlink+0x1bf>
  if(ip->type == T_DIR){
80105b51:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105b56:	0f 84 94 00 00 00    	je     80105bf0 <sys_unlink+0x180>
  iunlockput(dp);
80105b5c:	83 ec 0c             	sub    $0xc,%esp
80105b5f:	ff 75 b4             	push   -0x4c(%ebp)
80105b62:	e8 a9 be ff ff       	call   80101a10 <iunlockput>
  ip->nlink--;
80105b67:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105b6c:	89 1c 24             	mov    %ebx,(%esp)
80105b6f:	e8 5c bb ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
80105b74:	89 1c 24             	mov    %ebx,(%esp)
80105b77:	e8 94 be ff ff       	call   80101a10 <iunlockput>
  end_op();
80105b7c:	e8 4f d2 ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105b90:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
80105b94:	76 94                	jbe    80105b2a <sys_unlink+0xba>
80105b96:	be 20 00 00 00       	mov    $0x20,%esi
80105b9b:	eb 0b                	jmp    80105ba8 <sys_unlink+0x138>
80105b9d:	8d 76 00             	lea    0x0(%esi),%esi
80105ba0:	83 c6 10             	add    $0x10,%esi
80105ba3:	3b 73 58             	cmp    0x58(%ebx),%esi
80105ba6:	73 82                	jae    80105b2a <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105ba8:	6a 10                	push   $0x10
80105baa:	56                   	push   %esi
80105bab:	57                   	push   %edi
80105bac:	53                   	push   %ebx
80105bad:	e8 de be ff ff       	call   80101a90 <readi>
80105bb2:	83 c4 10             	add    $0x10,%esp
80105bb5:	83 f8 10             	cmp    $0x10,%eax
80105bb8:	75 68                	jne    80105c22 <sys_unlink+0x1b2>
    if(de.inum != 0)
80105bba:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80105bbf:	74 df                	je     80105ba0 <sys_unlink+0x130>
    iunlockput(ip);
80105bc1:	83 ec 0c             	sub    $0xc,%esp
80105bc4:	53                   	push   %ebx
80105bc5:	e8 46 be ff ff       	call   80101a10 <iunlockput>
    goto bad;
80105bca:	83 c4 10             	add    $0x10,%esp
80105bcd:	8d 76 00             	lea    0x0(%esi),%esi
  iunlockput(dp);
80105bd0:	83 ec 0c             	sub    $0xc,%esp
80105bd3:	ff 75 b4             	push   -0x4c(%ebp)
80105bd6:	e8 35 be ff ff       	call   80101a10 <iunlockput>
  end_op();
80105bdb:	e8 f0 d1 ff ff       	call   80102dd0 <end_op>
  return -1;
80105be0:	83 c4 10             	add    $0x10,%esp
80105be3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105be8:	eb 9c                	jmp    80105b86 <sys_unlink+0x116>
80105bea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    dp->nlink--;
80105bf0:	8b 45 b4             	mov    -0x4c(%ebp),%eax
    iupdate(dp);
80105bf3:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
80105bf6:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
80105bfb:	50                   	push   %eax
80105bfc:	e8 cf ba ff ff       	call   801016d0 <iupdate>
80105c01:	83 c4 10             	add    $0x10,%esp
80105c04:	e9 53 ff ff ff       	jmp    80105b5c <sys_unlink+0xec>
    return -1;
80105c09:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c0e:	e9 73 ff ff ff       	jmp    80105b86 <sys_unlink+0x116>
    end_op();
80105c13:	e8 b8 d1 ff ff       	call   80102dd0 <end_op>
    return -1;
80105c18:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c1d:	e9 64 ff ff ff       	jmp    80105b86 <sys_unlink+0x116>
      panic("isdirempty: readi");
80105c22:	83 ec 0c             	sub    $0xc,%esp
80105c25:	68 fc 85 10 80       	push   $0x801085fc
80105c2a:	e8 51 a7 ff ff       	call   80100380 <panic>
    panic("unlink: writei");
80105c2f:	83 ec 0c             	sub    $0xc,%esp
80105c32:	68 0e 86 10 80       	push   $0x8010860e
80105c37:	e8 44 a7 ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
80105c3c:	83 ec 0c             	sub    $0xc,%esp
80105c3f:	68 ea 85 10 80       	push   $0x801085ea
...
80105c55:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
80105c58:	53                   	push   %ebx
80105c59:	83 ec 24             	sub    $0x24,%esp
  if(argstr(0, &path) < 0 || argint(1, &omode) < 0)
80105c5c:	50                   	push   %eax
80105c5d:	6a 00                	push   $0x0
80105c5f:	e8 dc f7 ff ff       	call   80105440 <argstr>
80105c64:	83 c4 10             	add    $0x10,%esp
80105c67:	85 c0                	test   %eax,%eax
80105c69:	0f 88 8e 00 00 00    	js     80105cfd <sys_open+0xad>
80105c6f:	83 ec 08             	sub    $0x8,%esp
80105c72:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105c75:	50                   	push   %eax
80105c76:	6a 01                	push   $0x1
80105c78:	e8 03 f7 ff ff       	call   80105380 <argint>
80105c7d:	83 c4 10             	add    $0x10,%esp
80105c80:	85 c0                	test   %eax,%eax
80105c82:	78 79                	js     80105cfd <sys_open+0xad>
    return -1;

  begin_op();
80105c84:	e8 d7 d0 ff ff       	call   80102d60 <begin_op>

  if(omode & O_CREATE){
80105c89:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105c8d:	75 79                	jne    80105d08 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80105c92:	ff 75 e0             	push   -0x20(%ebp)
80105c95:	e8 06 c4 ff ff       	call   801020a0 <namei>
80105c9a:	83 c4 10             	add    $0x10,%esp
80105c9d:	89 c6                	mov    %eax,%esi
80105c9f:	85 c0                	test   %eax,%eax
80105ca1:	0f 84 7e 00 00 00    	je     80105d25 <sys_open+0xd5>
      end_op();
      return -1;
    }
    ilock(ip);
...
80105cab:	e8 d0 ba ff ff       	call   80101780 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105cb0:	83 c4 10             	add    $0x10,%esp
80105cb3:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105cb8:	0f 84 c2 00 00 00    	je     80105d80 <sys_open+0x130>
      end_op();
      return -1;
    }
  }
...
80105cbe:	e8 6d b1 ff ff       	call   80100e30 <filealloc>
80105cc3:	89 c7                	mov    %eax,%edi
80105cc5:	85 c0                	test   %eax,%eax
80105cc7:	74 23                	je     80105cec <sys_open+0x9c>
  struct proc *curproc = myproc();
80105cc9:	e8 52 df ff ff       	call   80103c20 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80105cce:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
80105cd0:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80105cd4:	85 d2                	test   %edx,%edx
80105cd6:	74 60                	je     80105d38 <sys_open+0xe8>
  for(fd = 0; fd < NOFILE; fd++){
80105cd8:	83 c3 01             	add    $0x1,%ebx
80105cdb:	83 fb 10             	cmp    $0x10,%ebx
80105cde:	75 f0                	jne    80105cd0 <sys_open+0x80>
    if(f)
      fileclose(f);
80105ce0:	83 ec 0c             	sub    $0xc,%esp
80105ce3:	57                   	push   %edi
80105ce4:	e8 07 b2 ff ff       	call   80100ef0 <fileclose>
80105ce9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
80105cec:	83 ec 0c             	sub    $0xc,%esp
80105cef:	56                   	push   %esi
80105cf0:	e8 1b bd ff ff       	call   80101a10 <iunlockput>
    end_op();
80105cf5:	e8 d6 d0 ff ff       	call   80102dd0 <end_op>
    return -1;
80105cfa:	83 c4 10             	add    $0x10,%esp
80105cfd:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105d02:	eb 6d                	jmp    80105d71 <sys_open+0x121>
80105d04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ip = create(path, T_FILE, 0, 0);
80105d08:	83 ec 0c             	sub    $0xc,%esp
80105d0b:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105d0e:	31 c9                	xor    %ecx,%ecx
80105d10:	ba 02 00 00 00       	mov    $0x2,%edx
80105d15:	6a 00                	push   $0x0
80105d17:	e8 14 f8 ff ff       	call   80105530 <create>
    if(ip == 0){
80105d1c:	83 c4 10             	add    $0x10,%esp
    ip = create(path, T_FILE, 0, 0);
80105d1f:	89 c6                	mov    %eax,%esi
    if(ip == 0){
80105d21:	85 c0                	test   %eax,%eax
80105d23:	75 99                	jne    80105cbe <sys_open+0x6e>
      end_op();
80105d25:	e8 a6 d0 ff ff       	call   80102dd0 <end_op>
      return -1;
80105d2a:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105d2f:	eb 40                	jmp    80105d71 <sys_open+0x121>
80105d31:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  }
  iunlock(ip);
80105d38:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105d3b:	89 7c 98 28          	mov    %edi,0x28(%eax,%ebx,4)
  iunlock(ip);
80105d3f:	56                   	push   %esi
80105d40:	e8 1b bb ff ff       	call   80101860 <iunlock>
  end_op();
80105d45:	e8 86 d0 ff ff       	call   80102dd0 <end_op>

  f->type = FD_INODE;
80105d4a:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80105d50:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105d53:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
80105d56:	89 77 10             	mov    %esi,0x10(%edi)
  f->readable = !(omode & O_WRONLY);
80105d59:	89 d0                	mov    %edx,%eax
  f->off = 0;
80105d5b:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
80105d62:	f7 d0                	not    %eax
80105d64:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105d67:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
80105d6a:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105d6d:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
80105d71:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105d74:	89 d8                	mov    %ebx,%eax
80105d76:	5b                   	pop    %ebx
80105d77:	5e                   	pop    %esi
80105d78:	5f                   	pop    %edi
80105d79:	5d                   	pop    %ebp
...
80105d7f:	90                   	nop
    if(ip->type == T_DIR && omode != O_RDONLY){
80105d80:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80105d83:	85 c9                	test   %ecx,%ecx
80105d85:	0f 84 33 ff ff ff    	je     80105cbe <sys_open+0x6e>
80105d8b:	e9 5c ff ff ff       	jmp    80105cec <sys_open+0x9c>
...
80105dcf:	e8 3c bc ff ff       	call   80101a10 <iunlockput>
  end_op();
80105dd4:	e8 f7 cf ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105ddf:	c3                   	ret    
    end_op();
80105de0:	e8 eb cf ff ff       	call   80102dd0 <end_op>
    return -1;
...
80105e5e:	e8 ad bb ff ff       	call   80101a10 <iunlockput>
  end_op();
80105e63:	e8 68 cf ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105e6f:	90                   	nop
    end_op();
80105e70:	e8 5b cf ff ff       	call   80102dd0 <end_op>
    return -1;
...
80105e85:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105e88:	e8 93 dd ff ff       	call   80103c20 <myproc>
80105e8d:	89 c6                	mov    %eax,%esi
  
  begin_op();
80105e8f:	e8 cc ce ff ff       	call   80102d60 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80105e94:	83 ec 08             	sub    $0x8,%esp
80105e97:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105e9a:	50                   	push   %eax
80105e9b:	6a 00                	push   $0x0
80105e9d:	e8 9e f5 ff ff       	call   80105440 <argstr>
80105ea2:	83 c4 10             	add    $0x10,%esp
80105ea5:	85 c0                	test   %eax,%eax
80105ea7:	78 77                	js     80105f20 <sys_chdir+0xa0>
80105ea9:	83 ec 0c             	sub    $0xc,%esp
80105eac:	ff 75 f4             	push   -0xc(%ebp)
80105eaf:	e8 ec c1 ff ff       	call   801020a0 <namei>
80105eb4:	83 c4 10             	add    $0x10,%esp
80105eb7:	89 c3                	mov    %eax,%ebx
80105eb9:	85 c0                	test   %eax,%eax
80105ebb:	74 63                	je     80105f20 <sys_chdir+0xa0>
    end_op();
    return -1;
  }
  ilock(ip);
...
80105ec1:	e8 ba b8 ff ff       	call   80101780 <ilock>
  if(ip->type != T_DIR){
80105ec6:	83 c4 10             	add    $0x10,%esp
80105ec9:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105ece:	75 30                	jne    80105f00 <sys_chdir+0x80>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80105ed4:	e8 87 b9 ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
80105ed9:	58                   	pop    %eax
80105eda:	ff 76 68             	push   0x68(%esi)
80105edd:	e8 ce b9 ff ff       	call   801018b0 <iput>
  end_op();
80105ee2:	e8 e9 ce ff ff       	call   80102dd0 <end_op>
  curproc->cwd = ip;
80105ee7:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
80105eea:	83 c4 10             	add    $0x10,%esp
80105eed:	31 c0                	xor    %eax,%eax
}
80105eef:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105ef2:	5b                   	pop    %ebx
80105ef3:	5e                   	pop    %esi
80105ef4:	5d                   	pop    %ebp
80105ef5:	c3                   	ret    
...
80105f04:	e8 07 bb ff ff       	call   80101a10 <iunlockput>
    end_op();
80105f09:	e8 c2 ce ff ff       	call   80102dd0 <end_op>
    return -1;
80105f0e:	83 c4 10             	add    $0x10,%esp
80105f11:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f16:	eb d7                	jmp    80105eef <sys_chdir+0x6f>
80105f18:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105f1f:	90                   	nop
    end_op();
80105f20:	e8 ab ce ff ff       	call   80102dd0 <end_op>
    return -1;
80105f25:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f2a:	eb c3                	jmp    80105eef <sys_chdir+0x6f>
...
80105f35:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
{
80105f3b:	53                   	push   %ebx
80105f3c:	81 ec a4 00 00 00    	sub    $0xa4,%esp
  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
80105f42:	50                   	push   %eax
80105f43:	6a 00                	push   $0x0
80105f45:	e8 f6 f4 ff ff       	call   80105440 <argstr>
80105f4a:	83 c4 10             	add    $0x10,%esp
80105f4d:	85 c0                	test   %eax,%eax
80105f4f:	0f 88 87 00 00 00    	js     80105fdc <sys_exec+0xac>
80105f55:	83 ec 08             	sub    $0x8,%esp
80105f58:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80105f5e:	50                   	push   %eax
80105f5f:	6a 01                	push   $0x1
80105f61:	e8 1a f4 ff ff       	call   80105380 <argint>
80105f66:	83 c4 10             	add    $0x10,%esp
80105f69:	85 c0                	test   %eax,%eax
80105f6b:	78 6f                	js     80105fdc <sys_exec+0xac>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105f6d:	83 ec 04             	sub    $0x4,%esp
80105f70:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
  for(i=0;; i++){
80105f76:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
80105f78:	68 80 00 00 00       	push   $0x80
80105f7d:	6a 00                	push   $0x0
80105f7f:	56                   	push   %esi
80105f80:	e8 3b f1 ff ff       	call   801050c0 <memset>
...
80105f93:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
80105f99:	8d 3c 9d 00 00 00 00 	lea    0x0(,%ebx,4),%edi
80105fa0:	50                   	push   %eax
80105fa1:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105fa7:	01 f8                	add    %edi,%eax
80105fa9:	50                   	push   %eax
80105faa:	e8 41 f3 ff ff       	call   801052f0 <fetchint>
80105faf:	83 c4 10             	add    $0x10,%esp
80105fb2:	85 c0                	test   %eax,%eax
80105fb4:	78 26                	js     80105fdc <sys_exec+0xac>
      return -1;
    if(uarg == 0){
80105fb6:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
80105fbc:	85 c0                	test   %eax,%eax
80105fbe:	74 30                	je     80105ff0 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80105fc0:	83 ec 08             	sub    $0x8,%esp
80105fc3:	8d 14 3e             	lea    (%esi,%edi,1),%edx
80105fc6:	52                   	push   %edx
80105fc7:	50                   	push   %eax
80105fc8:	e8 63 f3 ff ff       	call   80105330 <fetchstr>
80105fcd:	83 c4 10             	add    $0x10,%esp
80105fd0:	85 c0                	test   %eax,%eax
80105fd2:	78 08                	js     80105fdc <sys_exec+0xac>
  for(i=0;; i++){
80105fd4:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80105fd7:	83 fb 20             	cmp    $0x20,%ebx
80105fda:	75 b4                	jne    80105f90 <sys_exec+0x60>
      return -1;
  }
  return exec(path, argv);
}
80105fdc:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return -1;
...
80105fe9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      argv[i] = 0;
80105ff0:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
80105ff7:	00 00 00 00 
  return exec(path, argv);
80105ffb:	83 ec 08             	sub    $0x8,%esp
80105ffe:	56                   	push   %esi
80105fff:	ff b5 5c ff ff ff    	push   -0xa4(%ebp)
80106005:	e8 a6 aa ff ff       	call   80100ab0 <exec>
...
80106025:	8d 45 dc             	lea    -0x24(%ebp),%eax
{
80106028:	53                   	push   %ebx
80106029:	83 ec 20             	sub    $0x20,%esp
  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
8010602c:	6a 08                	push   $0x8
8010602e:	50                   	push   %eax
8010602f:	6a 00                	push   $0x0
80106031:	e8 9a f3 ff ff       	call   801053d0 <argptr>
80106036:	83 c4 10             	add    $0x10,%esp
80106039:	85 c0                	test   %eax,%eax
8010603b:	78 4a                	js     80106087 <sys_pipe+0x67>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
8010603d:	83 ec 08             	sub    $0x8,%esp
80106040:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106043:	50                   	push   %eax
80106044:	8d 45 e0             	lea    -0x20(%ebp),%eax
80106047:	50                   	push   %eax
80106048:	e8 e3 d3 ff ff       	call   80103430 <pipealloc>
8010604d:	83 c4 10             	add    $0x10,%esp
80106050:	85 c0                	test   %eax,%eax
80106052:	78 33                	js     80106087 <sys_pipe+0x67>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106054:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
80106057:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80106059:	e8 c2 db ff ff       	call   80103c20 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010605e:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
80106060:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
80106064:	85 f6                	test   %esi,%esi
80106066:	74 28                	je     80106090 <sys_pipe+0x70>
  for(fd = 0; fd < NOFILE; fd++){
80106068:	83 c3 01             	add    $0x1,%ebx
8010606b:	83 fb 10             	cmp    $0x10,%ebx
8010606e:	75 f0                	jne    80106060 <sys_pipe+0x40>
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
80106070:	83 ec 0c             	sub    $0xc,%esp
80106073:	ff 75 e0             	push   -0x20(%ebp)
80106076:	e8 75 ae ff ff       	call   80100ef0 <fileclose>
    fileclose(wf);
8010607b:	58                   	pop    %eax
8010607c:	ff 75 e4             	push   -0x1c(%ebp)
8010607f:	e8 6c ae ff ff       	call   80100ef0 <fileclose>
    return -1;
80106084:	83 c4 10             	add    $0x10,%esp
80106087:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010608c:	eb 53                	jmp    801060e1 <sys_pipe+0xc1>
...
80106097:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010609a:	e8 81 db ff ff       	call   80103c20 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801060ae:	74 20                	je     801060d0 <sys_pipe+0xb0>
  for(fd = 0; fd < NOFILE; fd++){
801060b0:	83 c2 01             	add    $0x1,%edx
801060b3:	83 fa 10             	cmp    $0x10,%edx
801060b6:	75 f0                	jne    801060a8 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
801060b8:	e8 63 db ff ff       	call   80103c20 <myproc>
801060bd:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
801060c4:	00 
801060c5:	eb a9                	jmp    80106070 <sys_pipe+0x50>
...
{
  return fork();
801060f0:	e9 4b dd ff ff       	jmp    80103e40 <fork>
...
80106103:	83 ec 08             	sub    $0x8,%esp
  exit();
80106106:	e8 d5 e1 ff ff       	call   801042e0 <exit>
  return 0;  // not reached
}
8010610b:	31 c0                	xor    %eax,%eax
8010610d:	c9                   	leave  
8010610e:	c3                   	ret    
8010610f:	90                   	nop
...
{
  return wait();
80106110:	e9 cb e3 ff ff       	jmp    801044e0 <wait>
...
8010612c:	e8 4f f2 ff ff       	call   80105380 <argint>
80106131:	83 c4 10             	add    $0x10,%esp
80106134:	85 c0                	test   %eax,%eax
80106136:	78 18                	js     80106150 <sys_kill+0x30>
    return -1;
  return kill(pid);
80106138:	83 ec 0c             	sub    $0xc,%esp
8010613b:	ff 75 f4             	push   -0xc(%ebp)
8010613e:	e8 8d e6 ff ff       	call   801047d0 <kill>
...
80106163:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80106166:	e8 b5 da ff ff       	call   80103c20 <myproc>
8010616b:	8b 40 10             	mov    0x10(%eax),%eax
}
8010616e:	c9                   	leave  
8010616f:	c3                   	ret    
...
8010617d:	e8 fe f1 ff ff       	call   80105380 <argint>
80106182:	83 c4 10             	add    $0x10,%esp
80106185:	85 c0                	test   %eax,%eax
80106187:	78 27                	js     801061b0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
...
8010618e:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80106191:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80106193:	ff 75 f4             	push   -0xc(%ebp)
80106196:	e8 25 dc ff ff       	call   80103dc0 <growproc>
8010619b:	83 c4 10             	add    $0x10,%esp
8010619e:	85 c0                	test   %eax,%eax
801061a0:	78 0e                	js     801061b0 <sys_sbrk+0x40>
    return -1;
  return addr;
}
801061a2:	89 d8                	mov    %ebx,%eax
801061a4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801061a7:	c9                   	leave  
801061a8:	c3                   	ret    
801061a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    return -1;
801061b0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801061b5:	eb eb                	jmp    801061a2 <sys_sbrk+0x32>
...
801061cd:	e8 ae f1 ff ff       	call   80105380 <argint>
801061d2:	83 c4 10             	add    $0x10,%esp
801061d5:	85 c0                	test   %eax,%eax
801061d7:	0f 88 8a 00 00 00    	js     80106267 <sys_sleep+0xa7>
    return -1;
  acquire(&tickslock);
801061dd:	83 ec 0c             	sub    $0xc,%esp
801061e0:	68 00 56 11 80       	push   $0x80115600
801061e5:	e8 16 ee ff ff       	call   80105000 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801061ea:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801061ed:	8b 1d e0 55 11 80    	mov    0x801155e0,%ebx
  while(ticks - ticks0 < n){
801061f3:	83 c4 10             	add    $0x10,%esp
801061f6:	85 d2                	test   %edx,%edx
801061f8:	75 27                	jne    80106221 <sys_sleep+0x61>
801061fa:	eb 54                	jmp    80106250 <sys_sleep+0x90>
...
80106203:	68 00 56 11 80       	push   $0x80115600
80106208:	68 e0 55 11 80       	push   $0x801155e0
8010620d:	e8 9e e4 ff ff       	call   801046b0 <sleep>
  while(ticks - ticks0 < n){
80106212:	a1 e0 55 11 80       	mov    0x801155e0,%eax
80106217:	83 c4 10             	add    $0x10,%esp
8010621a:	29 d8                	sub    %ebx,%eax
8010621c:	3b 45 f4             	cmp    -0xc(%ebp),%eax
8010621f:	73 2f                	jae    80106250 <sys_sleep+0x90>
    if(myproc()->killed){
80106221:	e8 fa d9 ff ff       	call   80103c20 <myproc>
80106226:	8b 40 24             	mov    0x24(%eax),%eax
80106229:	85 c0                	test   %eax,%eax
8010622b:	74 d3                	je     80106200 <sys_sleep+0x40>
      release(&tickslock);
8010622d:	83 ec 0c             	sub    $0xc,%esp
80106230:	68 00 56 11 80       	push   $0x80115600
80106235:	e8 66 ed ff ff       	call   80104fa0 <release>
  }
  release(&tickslock);
  return 0;
}
8010623a:	8b 5d fc             	mov    -0x4(%ebp),%ebx
      return -1;
...
80106253:	68 00 56 11 80       	push   $0x80115600
80106258:	e8 43 ed ff ff       	call   80104fa0 <release>
  return 0;
8010625d:	83 c4 10             	add    $0x10,%esp
80106260:	31 c0                	xor    %eax,%eax
}
...
8010626c:	eb f4                	jmp    80106262 <sys_sleep+0xa2>
...
80106274:	83 ec 10             	sub    $0x10,%esp
  uint xticks;

  acquire(&tickslock);
80106277:	68 00 56 11 80       	push   $0x80115600
8010627c:	e8 7f ed ff ff       	call   80105000 <acquire>
  xticks = ticks;
80106281:	8b 1d e0 55 11 80    	mov    0x801155e0,%ebx
  release(&tickslock);
80106287:	c7 04 24 00 56 11 80 	movl   $0x80115600,(%esp)
8010628e:	e8 0d ed ff ff       	call   80104fa0 <release>
  return xticks;
}
80106293:	89 d8                	mov    %ebx,%eax
80106295:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106298:	c9                   	leave  
80106299:	c3                   	ret    
8010629a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

801062a0 <sys_getgpid>:
...
801062a6:	e8 75 d9 ff ff       	call   80103c20 <myproc>

  struct proc* pproc = culproc -> parent;
801062ab:	8b 40 14             	mov    0x14(%eax),%eax
  if (pproc == 0) return -1;
801062ae:	85 c0                	test   %eax,%eax
801062b0:	74 0c                	je     801062be <sys_getgpid+0x1e>
  struct proc* gpproc = pproc -> parent;
801062b2:	8b 40 14             	mov    0x14(%eax),%eax
  if (gpproc == 0) return -1;
801062b5:	85 c0                	test   %eax,%eax
801062b7:	74 05                	je     801062be <sys_getgpid+0x1e>

  return gpproc -> pid;
801062b9:	8b 40 10             	mov    0x10(%eax),%eax
}
801062bc:	c9                   	leave  
801062bd:	c3                   	ret    
801062be:	c9                   	leave  
...
801062d5:	e8 46 d9 ff ff       	call   80103c20 <myproc>
  uint xticks;

  acquire(&tickslock);
801062da:	83 ec 0c             	sub    $0xc,%esp
801062dd:	68 00 56 11 80       	push   $0x80115600
  struct proc* p = myproc();
801062e2:	89 c3                	mov    %eax,%ebx
  acquire(&tickslock);
801062e4:	e8 17 ed ff ff       	call   80105000 <acquire>
  xticks = ticks;
801062e9:	8b 35 e0 55 11 80    	mov    0x801155e0,%esi
  release(&tickslock);
801062ef:	c7 04 24 00 56 11 80 	movl   $0x80115600,(%esp)
801062f6:	e8 a5 ec ff ff       	call   80104fa0 <release>

  cprintf("ticks = %d, pid = %d, name = %s\n", xticks, p->pid, p->name);
801062fb:	8d 43 6c             	lea    0x6c(%ebx),%eax
801062fe:	50                   	push   %eax
801062ff:	ff 73 10             	push   0x10(%ebx)
80106302:	56                   	push   %esi
80106303:	68 20 86 10 80       	push   $0x80108620
80106308:	e8 93 a3 ff ff       	call   801006a0 <cprintf>
  return 0;
}
...
80106323:	83 ec 08             	sub    $0x8,%esp
  yield();
80106326:	e8 e5 e2 ff ff       	call   80104610 <yield>
  return 0;
}
...
8010634c:	e8 2f f0 ff ff       	call   80105380 <argint>
80106351:	83 c4 10             	add    $0x10,%esp
80106354:	85 c0                	test   %eax,%eax
80106356:	78 28                	js     80106380 <sys_setpriority+0x40>
    return -1;
...
80106361:	e8 1a f0 ff ff       	call   80105380 <argint>
80106366:	83 c4 10             	add    $0x10,%esp
80106369:	85 c0                	test   %eax,%eax
8010636b:	78 13                	js     80106380 <sys_setpriority+0x40>
    return -1;

  return setpriority(pid, priority);
8010636d:	83 ec 08             	sub    $0x8,%esp
80106370:	ff 75 f4             	push   -0xc(%ebp)
80106373:	ff 75 f0             	push   -0x10(%ebp)
80106376:	e8 75 e7 ff ff       	call   80104af0 <setpriority>
...
80106393:	83 ec 20             	sub    $0x20,%esp
  int pid, password;
...
8010639c:	e8 df ef ff ff       	call   80105380 <argint>
801063a1:	83 c4 10             	add    $0x10,%esp
801063a4:	85 c0                	test   %eax,%eax
801063a6:	78 28                	js     801063d0 <sys_setmonopoly+0x40>
    return -1;
  if(argint(1, &password) < 0)
801063a8:	83 ec 08             	sub    $0x8,%esp
801063ab:	8d 45 f4             	lea    -0xc(%ebp),%eax
801063ae:	50                   	push   %eax
801063af:	6a 01                	push   $0x1
801063b1:	e8 ca ef ff ff       	call   80105380 <argint>
801063b6:	83 c4 10             	add    $0x10,%esp
801063b9:	85 c0                	test   %eax,%eax
801063bb:	78 13                	js     801063d0 <sys_setmonopoly+0x40>
    return -1;

  return setmonopoly(pid, password);
801063bd:	83 ec 08             	sub    $0x8,%esp
801063c0:	ff 75 f4             	push   -0xc(%ebp)
801063c3:	ff 75 f0             	push   -0x10(%ebp)
801063c6:	e8 b5 e7 ff ff       	call   80104b80 <setmonopoly>
...
801063e3:	83 ec 08             	sub    $0x8,%esp
  monopolize();
801063e6:	e8 95 e8 ff ff       	call   80104c80 <monopolize>
  return 0;
}
...
801063f3:	83 ec 08             	sub    $0x8,%esp
  unmonopolize();
801063f6:	e8 b5 e8 ff ff       	call   80104cb0 <unmonopolize>
  return 0;
...
8010640e:	54                   	push   %esp
  call trap
8010640f:	e8 ec 00 00 00       	call   80106500 <trap>
  addl $4, %esp
...
80106447:	c7 04 c5 42 56 11 80 	movl   $0x8e000008,-0x7feea9be(,%eax,8)
8010644e:	08 00 00 8e 
80106452:	66 89 14 c5 40 56 11 	mov    %dx,-0x7feea9c0(,%eax,8)
80106459:	80 
8010645a:	c1 ea 10             	shr    $0x10,%edx
8010645d:	66 89 14 c5 46 56 11 	mov    %dx,-0x7feea9ba(,%eax,8)
80106464:	80 
  for(i = 0; i < 256; i++)
...
80106474:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106477:	c7 05 42 58 11 80 08 	movl   $0xef000008,0x80115842
8010647e:	00 00 ef 
  initlock(&tickslock, "time");
80106481:	68 41 86 10 80       	push   $0x80108641
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106486:	66 a3 40 58 11 80    	mov    %ax,0x80115840
8010648c:	c1 e8 10             	shr    $0x10,%eax
8010648f:	66 a3 46 58 11 80    	mov    %ax,0x80115846
  SETGATE(idt[128], 1, SEG_KCODE<<3, vectors[128], DPL_USER);
80106495:	a1 08 b2 10 80       	mov    0x8010b208,%eax
  initlock(&tickslock, "time");
8010649a:	68 00 56 11 80       	push   $0x80115600
  SETGATE(idt[128], 1, SEG_KCODE<<3, vectors[128], DPL_USER);
8010649f:	66 a3 40 5a 11 80    	mov    %ax,0x80115a40
801064a5:	c1 e8 10             	shr    $0x10,%eax
801064a8:	c7 05 42 5a 11 80 08 	movl   $0xef000008,0x80115a42
801064af:	00 00 ef 
801064b2:	66 a3 46 5a 11 80    	mov    %ax,0x80115a46
  initlock(&tickslock, "time");
801064b8:	e8 73 e9 ff ff       	call   80104e30 <initlock>
}
...
801064d0:	55                   	push   %ebp
  pd[0] = size-1;
801064d1:	b8 ff 07 00 00       	mov    $0x7ff,%eax
801064d6:	89 e5                	mov    %esp,%ebp
801064d8:	83 ec 10             	sub    $0x10,%esp
801064db:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801064df:	b8 40 56 11 80       	mov    $0x80115640,%eax
801064e4:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801064e8:	c1 e8 10             	shr    $0x10,%eax
...
8010650c:	8b 43 30             	mov    0x30(%ebx),%eax
8010650f:	83 f8 40             	cmp    $0x40,%eax
80106512:	0f 84 a8 01 00 00    	je     801066c0 <trap+0x1c0>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80106518:	83 f8 3f             	cmp    $0x3f,%eax
8010651b:	0f 87 9f 00 00 00    	ja     801065c0 <trap+0xc0>
80106521:	83 f8 1f             	cmp    $0x1f,%eax
80106524:	0f 86 c6 00 00 00    	jbe    801065f0 <trap+0xf0>
8010652a:	83 e8 20             	sub    $0x20,%eax
8010652d:	83 f8 1f             	cmp    $0x1f,%eax
80106530:	0f 87 ba 00 00 00    	ja     801065f0 <trap+0xf0>
80106536:	ff 24 85 04 87 10 80 	jmp    *-0x7fef78fc(,%eax,4)
8010653d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106540:	e8 fb bc ff ff       	call   80102240 <ideintr>
    lapiceoi();
...
8010654a:	e8 d1 d6 ff ff       	call   80103c20 <myproc>
8010654f:	85 c0                	test   %eax,%eax
80106551:	74 1d                	je     80106570 <trap+0x70>
80106553:	e8 c8 d6 ff ff       	call   80103c20 <myproc>
80106558:	8b 50 24             	mov    0x24(%eax),%edx
8010655b:	85 d2                	test   %edx,%edx
8010655d:	74 11                	je     80106570 <trap+0x70>
8010655f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80106563:	83 e0 03             	and    $0x3,%eax
80106566:	66 83 f8 03          	cmp    $0x3,%ax
8010656a:	0f 84 30 02 00 00    	je     801067a0 <trap+0x2a0>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
80106570:	e8 ab d6 ff ff       	call   80103c20 <myproc>
80106575:	85 c0                	test   %eax,%eax
80106577:	74 0f                	je     80106588 <trap+0x88>
80106579:	e8 a2 d6 ff ff       	call   80103c20 <myproc>
8010657e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80106582:	0f 84 e8 00 00 00    	je     80106670 <trap+0x170>
    proctimer();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106588:	e8 93 d6 ff ff       	call   80103c20 <myproc>
8010658d:	85 c0                	test   %eax,%eax
8010658f:	74 1d                	je     801065ae <trap+0xae>
80106591:	e8 8a d6 ff ff       	call   80103c20 <myproc>
80106596:	8b 40 24             	mov    0x24(%eax),%eax
80106599:	85 c0                	test   %eax,%eax
8010659b:	74 11                	je     801065ae <trap+0xae>
8010659d:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801065a1:	83 e0 03             	and    $0x3,%eax
801065a4:	66 83 f8 03          	cmp    $0x3,%ax
801065a8:	0f 84 3f 01 00 00    	je     801066ed <trap+0x1ed>
    exit();
}
801065ae:	8d 65 f4             	lea    -0xc(%ebp),%esp
801065b1:	5b                   	pop    %ebx
801065b2:	5e                   	pop    %esi
801065b3:	5f                   	pop    %edi
801065b4:	5d                   	pop    %ebp
...
801065bd:	8d 76 00             	lea    0x0(%esi),%esi
  switch(tf->trapno){
801065c0:	3d 80 00 00 00       	cmp    $0x80,%eax
801065c5:	75 29                	jne    801065f0 <trap+0xf0>
    cprintf("user interrupt 128 called!\n");
801065c7:	83 ec 0c             	sub    $0xc,%esp
801065ca:	68 46 86 10 80       	push   $0x80108646
801065cf:	e8 cc a0 ff ff       	call   801006a0 <cprintf>
    exit();
801065d4:	e8 07 dd ff ff       	call   801042e0 <exit>
    break;
801065d9:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801065dc:	e8 3f d6 ff ff       	call   80103c20 <myproc>
801065e1:	85 c0                	test   %eax,%eax
801065e3:	0f 85 6a ff ff ff    	jne    80106553 <trap+0x53>
801065e9:	eb 85                	jmp    80106570 <trap+0x70>
801065eb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801065ef:	90                   	nop
    if(myproc() == 0 || (tf->cs&3) == 0){
801065f0:	e8 2b d6 ff ff       	call   80103c20 <myproc>
801065f5:	8b 7b 38             	mov    0x38(%ebx),%edi
801065f8:	85 c0                	test   %eax,%eax
801065fa:	0f 84 c7 01 00 00    	je     801067c7 <trap+0x2c7>
80106600:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80106604:	0f 84 bd 01 00 00    	je     801067c7 <trap+0x2c7>
...
80106610:	e8 eb d5 ff ff       	call   80103c00 <cpuid>
...
80106621:	e8 fa d5 ff ff       	call   80103c20 <myproc>
80106626:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106629:	e8 f2 d5 ff ff       	call   80103c20 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
8010663e:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106641:	56                   	push   %esi
80106642:	ff 70 10             	push   0x10(%eax)
80106645:	68 c0 86 10 80       	push   $0x801086c0
8010664a:	e8 51 a0 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
8010664f:	83 c4 20             	add    $0x20,%esp
80106652:	e8 c9 d5 ff ff       	call   80103c20 <myproc>
80106657:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010665e:	e8 bd d5 ff ff       	call   80103c20 <myproc>
80106663:	85 c0                	test   %eax,%eax
80106665:	0f 85 e8 fe ff ff    	jne    80106553 <trap+0x53>
8010666b:	e9 00 ff ff ff       	jmp    80106570 <trap+0x70>
  if(myproc() && myproc()->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
80106670:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80106674:	0f 85 0e ff ff ff    	jne    80106588 <trap+0x88>
    proctimer();
8010667a:	e8 91 e2 ff ff       	call   80104910 <proctimer>
8010667f:	e9 04 ff ff ff       	jmp    80106588 <trap+0x88>
...
8010668f:	e8 6c d5 ff ff       	call   80103c00 <cpuid>
80106694:	57                   	push   %edi
80106695:	56                   	push   %esi
80106696:	50                   	push   %eax
80106697:	68 68 86 10 80       	push   $0x80108668
...
801066b0:	0f 85 9d fe ff ff    	jne    80106553 <trap+0x53>
801066b6:	e9 b5 fe ff ff       	jmp    80106570 <trap+0x70>
801066bb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801066bf:	90                   	nop
    if(myproc()->killed)
801066c0:	e8 5b d5 ff ff       	call   80103c20 <myproc>
801066c5:	8b 70 24             	mov    0x24(%eax),%esi
801066c8:	85 f6                	test   %esi,%esi
801066ca:	0f 85 e0 00 00 00    	jne    801067b0 <trap+0x2b0>
    myproc()->tf = tf;
801066d0:	e8 4b d5 ff ff       	call   80103c20 <myproc>
801066d5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801066d8:	e8 e3 ed ff ff       	call   801054c0 <syscall>
    if(myproc()->killed)
801066dd:	e8 3e d5 ff ff       	call   80103c20 <myproc>
801066e2:	8b 48 24             	mov    0x24(%eax),%ecx
801066e5:	85 c9                	test   %ecx,%ecx
801066e7:	0f 84 c1 fe ff ff    	je     801065ae <trap+0xae>
}
...
801066f3:	5d                   	pop    %ebp
      exit();
801066f4:	e9 e7 db ff ff       	jmp    801042e0 <exit>
801066f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80106700:	e8 5b 02 00 00       	call   80106960 <uartintr>
    lapiceoi();
80106705:	e8 06 c2 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010670a:	e8 11 d5 ff ff       	call   80103c20 <myproc>
8010670f:	85 c0                	test   %eax,%eax
80106711:	0f 85 3c fe ff ff    	jne    80106553 <trap+0x53>
80106717:	e9 54 fe ff ff       	jmp    80106570 <trap+0x70>
...
80106725:	e8 e6 c1 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010672a:	e8 f1 d4 ff ff       	call   80103c20 <myproc>
8010672f:	85 c0                	test   %eax,%eax
80106731:	0f 85 1c fe ff ff    	jne    80106553 <trap+0x53>
80106737:	e9 34 fe ff ff       	jmp    80106570 <trap+0x70>
8010673c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80106740:	e8 bb d4 ff ff       	call   80103c00 <cpuid>
80106745:	85 c0                	test   %eax,%eax
80106747:	0f 85 f8 fd ff ff    	jne    80106545 <trap+0x45>
      acquire(&tickslock);
8010674d:	83 ec 0c             	sub    $0xc,%esp
80106750:	68 00 56 11 80       	push   $0x80115600
80106755:	e8 a6 e8 ff ff       	call   80105000 <acquire>
      wakeup(&ticks);
8010675a:	c7 04 24 e0 55 11 80 	movl   $0x801155e0,(%esp)
      ticks++;
80106761:	83 05 e0 55 11 80 01 	addl   $0x1,0x801155e0
      wakeup(&ticks);
80106768:	e8 03 e0 ff ff       	call   80104770 <wakeup>
8010676d:	83 c4 10             	add    $0x10,%esp
80106770:	69 05 e0 55 11 80 29 	imul   $0xc28f5c29,0x801155e0,%eax
80106777:	5c 8f c2 
8010677a:	c1 c8 02             	ror    $0x2,%eax
      if (ticks % 100 == 0){
8010677d:	3d 28 5c 8f 02       	cmp    $0x28f5c28,%eax
80106782:	76 3c                	jbe    801067c0 <trap+0x2c0>
      release(&tickslock);
80106784:	83 ec 0c             	sub    $0xc,%esp
80106787:	68 00 56 11 80       	push   $0x80115600
8010678c:	e8 0f e8 ff ff       	call   80104fa0 <release>
80106791:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80106794:	e9 ac fd ff ff       	jmp    80106545 <trap+0x45>
80106799:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
801067a0:	e8 3b db ff ff       	call   801042e0 <exit>
801067a5:	e9 c6 fd ff ff       	jmp    80106570 <trap+0x70>
801067aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
801067b0:	e8 2b db ff ff       	call   801042e0 <exit>
801067b5:	e9 16 ff ff ff       	jmp    801066d0 <trap+0x1d0>
801067ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prboost();
801067c0:	e8 0b e2 ff ff       	call   801049d0 <prboost>
801067c5:	eb bd                	jmp    80106784 <trap+0x284>
801067c7:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801067ca:	e8 31 d4 ff ff       	call   80103c00 <cpuid>
801067cf:	83 ec 0c             	sub    $0xc,%esp
801067d2:	56                   	push   %esi
801067d3:	57                   	push   %edi
801067d4:	50                   	push   %eax
801067d5:	ff 73 30             	push   0x30(%ebx)
801067d8:	68 8c 86 10 80       	push   $0x8010868c
801067dd:	e8 be 9e ff ff       	call   801006a0 <cprintf>
      panic("trap");
801067e2:	83 c4 14             	add    $0x14,%esp
801067e5:	68 62 86 10 80       	push   $0x80108662
801067ea:	e8 91 9b ff ff       	call   80100380 <panic>
801067ef:	90                   	nop
...
{
  if(!uart)
801067f0:	a1 40 5e 11 80       	mov    0x80115e40,%eax
801067f5:	85 c0                	test   %eax,%eax
801067f7:	74 17                	je     80106810 <uartgetc+0x20>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801067f9:	ba fd 03 00 00       	mov    $0x3fd,%edx
801067fe:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
801067ff:	a8 01                	test   $0x1,%al
80106801:	74 0d                	je     80106810 <uartgetc+0x20>
80106803:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106808:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80106809:	0f b6 c0             	movzbl %al,%eax
8010680c:	c3                   	ret    
...
80106877:	74 78                	je     801068f1 <uartinit+0xd1>
  uart = 1;
80106879:	c7 05 40 5e 11 80 01 	movl   $0x1,0x80115e40
80106880:	00 00 00 
80106883:	89 fa                	mov    %edi,%edx
...
8010688c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
8010688f:	bf 84 87 10 80       	mov    $0x80108784,%edi
80106894:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80106899:	6a 00                	push   $0x0
8010689b:	6a 04                	push   $0x4
8010689d:	e8 de bb ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
801068a2:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
801068a6:	83 c4 10             	add    $0x10,%esp
801068a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
801068b0:	a1 40 5e 11 80       	mov    0x80115e40,%eax
801068b5:	bb 80 00 00 00       	mov    $0x80,%ebx
801068ba:	85 c0                	test   %eax,%eax
801068bc:	75 14                	jne    801068d2 <uartinit+0xb2>
801068be:	eb 23                	jmp    801068e3 <uartinit+0xc3>
    microdelay(10);
801068c0:	83 ec 0c             	sub    $0xc,%esp
801068c3:	6a 0a                	push   $0xa
801068c5:	e8 66 c0 ff ff       	call   80102930 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801068ca:	83 c4 10             	add    $0x10,%esp
801068cd:	83 eb 01             	sub    $0x1,%ebx
801068d0:	74 07                	je     801068d9 <uartinit+0xb9>
801068d2:	89 f2                	mov    %esi,%edx
801068d4:	ec                   	in     (%dx),%al
801068d5:	a8 20                	test   $0x20,%al
801068d7:	74 e7                	je     801068c0 <uartinit+0xa0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801068d9:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
801068dd:	ba f8 03 00 00       	mov    $0x3f8,%edx
801068e2:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
801068e3:	0f b6 47 01          	movzbl 0x1(%edi),%eax
801068e7:	83 c7 01             	add    $0x1,%edi
801068ea:	88 45 e7             	mov    %al,-0x19(%ebp)
801068ed:	84 c0                	test   %al,%al
801068ef:	75 bf                	jne    801068b0 <uartinit+0x90>
}
...
80106907:	74 47                	je     80106950 <uartputc+0x50>
{
80106909:	55                   	push   %ebp
8010690a:	89 e5                	mov    %esp,%ebp
8010690c:	56                   	push   %esi
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010690d:	be fd 03 00 00       	mov    $0x3fd,%esi
80106912:	53                   	push   %ebx
80106913:	bb 80 00 00 00       	mov    $0x80,%ebx
80106918:	eb 18                	jmp    80106932 <uartputc+0x32>
8010691a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    microdelay(10);
80106920:	83 ec 0c             	sub    $0xc,%esp
80106923:	6a 0a                	push   $0xa
80106925:	e8 06 c0 ff ff       	call   80102930 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010692a:	83 c4 10             	add    $0x10,%esp
8010692d:	83 eb 01             	sub    $0x1,%ebx
80106930:	74 07                	je     80106939 <uartputc+0x39>
80106932:	89 f2                	mov    %esi,%edx
80106934:	ec                   	in     (%dx),%al
80106935:	a8 20                	test   $0x20,%al
80106937:	74 e7                	je     80106920 <uartputc+0x20>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106939:	8b 45 08             	mov    0x8(%ebp),%eax
8010693c:	ba f8 03 00 00       	mov    $0x3f8,%edx
...
80106966:	68 f0 67 10 80       	push   $0x801067f0
8010696b:	e8 10 9f ff ff       	call   80100880 <consoleintr>
}
...
80106977:	6a 00                	push   $0x0
  jmp alltraps
80106979:	e9 81 fa ff ff       	jmp    801063ff <alltraps>
...
8010697e:	6a 00                	push   $0x0
  pushl $1
80106980:	6a 01                	push   $0x1
  jmp alltraps
80106982:	e9 78 fa ff ff       	jmp    801063ff <alltraps>
...
80106989:	6a 02                	push   $0x2
  jmp alltraps
8010698b:	e9 6f fa ff ff       	jmp    801063ff <alltraps>
...
80106992:	6a 03                	push   $0x3
  jmp alltraps
80106994:	e9 66 fa ff ff       	jmp    801063ff <alltraps>
...
80106999:	6a 00                	push   $0x0
  pushl $4
8010699b:	6a 04                	push   $0x4
  jmp alltraps
8010699d:	e9 5d fa ff ff       	jmp    801063ff <alltraps>
...
801069a2:	6a 00                	push   $0x0
  pushl $5
801069a4:	6a 05                	push   $0x5
  jmp alltraps
801069a6:	e9 54 fa ff ff       	jmp    801063ff <alltraps>
...
801069ab:	6a 00                	push   $0x0
  pushl $6
801069ad:	6a 06                	push   $0x6
  jmp alltraps
801069af:	e9 4b fa ff ff       	jmp    801063ff <alltraps>
...
801069b4:	6a 00                	push   $0x0
  pushl $7
801069b6:	6a 07                	push   $0x7
  jmp alltraps
801069b8:	e9 42 fa ff ff       	jmp    801063ff <alltraps>

801069bd <vector8>:
.globl vector8
vector8:
  pushl $8
801069bd:	6a 08                	push   $0x8
  jmp alltraps
801069bf:	e9 3b fa ff ff       	jmp    801063ff <alltraps>
...
801069c4:	6a 00                	push   $0x0
  pushl $9
801069c6:	6a 09                	push   $0x9
  jmp alltraps
801069c8:	e9 32 fa ff ff       	jmp    801063ff <alltraps>

801069cd <vector10>:
.globl vector10
vector10:
  pushl $10
801069cd:	6a 0a                	push   $0xa
  jmp alltraps
801069cf:	e9 2b fa ff ff       	jmp    801063ff <alltraps>

801069d4 <vector11>:
.globl vector11
vector11:
  pushl $11
801069d4:	6a 0b                	push   $0xb
  jmp alltraps
801069d6:	e9 24 fa ff ff       	jmp    801063ff <alltraps>

801069db <vector12>:
.globl vector12
vector12:
  pushl $12
801069db:	6a 0c                	push   $0xc
  jmp alltraps
801069dd:	e9 1d fa ff ff       	jmp    801063ff <alltraps>

801069e2 <vector13>:
.globl vector13
vector13:
  pushl $13
801069e2:	6a 0d                	push   $0xd
  jmp alltraps
801069e4:	e9 16 fa ff ff       	jmp    801063ff <alltraps>

801069e9 <vector14>:
.globl vector14
vector14:
  pushl $14
801069e9:	6a 0e                	push   $0xe
  jmp alltraps
801069eb:	e9 0f fa ff ff       	jmp    801063ff <alltraps>
...
801069f0:	6a 00                	push   $0x0
  pushl $15
801069f2:	6a 0f                	push   $0xf
  jmp alltraps
801069f4:	e9 06 fa ff ff       	jmp    801063ff <alltraps>
...
801069f9:	6a 00                	push   $0x0
  pushl $16
801069fb:	6a 10                	push   $0x10
  jmp alltraps
801069fd:	e9 fd f9 ff ff       	jmp    801063ff <alltraps>

80106a02 <vector17>:
.globl vector17
vector17:
  pushl $17
80106a02:	6a 11                	push   $0x11
  jmp alltraps
80106a04:	e9 f6 f9 ff ff       	jmp    801063ff <alltraps>
...
80106a09:	6a 00                	push   $0x0
  pushl $18
80106a0b:	6a 12                	push   $0x12
  jmp alltraps
80106a0d:	e9 ed f9 ff ff       	jmp    801063ff <alltraps>
...
80106a12:	6a 00                	push   $0x0
  pushl $19
80106a14:	6a 13                	push   $0x13
  jmp alltraps
80106a16:	e9 e4 f9 ff ff       	jmp    801063ff <alltraps>
...
80106a1b:	6a 00                	push   $0x0
  pushl $20
80106a1d:	6a 14                	push   $0x14
  jmp alltraps
80106a1f:	e9 db f9 ff ff       	jmp    801063ff <alltraps>
...
80106a24:	6a 00                	push   $0x0
  pushl $21
80106a26:	6a 15                	push   $0x15
  jmp alltraps
80106a28:	e9 d2 f9 ff ff       	jmp    801063ff <alltraps>
...
80106a2d:	6a 00                	push   $0x0
  pushl $22
80106a2f:	6a 16                	push   $0x16
  jmp alltraps
80106a31:	e9 c9 f9 ff ff       	jmp    801063ff <alltraps>
...
80106a36:	6a 00                	push   $0x0
  pushl $23
80106a38:	6a 17                	push   $0x17
  jmp alltraps
80106a3a:	e9 c0 f9 ff ff       	jmp    801063ff <alltraps>
...
80106a3f:	6a 00                	push   $0x0
  pushl $24
80106a41:	6a 18                	push   $0x18
  jmp alltraps
80106a43:	e9 b7 f9 ff ff       	jmp    801063ff <alltraps>
...
80106a48:	6a 00                	push   $0x0
  pushl $25
80106a4a:	6a 19                	push   $0x19
  jmp alltraps
80106a4c:	e9 ae f9 ff ff       	jmp    801063ff <alltraps>
...
80106a51:	6a 00                	push   $0x0
  pushl $26
80106a53:	6a 1a                	push   $0x1a
  jmp alltraps
80106a55:	e9 a5 f9 ff ff       	jmp    801063ff <alltraps>
...
80106a5a:	6a 00                	push   $0x0
  pushl $27
80106a5c:	6a 1b                	push   $0x1b
  jmp alltraps
80106a5e:	e9 9c f9 ff ff       	jmp    801063ff <alltraps>
...
80106a63:	6a 00                	push   $0x0
  pushl $28
80106a65:	6a 1c                	push   $0x1c
  jmp alltraps
80106a67:	e9 93 f9 ff ff       	jmp    801063ff <alltraps>
...
80106a6c:	6a 00                	push   $0x0
  pushl $29
80106a6e:	6a 1d                	push   $0x1d
  jmp alltraps
80106a70:	e9 8a f9 ff ff       	jmp    801063ff <alltraps>
...
80106a75:	6a 00                	push   $0x0
  pushl $30
80106a77:	6a 1e                	push   $0x1e
  jmp alltraps
80106a79:	e9 81 f9 ff ff       	jmp    801063ff <alltraps>
...
80106a7e:	6a 00                	push   $0x0
  pushl $31
80106a80:	6a 1f                	push   $0x1f
  jmp alltraps
80106a82:	e9 78 f9 ff ff       	jmp    801063ff <alltraps>
...
80106a87:	6a 00                	push   $0x0
  pushl $32
80106a89:	6a 20                	push   $0x20
  jmp alltraps
80106a8b:	e9 6f f9 ff ff       	jmp    801063ff <alltraps>
...
80106a90:	6a 00                	push   $0x0
  pushl $33
80106a92:	6a 21                	push   $0x21
  jmp alltraps
80106a94:	e9 66 f9 ff ff       	jmp    801063ff <alltraps>
...
80106a99:	6a 00                	push   $0x0
  pushl $34
80106a9b:	6a 22                	push   $0x22
  jmp alltraps
80106a9d:	e9 5d f9 ff ff       	jmp    801063ff <alltraps>
...
80106aa2:	6a 00                	push   $0x0
  pushl $35
80106aa4:	6a 23                	push   $0x23
  jmp alltraps
80106aa6:	e9 54 f9 ff ff       	jmp    801063ff <alltraps>
...
80106aab:	6a 00                	push   $0x0
  pushl $36
80106aad:	6a 24                	push   $0x24
  jmp alltraps
80106aaf:	e9 4b f9 ff ff       	jmp    801063ff <alltraps>
...
80106ab4:	6a 00                	push   $0x0
  pushl $37
80106ab6:	6a 25                	push   $0x25
  jmp alltraps
80106ab8:	e9 42 f9 ff ff       	jmp    801063ff <alltraps>
...
80106abd:	6a 00                	push   $0x0
  pushl $38
80106abf:	6a 26                	push   $0x26
  jmp alltraps
80106ac1:	e9 39 f9 ff ff       	jmp    801063ff <alltraps>
...
80106ac6:	6a 00                	push   $0x0
  pushl $39
80106ac8:	6a 27                	push   $0x27
  jmp alltraps
80106aca:	e9 30 f9 ff ff       	jmp    801063ff <alltraps>
...
80106acf:	6a 00                	push   $0x0
  pushl $40
80106ad1:	6a 28                	push   $0x28
  jmp alltraps
80106ad3:	e9 27 f9 ff ff       	jmp    801063ff <alltraps>
...
80106ad8:	6a 00                	push   $0x0
  pushl $41
80106ada:	6a 29                	push   $0x29
  jmp alltraps
80106adc:	e9 1e f9 ff ff       	jmp    801063ff <alltraps>
...
80106ae1:	6a 00                	push   $0x0
  pushl $42
80106ae3:	6a 2a                	push   $0x2a
  jmp alltraps
80106ae5:	e9 15 f9 ff ff       	jmp    801063ff <alltraps>
...
80106aea:	6a 00                	push   $0x0
  pushl $43
80106aec:	6a 2b                	push   $0x2b
  jmp alltraps
80106aee:	e9 0c f9 ff ff       	jmp    801063ff <alltraps>
...
80106af3:	6a 00                	push   $0x0
  pushl $44
80106af5:	6a 2c                	push   $0x2c
  jmp alltraps
80106af7:	e9 03 f9 ff ff       	jmp    801063ff <alltraps>
...
80106afc:	6a 00                	push   $0x0
  pushl $45
80106afe:	6a 2d                	push   $0x2d
  jmp alltraps
80106b00:	e9 fa f8 ff ff       	jmp    801063ff <alltraps>
...
80106b05:	6a 00                	push   $0x0
  pushl $46
80106b07:	6a 2e                	push   $0x2e
  jmp alltraps
80106b09:	e9 f1 f8 ff ff       	jmp    801063ff <alltraps>
...
80106b0e:	6a 00                	push   $0x0
  pushl $47
80106b10:	6a 2f                	push   $0x2f
  jmp alltraps
80106b12:	e9 e8 f8 ff ff       	jmp    801063ff <alltraps>
...
80106b17:	6a 00                	push   $0x0
  pushl $48
80106b19:	6a 30                	push   $0x30
  jmp alltraps
80106b1b:	e9 df f8 ff ff       	jmp    801063ff <alltraps>
...
80106de9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106dee:	e9 0c f6 ff ff       	jmp    801063ff <alltraps>
...
80106df3:	6a 00                	push   $0x0
  pushl $129
80106df5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106dfa:	e9 00 f6 ff ff       	jmp    801063ff <alltraps>
...
80106dff:	6a 00                	push   $0x0
  pushl $130
80106e01:	68 82 00 00 00       	push   $0x82
  jmp alltraps
...
80106e0b:	6a 00                	push   $0x0
  pushl $131
80106e0d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106e12:	e9 e8 f5 ff ff       	jmp    801063ff <alltraps>
...
80106e17:	6a 00                	push   $0x0
  pushl $132
80106e19:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106e1e:	e9 dc f5 ff ff       	jmp    801063ff <alltraps>
...
80106e23:	6a 00                	push   $0x0
  pushl $133
80106e25:	68 85 00 00 00       	push   $0x85
  jmp alltraps
...
80106e2f:	6a 00                	push   $0x0
  pushl $134
80106e31:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106e36:	e9 c4 f5 ff ff       	jmp    801063ff <alltraps>
...
80106e3b:	6a 00                	push   $0x0
  pushl $135
80106e3d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106e42:	e9 b8 f5 ff ff       	jmp    801063ff <alltraps>
...
80106e47:	6a 00                	push   $0x0
  pushl $136
80106e49:	68 88 00 00 00       	push   $0x88
  jmp alltraps
...
80106e53:	6a 00                	push   $0x0
  pushl $137
80106e55:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106e5a:	e9 a0 f5 ff ff       	jmp    801063ff <alltraps>
...
80106e5f:	6a 00                	push   $0x0
  pushl $138
80106e61:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106e66:	e9 94 f5 ff ff       	jmp    801063ff <alltraps>
...
80106e6b:	6a 00                	push   $0x0
  pushl $139
80106e6d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
...
80106e77:	6a 00                	push   $0x0
  pushl $140
80106e79:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106e7e:	e9 7c f5 ff ff       	jmp    801063ff <alltraps>
...
80106e83:	6a 00                	push   $0x0
  pushl $141
80106e85:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106e8a:	e9 70 f5 ff ff       	jmp    801063ff <alltraps>
...
80106e8f:	6a 00                	push   $0x0
  pushl $142
80106e91:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
...
80106e9b:	6a 00                	push   $0x0
  pushl $143
80106e9d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106ea2:	e9 58 f5 ff ff       	jmp    801063ff <alltraps>
...
80106ea7:	6a 00                	push   $0x0
  pushl $144
80106ea9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106eae:	e9 4c f5 ff ff       	jmp    801063ff <alltraps>
...
80106eb3:	6a 00                	push   $0x0
  pushl $145
80106eb5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
...
80106ebf:	6a 00                	push   $0x0
  pushl $146
80106ec1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106ec6:	e9 34 f5 ff ff       	jmp    801063ff <alltraps>
...
80106ecb:	6a 00                	push   $0x0
  pushl $147
80106ecd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106ed2:	e9 28 f5 ff ff       	jmp    801063ff <alltraps>
...
80106ed7:	6a 00                	push   $0x0
  pushl $148
80106ed9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
...
80106ee3:	6a 00                	push   $0x0
  pushl $149
80106ee5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106eea:	e9 10 f5 ff ff       	jmp    801063ff <alltraps>
...
80106eef:	6a 00                	push   $0x0
  pushl $150
80106ef1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106ef6:	e9 04 f5 ff ff       	jmp    801063ff <alltraps>
...
80106efb:	6a 00                	push   $0x0
  pushl $151
80106efd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
...
80106f07:	6a 00                	push   $0x0
  pushl $152
80106f09:	68 98 00 00 00       	push   $0x98
  jmp alltraps
...
80106f13:	6a 00                	push   $0x0
  pushl $153
80106f15:	68 99 00 00 00       	push   $0x99
  jmp alltraps
...
80106f1f:	6a 00                	push   $0x0
  pushl $154
80106f21:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
...
80106f2b:	6a 00                	push   $0x0
  pushl $155
80106f2d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
...
80106f37:	6a 00                	push   $0x0
  pushl $156
80106f39:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
...
80106f43:	6a 00                	push   $0x0
  pushl $157
80106f45:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
...
80106f4f:	6a 00                	push   $0x0
  pushl $158
80106f51:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
...
80106f5b:	6a 00                	push   $0x0
  pushl $159
80106f5d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
...
80106f67:	6a 00                	push   $0x0
  pushl $160
80106f69:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
...
80106f73:	6a 00                	push   $0x0
  pushl $161
80106f75:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
...
80106f7f:	6a 00                	push   $0x0
  pushl $162
80106f81:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
...
80106f8b:	6a 00                	push   $0x0
  pushl $163
80106f8d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
...
80106f97:	6a 00                	push   $0x0
  pushl $164
80106f99:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
...
80106fa3:	6a 00                	push   $0x0
  pushl $165
80106fa5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
...
80106faf:	6a 00                	push   $0x0
  pushl $166
80106fb1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
...
80106fbb:	6a 00                	push   $0x0
  pushl $167
80106fbd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
...
80106fc7:	6a 00                	push   $0x0
  pushl $168
80106fc9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
...
80106fd3:	6a 00                	push   $0x0
  pushl $169
80106fd5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
...
80106fdf:	6a 00                	push   $0x0
  pushl $170
80106fe1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
...
80106feb:	6a 00                	push   $0x0
  pushl $171
80106fed:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
...
80106ff7:	6a 00                	push   $0x0
  pushl $172
80106ff9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
...
80107003:	6a 00                	push   $0x0
  pushl $173
80107005:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
...
8010700f:	6a 00                	push   $0x0
  pushl $174
80107011:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
...
8010701b:	6a 00                	push   $0x0
  pushl $175
8010701d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
...
80107027:	6a 00                	push   $0x0
  pushl $176
80107029:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
...
80107033:	6a 00                	push   $0x0
  pushl $177
80107035:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
...
8010703f:	6a 00                	push   $0x0
  pushl $178
80107041:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
...
8010704b:	6a 00                	push   $0x0
  pushl $179
8010704d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
...
80107057:	6a 00                	push   $0x0
  pushl $180
80107059:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
...
80107063:	6a 00                	push   $0x0
  pushl $181
80107065:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
...
8010706f:	6a 00                	push   $0x0
  pushl $182
80107071:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
...
8010707b:	6a 00                	push   $0x0
  pushl $183
8010707d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
...
80107087:	6a 00                	push   $0x0
  pushl $184
80107089:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
...
80107093:	6a 00                	push   $0x0
  pushl $185
80107095:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
...
8010709f:	6a 00                	push   $0x0
  pushl $186
801070a1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
...
801070ab:	6a 00                	push   $0x0
  pushl $187
801070ad:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
...
801070b7:	6a 00                	push   $0x0
  pushl $188
801070b9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
...
801070c3:	6a 00                	push   $0x0
  pushl $189
801070c5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
...
801070cf:	6a 00                	push   $0x0
  pushl $190
801070d1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
...
801070db:	6a 00                	push   $0x0
  pushl $191
801070dd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
...
801070e7:	6a 00                	push   $0x0
  pushl $192
801070e9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
...
801070f3:	6a 00                	push   $0x0
  pushl $193
801070f5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
...
801070ff:	6a 00                	push   $0x0
  pushl $194
80107101:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
...
8010710b:	6a 00                	push   $0x0
  pushl $195
8010710d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
...
80107117:	6a 00                	push   $0x0
  pushl $196
80107119:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
...
80107123:	6a 00                	push   $0x0
  pushl $197
80107125:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
...
8010712f:	6a 00                	push   $0x0
  pushl $198
80107131:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
...
8010713b:	6a 00                	push   $0x0
  pushl $199
8010713d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
...
80107147:	6a 00                	push   $0x0
  pushl $200
80107149:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
...
80107153:	6a 00                	push   $0x0
  pushl $201
80107155:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
...
8010715f:	6a 00                	push   $0x0
  pushl $202
80107161:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
...
8010716b:	6a 00                	push   $0x0
  pushl $203
8010716d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
...
80107177:	6a 00                	push   $0x0
  pushl $204
80107179:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
...
80107183:	6a 00                	push   $0x0
  pushl $205
80107185:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
...
8010718f:	6a 00                	push   $0x0
  pushl $206
80107191:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
...
8010719b:	6a 00                	push   $0x0
  pushl $207
8010719d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
...
801071a7:	6a 00                	push   $0x0
  pushl $208
801071a9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
...
801071b3:	6a 00                	push   $0x0
  pushl $209
801071b5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
...
801071bf:	6a 00                	push   $0x0
  pushl $210
801071c1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
...
801071cb:	6a 00                	push   $0x0
  pushl $211
801071cd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
...
801071d7:	6a 00                	push   $0x0
  pushl $212
801071d9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
...
801071e3:	6a 00                	push   $0x0
  pushl $213
801071e5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
...
801071ef:	6a 00                	push   $0x0
  pushl $214
801071f1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
...
801071fb:	6a 00                	push   $0x0
  pushl $215
801071fd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
...
80107207:	6a 00                	push   $0x0
  pushl $216
80107209:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
...
80107213:	6a 00                	push   $0x0
  pushl $217
80107215:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
...
8010721f:	6a 00                	push   $0x0
  pushl $218
80107221:	68 da 00 00 00       	push   $0xda
  jmp alltraps
...
8010722b:	6a 00                	push   $0x0
  pushl $219
8010722d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
...
80107237:	6a 00                	push   $0x0
  pushl $220
80107239:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
...
80107243:	6a 00                	push   $0x0
  pushl $221
80107245:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
...
8010724f:	6a 00                	push   $0x0
  pushl $222
80107251:	68 de 00 00 00       	push   $0xde
  jmp alltraps
...
8010725b:	6a 00                	push   $0x0
  pushl $223
8010725d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
...
80107267:	6a 00                	push   $0x0
  pushl $224
80107269:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
...
80107273:	6a 00                	push   $0x0
  pushl $225
80107275:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
...
8010727f:	6a 00                	push   $0x0
  pushl $226
80107281:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
...
8010728b:	6a 00                	push   $0x0
  pushl $227
8010728d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
...
80107297:	6a 00                	push   $0x0
  pushl $228
80107299:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
...
801072a3:	6a 00                	push   $0x0
  pushl $229
801072a5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
...
801072af:	6a 00                	push   $0x0
  pushl $230
801072b1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
...
801072bb:	6a 00                	push   $0x0
  pushl $231
801072bd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
...
801072c7:	6a 00                	push   $0x0
  pushl $232
801072c9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
...
801072d3:	6a 00                	push   $0x0
  pushl $233
801072d5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
...
801072df:	6a 00                	push   $0x0
  pushl $234
801072e1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
...
801072eb:	6a 00                	push   $0x0
  pushl $235
801072ed:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
...
801072f7:	6a 00                	push   $0x0
  pushl $236
801072f9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
...
80107303:	6a 00                	push   $0x0
  pushl $237
80107305:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
...
8010730f:	6a 00                	push   $0x0
  pushl $238
80107311:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
...
8010731b:	6a 00                	push   $0x0
  pushl $239
8010731d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
...
80107327:	6a 00                	push   $0x0
  pushl $240
80107329:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
...
80107333:	6a 00                	push   $0x0
  pushl $241
80107335:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
...
8010733f:	6a 00                	push   $0x0
  pushl $242
80107341:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
...
8010734b:	6a 00                	push   $0x0
  pushl $243
8010734d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
...
80107357:	6a 00                	push   $0x0
  pushl $244
80107359:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
...
80107363:	6a 00                	push   $0x0
  pushl $245
80107365:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
...
8010736f:	6a 00                	push   $0x0
  pushl $246
80107371:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
...
8010737b:	6a 00                	push   $0x0
  pushl $247
8010737d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
...
80107387:	6a 00                	push   $0x0
  pushl $248
80107389:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
...
80107393:	6a 00                	push   $0x0
  pushl $249
80107395:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
...
8010739f:	6a 00                	push   $0x0
  pushl $250
801073a1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
...
801073ab:	6a 00                	push   $0x0
  pushl $251
801073ad:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
...
801073b7:	6a 00                	push   $0x0
  pushl $252
801073b9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
...
801073c3:	6a 00                	push   $0x0
  pushl $253
801073c5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
...
801073cf:	6a 00                	push   $0x0
  pushl $254
801073d1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
...
801073db:	6a 00                	push   $0x0
  pushl $255
801073dd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
...
801073f5:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
801073f6:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
801073fc:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80107402:	83 ec 1c             	sub    $0x1c,%esp
80107405:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107408:	39 d3                	cmp    %edx,%ebx
8010740a:	73 49                	jae    80107455 <deallocuvm.part.0+0x65>
8010740c:	89 c7                	mov    %eax,%edi
8010740e:	eb 0c                	jmp    8010741c <deallocuvm.part.0+0x2c>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80107410:	83 c0 01             	add    $0x1,%eax
80107413:	c1 e0 16             	shl    $0x16,%eax
80107416:	89 c3                	mov    %eax,%ebx
  for(; a  < oldsz; a += PGSIZE){
80107418:	39 da                	cmp    %ebx,%edx
8010741a:	76 39                	jbe    80107455 <deallocuvm.part.0+0x65>
  pde = &pgdir[PDX(va)];
8010741c:	89 d8                	mov    %ebx,%eax
8010741e:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80107421:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
80107424:	f6 c1 01             	test   $0x1,%cl
80107427:	74 e7                	je     80107410 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
80107429:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010742b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80107431:	c1 ee 0a             	shr    $0xa,%esi
80107434:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
8010743a:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
    if(!pte)
80107441:	85 f6                	test   %esi,%esi
80107443:	74 cb                	je     80107410 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
80107445:	8b 06                	mov    (%esi),%eax
80107447:	a8 01                	test   $0x1,%al
80107449:	75 15                	jne    80107460 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
8010744b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107451:	39 da                	cmp    %ebx,%edx
80107453:	77 c7                	ja     8010741c <deallocuvm.part.0+0x2c>
      kfree(v);
      *pte = 0;
    }
  }
...
80107455:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
8010745f:	c3                   	ret    
      if(pa == 0)
80107460:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107465:	74 25                	je     8010748c <deallocuvm.part.0+0x9c>
      kfree(v);
80107467:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
8010746a:	05 00 00 00 80       	add    $0x80000000,%eax
8010746f:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107472:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80107478:	50                   	push   %eax
80107479:	e8 42 b0 ff ff       	call   801024c0 <kfree>
      *pte = 0;
8010747e:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  for(; a  < oldsz; a += PGSIZE){
80107484:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107487:	83 c4 10             	add    $0x10,%esp
8010748a:	eb 8c                	jmp    80107418 <deallocuvm.part.0+0x28>
        panic("kfree");
8010748c:	83 ec 0c             	sub    $0xc,%esp
8010748f:	68 a6 80 10 80       	push   $0x801080a6
...
{
801074ae:	83 ec 1c             	sub    $0x1c,%esp
801074b1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801074b4:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
801074b8:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801074bd:	89 45 dc             	mov    %eax,-0x24(%ebp)
801074c0:	8b 45 08             	mov    0x8(%ebp),%eax
801074c3:	29 d8                	sub    %ebx,%eax
801074c5:	89 45 e0             	mov    %eax,-0x20(%ebp)
801074c8:	eb 3d                	jmp    80107507 <mappages+0x67>
801074ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
801074d0:	89 da                	mov    %ebx,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
...
801074e9:	74 75                	je     80107560 <mappages+0xc0>
    if(*pte & PTE_P)
801074eb:	f6 00 01             	testb  $0x1,(%eax)
801074ee:	0f 85 86 00 00 00    	jne    8010757a <mappages+0xda>
    *pte = pa | perm | PTE_P;
801074f4:	0b 75 0c             	or     0xc(%ebp),%esi
801074f7:	83 ce 01             	or     $0x1,%esi
801074fa:	89 30                	mov    %esi,(%eax)
    if(a == last)
801074fc:	3b 5d dc             	cmp    -0x24(%ebp),%ebx
801074ff:	74 6f                	je     80107570 <mappages+0xd0>
    a += PGSIZE;
80107501:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80107507:	8b 45 e0             	mov    -0x20(%ebp),%eax
  pde = &pgdir[PDX(va)];
8010750a:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010750d:	8d 34 18             	lea    (%eax,%ebx,1),%esi
80107510:	89 d8                	mov    %ebx,%eax
80107512:	c1 e8 16             	shr    $0x16,%eax
80107515:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
80107518:	8b 07                	mov    (%edi),%eax
8010751a:	a8 01                	test   $0x1,%al
8010751c:	75 b2                	jne    801074d0 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
8010751e:	e8 5d b1 ff ff       	call   80102680 <kalloc>
80107523:	85 c0                	test   %eax,%eax
80107525:	74 39                	je     80107560 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80107527:	83 ec 04             	sub    $0x4,%esp
8010752a:	89 45 d8             	mov    %eax,-0x28(%ebp)
8010752d:	68 00 10 00 00       	push   $0x1000
80107532:	6a 00                	push   $0x0
80107534:	50                   	push   %eax
80107535:	e8 86 db ff ff       	call   801050c0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010753a:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
8010753d:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80107540:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80107546:	83 c8 07             	or     $0x7,%eax
80107549:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
8010754b:	89 d8                	mov    %ebx,%eax
8010754d:	c1 e8 0a             	shr    $0xa,%eax
80107550:	25 fc 0f 00 00       	and    $0xffc,%eax
80107555:	01 d0                	add    %edx,%eax
80107557:	eb 92                	jmp    801074eb <mappages+0x4b>
...
8010757d:	68 8c 87 10 80       	push   $0x8010878c
80107582:	e8 f9 8d ff ff       	call   80100380 <panic>
...
80107593:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80107596:	e8 65 c6 ff ff       	call   80103c00 <cpuid>
  pd[0] = size-1;
8010759b:	ba 2f 00 00 00       	mov    $0x2f,%edx
801075a0:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
801075a6:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801075aa:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
801075b1:	ff 00 00 
801075b4:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
801075bb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801075be:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
801075c5:	ff 00 00 
801075c8:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
801075cf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801075d2:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
801075d9:	ff 00 00 
801075dc:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
801075e3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801075e6:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
801075ed:	ff 00 00 
801075f0:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
801075f7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801075fa:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
801075ff:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80107603:	c1 e8 10             	shr    $0x10,%eax
80107606:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
8010760a:	8d 45 f2             	lea    -0xe(%ebp),%eax
8010760d:	0f 01 10             	lgdtl  (%eax)
}
80107610:	c9                   	leave  
80107611:	c3                   	ret    
...
80107620:	a1 44 5e 11 80       	mov    0x80115e44,%eax
...
8010763e:	0f 84 cb 00 00 00    	je     8010770f <switchuvm+0xdf>
  if(p->kstack == 0)
80107644:	8b 46 08             	mov    0x8(%esi),%eax
80107647:	85 c0                	test   %eax,%eax
80107649:	0f 84 da 00 00 00    	je     80107729 <switchuvm+0xf9>
  if(p->pgdir == 0)
8010764f:	8b 46 04             	mov    0x4(%esi),%eax
80107652:	85 c0                	test   %eax,%eax
80107654:	0f 84 c2 00 00 00    	je     8010771c <switchuvm+0xec>
  pushcli();
8010765a:	e8 51 d8 ff ff       	call   80104eb0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010765f:	e8 3c c5 ff ff       	call   80103ba0 <mycpu>
80107664:	89 c3                	mov    %eax,%ebx
80107666:	e8 35 c5 ff ff       	call   80103ba0 <mycpu>
8010766b:	89 c7                	mov    %eax,%edi
8010766d:	e8 2e c5 ff ff       	call   80103ba0 <mycpu>
80107672:	83 c7 08             	add    $0x8,%edi
80107675:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107678:	e8 23 c5 ff ff       	call   80103ba0 <mycpu>
8010767d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80107680:	ba 67 00 00 00       	mov    $0x67,%edx
80107685:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
8010768c:	83 c0 08             	add    $0x8,%eax
8010768f:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107696:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010769b:	83 c1 08             	add    $0x8,%ecx
8010769e:	c1 e8 18             	shr    $0x18,%eax
801076a1:	c1 e9 10             	shr    $0x10,%ecx
801076a4:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
801076aa:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
801076b0:	b9 99 40 00 00       	mov    $0x4099,%ecx
801076b5:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801076bc:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
801076c1:	e8 da c4 ff ff       	call   80103ba0 <mycpu>
801076c6:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801076cd:	e8 ce c4 ff ff       	call   80103ba0 <mycpu>
801076d2:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
801076d6:	8b 5e 08             	mov    0x8(%esi),%ebx
801076d9:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801076df:	e8 bc c4 ff ff       	call   80103ba0 <mycpu>
801076e4:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801076e7:	e8 b4 c4 ff ff       	call   80103ba0 <mycpu>
801076ec:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
801076f0:	b8 28 00 00 00       	mov    $0x28,%eax
801076f5:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
801076f8:	8b 46 04             	mov    0x4(%esi),%eax
...
80107709:	5d                   	pop    %ebp
  popcli();
8010770a:	e9 f1 d7 ff ff       	jmp    80104f00 <popcli>
    panic("switchuvm: no process");
8010770f:	83 ec 0c             	sub    $0xc,%esp
80107712:	68 92 87 10 80       	push   $0x80108792
80107717:	e8 64 8c ff ff       	call   80100380 <panic>
    panic("switchuvm: no pgdir");
8010771c:	83 ec 0c             	sub    $0xc,%esp
8010771f:	68 bd 87 10 80       	push   $0x801087bd
80107724:	e8 57 8c ff ff       	call   80100380 <panic>
    panic("switchuvm: no kstack");
80107729:	83 ec 0c             	sub    $0xc,%esp
8010772c:	68 a8 87 10 80       	push   $0x801087a8
...
8010774c:	8b 75 10             	mov    0x10(%ebp),%esi
8010774f:	8b 7d 08             	mov    0x8(%ebp),%edi
80107752:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80107755:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
8010775b:	77 4b                	ja     801077a8 <inituvm+0x68>
  mem = kalloc();
8010775d:	e8 1e af ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
8010776f:	e8 4c d9 ff ff       	call   801050c0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80107774:	58                   	pop    %eax
80107775:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010777b:	5a                   	pop    %edx
8010777c:	6a 06                	push   $0x6
8010777e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107783:	31 d2                	xor    %edx,%edx
80107785:	50                   	push   %eax
80107786:	89 f8                	mov    %edi,%eax
80107788:	e8 13 fd ff ff       	call   801074a0 <mappages>
  memmove(mem, init, sz);
8010778d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107790:	89 75 10             	mov    %esi,0x10(%ebp)
80107793:	83 c4 10             	add    $0x10,%esp
80107796:	89 5d 08             	mov    %ebx,0x8(%ebp)
80107799:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
801077a2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801077a3:	e9 b8 d9 ff ff       	jmp    80105160 <memmove>
    panic("inituvm: more than a page");
801077a8:	83 ec 0c             	sub    $0xc,%esp
801077ab:	68 d1 87 10 80       	push   $0x801087d1
801077b0:	e8 cb 8b ff ff       	call   80100380 <panic>
...
801077cc:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
801077cf:	a9 ff 0f 00 00       	test   $0xfff,%eax
801077d4:	0f 85 bb 00 00 00    	jne    80107895 <loaduvm+0xd5>
  for(i = 0; i < sz; i += PGSIZE){
801077da:	01 f0                	add    %esi,%eax
801077dc:	89 f3                	mov    %esi,%ebx
801077de:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
801077e1:	8b 45 14             	mov    0x14(%ebp),%eax
801077e4:	01 f0                	add    %esi,%eax
801077e6:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
801077e9:	85 f6                	test   %esi,%esi
801077eb:	0f 84 87 00 00 00    	je     80107878 <loaduvm+0xb8>
801077f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
801077f8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  if(*pde & PTE_P){
801077fb:	8b 4d 08             	mov    0x8(%ebp),%ecx
801077fe:	29 d8                	sub    %ebx,%eax
  pde = &pgdir[PDX(va)];
80107800:	89 c2                	mov    %eax,%edx
80107802:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80107805:	8b 14 91             	mov    (%ecx,%edx,4),%edx
80107808:	f6 c2 01             	test   $0x1,%dl
8010780b:	75 13                	jne    80107820 <loaduvm+0x60>
      panic("loaduvm: address should exist");
8010780d:	83 ec 0c             	sub    $0xc,%esp
80107810:	68 eb 87 10 80       	push   $0x801087eb
80107815:	e8 66 8b ff ff       	call   80100380 <panic>
...
80107837:	74 d4                	je     8010780d <loaduvm+0x4d>
    pa = PTE_ADDR(*pte);
80107839:	8b 00                	mov    (%eax),%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
8010783b:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    if(sz - i < PGSIZE)
8010783e:	bf 00 10 00 00       	mov    $0x1000,%edi
    pa = PTE_ADDR(*pte);
80107843:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80107848:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
8010784e:	0f 46 fb             	cmovbe %ebx,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107851:	29 d9                	sub    %ebx,%ecx
80107853:	05 00 00 00 80       	add    $0x80000000,%eax
80107858:	57                   	push   %edi
80107859:	51                   	push   %ecx
8010785a:	50                   	push   %eax
8010785b:	ff 75 10             	push   0x10(%ebp)
8010785e:	e8 2d a2 ff ff       	call   80101a90 <readi>
80107863:	83 c4 10             	add    $0x10,%esp
80107866:	39 f8                	cmp    %edi,%eax
80107868:	75 1e                	jne    80107888 <loaduvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
8010786a:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80107870:	89 f0                	mov    %esi,%eax
80107872:	29 d8                	sub    %ebx,%eax
80107874:	39 c6                	cmp    %eax,%esi
80107876:	77 80                	ja     801077f8 <loaduvm+0x38>
}
...
80107888:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
8010788b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80107890:	5b                   	pop    %ebx
80107891:	5e                   	pop    %esi
80107892:	5f                   	pop    %edi
...
80107898:	68 8c 88 10 80       	push   $0x8010888c
8010789d:	e8 de 8a ff ff       	call   80100380 <panic>
...
801078b6:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
801078b9:	8b 45 10             	mov    0x10(%ebp),%eax
{
801078bc:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
801078bf:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801078c2:	85 c0                	test   %eax,%eax
801078c4:	0f 88 b6 00 00 00    	js     80107980 <allocuvm+0xd0>
  if(newsz < oldsz)
801078ca:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
801078cd:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
801078d0:	0f 82 9a 00 00 00    	jb     80107970 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
801078d6:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
801078dc:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
801078e2:	39 75 10             	cmp    %esi,0x10(%ebp)
801078e5:	77 44                	ja     8010792b <allocuvm+0x7b>
801078e7:	e9 87 00 00 00       	jmp    80107973 <allocuvm+0xc3>
801078ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    memset(mem, 0, PGSIZE);
801078f0:	83 ec 04             	sub    $0x4,%esp
801078f3:	68 00 10 00 00       	push   $0x1000
801078f8:	6a 00                	push   $0x0
801078fa:	50                   	push   %eax
801078fb:	e8 c0 d7 ff ff       	call   801050c0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80107900:	58                   	pop    %eax
80107901:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80107907:	5a                   	pop    %edx
80107908:	6a 06                	push   $0x6
8010790a:	b9 00 10 00 00       	mov    $0x1000,%ecx
8010790f:	89 f2                	mov    %esi,%edx
80107911:	50                   	push   %eax
80107912:	89 f8                	mov    %edi,%eax
80107914:	e8 87 fb ff ff       	call   801074a0 <mappages>
80107919:	83 c4 10             	add    $0x10,%esp
8010791c:	85 c0                	test   %eax,%eax
8010791e:	78 78                	js     80107998 <allocuvm+0xe8>
  for(; a < newsz; a += PGSIZE){
80107920:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107926:	39 75 10             	cmp    %esi,0x10(%ebp)
80107929:	76 48                	jbe    80107973 <allocuvm+0xc3>
    mem = kalloc();
8010792b:	e8 50 ad ff ff       	call   80102680 <kalloc>
80107930:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80107932:	85 c0                	test   %eax,%eax
80107934:	75 ba                	jne    801078f0 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80107936:	83 ec 0c             	sub    $0xc,%esp
80107939:	68 09 88 10 80       	push   $0x80108809
8010793e:	e8 5d 8d ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
80107943:	8b 45 0c             	mov    0xc(%ebp),%eax
80107946:	83 c4 10             	add    $0x10,%esp
80107949:	39 45 10             	cmp    %eax,0x10(%ebp)
8010794c:	74 32                	je     80107980 <allocuvm+0xd0>
8010794e:	8b 55 10             	mov    0x10(%ebp),%edx
80107951:	89 c1                	mov    %eax,%ecx
80107953:	89 f8                	mov    %edi,%eax
80107955:	e8 96 fa ff ff       	call   801073f0 <deallocuvm.part.0>
      return 0;
8010795a:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
80107961:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
80107973:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107976:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107979:	5b                   	pop    %ebx
8010797a:	5e                   	pop    %esi
8010797b:	5f                   	pop    %edi
8010797c:	5d                   	pop    %ebp
...
8010797e:	66 90                	xchg   %ax,%ax
    return 0;
80107980:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
80107987:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
8010799b:	68 21 88 10 80       	push   $0x80108821
801079a0:	e8 fb 8c ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
801079a5:	8b 45 0c             	mov    0xc(%ebp),%eax
801079a8:	83 c4 10             	add    $0x10,%esp
801079ab:	39 45 10             	cmp    %eax,0x10(%ebp)
801079ae:	74 0c                	je     801079bc <allocuvm+0x10c>
801079b0:	8b 55 10             	mov    0x10(%ebp),%edx
801079b3:	89 c1                	mov    %eax,%ecx
801079b5:	89 f8                	mov    %edi,%eax
801079b7:	e8 34 fa ff ff       	call   801073f0 <deallocuvm.part.0>
      kfree(mem);
801079bc:	83 ec 0c             	sub    $0xc,%esp
801079bf:	53                   	push   %ebx
801079c0:	e8 fb aa ff ff       	call   801024c0 <kfree>
      return 0;
801079c5:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801079cc:	83 c4 10             	add    $0x10,%esp
}
801079cf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801079d2:	8d 65 f4             	lea    -0xc(%ebp),%esp
801079d5:	5b                   	pop    %ebx
801079d6:	5e                   	pop    %esi
801079d7:	5f                   	pop    %edi
801079d8:	5d                   	pop    %ebp
...
801079e3:	8b 55 0c             	mov    0xc(%ebp),%edx
801079e6:	8b 4d 10             	mov    0x10(%ebp),%ecx
801079e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
801079ec:	39 d1                	cmp    %edx,%ecx
801079ee:	73 10                	jae    80107a00 <deallocuvm+0x20>
}
801079f0:	5d                   	pop    %ebp
801079f1:	e9 fa f9 ff ff       	jmp    801073f0 <deallocuvm.part.0>
801079f6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801079fd:	8d 76 00             	lea    0x0(%esi),%esi
80107a00:	89 d0                	mov    %edx,%eax
80107a02:	5d                   	pop    %ebp
80107a03:	c3                   	ret    
80107a04:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80107a19:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
80107a1c:	85 f6                	test   %esi,%esi
80107a1e:	74 59                	je     80107a79 <freevm+0x69>
  if(newsz >= oldsz)
80107a20:	31 c9                	xor    %ecx,%ecx
80107a22:	ba 00 00 00 80       	mov    $0x80000000,%edx
80107a27:	89 f0                	mov    %esi,%eax
80107a29:	89 f3                	mov    %esi,%ebx
80107a2b:	e8 c0 f9 ff ff       	call   801073f0 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80107a30:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80107a36:	eb 0f                	jmp    80107a47 <freevm+0x37>
80107a38:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107a3f:	90                   	nop
80107a40:	83 c3 04             	add    $0x4,%ebx
80107a43:	39 df                	cmp    %ebx,%edi
80107a45:	74 23                	je     80107a6a <freevm+0x5a>
    if(pgdir[i] & PTE_P){
80107a47:	8b 03                	mov    (%ebx),%eax
80107a49:	a8 01                	test   $0x1,%al
80107a4b:	74 f3                	je     80107a40 <freevm+0x30>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80107a4d:	25 00 f0 ff ff       	and    $0xfffff000,%eax
      kfree(v);
80107a52:	83 ec 0c             	sub    $0xc,%esp
  for(i = 0; i < NPDENTRIES; i++){
80107a55:	83 c3 04             	add    $0x4,%ebx
      char * v = P2V(PTE_ADDR(pgdir[i]));
80107a58:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
80107a5d:	50                   	push   %eax
80107a5e:	e8 5d aa ff ff       	call   801024c0 <kfree>
80107a63:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NPDENTRIES; i++){
80107a66:	39 df                	cmp    %ebx,%edi
80107a68:	75 dd                	jne    80107a47 <freevm+0x37>
    }
  }
  kfree((char*)pgdir);
80107a6a:	89 75 08             	mov    %esi,0x8(%ebp)
}
80107a6d:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107a70:	5b                   	pop    %ebx
80107a71:	5e                   	pop    %esi
80107a72:	5f                   	pop    %edi
80107a73:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107a74:	e9 47 aa ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80107a79:	83 ec 0c             	sub    $0xc,%esp
80107a7c:	68 3d 88 10 80       	push   $0x8010883d
80107a81:	e8 fa 88 ff ff       	call   80100380 <panic>
...
80107a9e:	74 42                	je     80107ae2 <setupkvm+0x52>
  memset(pgdir, 0, PGSIZE);
80107aa0:	83 ec 04             	sub    $0x4,%esp
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107aa3:	bb 20 b4 10 80       	mov    $0x8010b420,%ebx
  memset(pgdir, 0, PGSIZE);
80107aa8:	68 00 10 00 00       	push   $0x1000
80107aad:	6a 00                	push   $0x0
80107aaf:	50                   	push   %eax
80107ab0:	e8 0b d6 ff ff       	call   801050c0 <memset>
80107ab5:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
80107ab8:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80107abb:	83 ec 08             	sub    $0x8,%esp
80107abe:	8b 4b 08             	mov    0x8(%ebx),%ecx
80107ac1:	ff 73 0c             	push   0xc(%ebx)
80107ac4:	8b 13                	mov    (%ebx),%edx
80107ac6:	50                   	push   %eax
80107ac7:	29 c1                	sub    %eax,%ecx
80107ac9:	89 f0                	mov    %esi,%eax
80107acb:	e8 d0 f9 ff ff       	call   801074a0 <mappages>
80107ad0:	83 c4 10             	add    $0x10,%esp
80107ad3:	85 c0                	test   %eax,%eax
80107ad5:	78 19                	js     80107af0 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107ad7:	83 c3 10             	add    $0x10,%ebx
80107ada:	81 fb 60 b4 10 80    	cmp    $0x8010b460,%ebx
80107ae0:	75 d6                	jne    80107ab8 <setupkvm+0x28>
}
80107ae2:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
80107af3:	56                   	push   %esi
      return 0;
80107af4:	31 f6                	xor    %esi,%esi
      freevm(pgdir);
80107af6:	e8 15 ff ff ff       	call   80107a10 <freevm>
      return 0;
80107afb:	83 c4 10             	add    $0x10,%esp
}
80107afe:	8d 65 f8             	lea    -0x8(%ebp),%esp
80107b01:	89 f0                	mov    %esi,%eax
80107b03:	5b                   	pop    %ebx
80107b04:	5e                   	pop    %esi
80107b05:	5d                   	pop    %ebp
80107b06:	c3                   	ret    
80107b07:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80107b13:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107b16:	e8 75 ff ff ff       	call   80107a90 <setupkvm>
80107b1b:	a3 44 5e 11 80       	mov    %eax,0x80115e44
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80107b20:	05 00 00 00 80       	add    $0x80000000,%eax
80107b25:	0f 22 d8             	mov    %eax,%cr3
}
80107b28:	c9                   	leave  
80107b29:	c3                   	ret    
...
80107b39:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
80107b3c:	89 c1                	mov    %eax,%ecx
80107b3e:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80107b41:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
80107b44:	f6 c2 01             	test   $0x1,%dl
80107b47:	75 17                	jne    80107b60 <clearpteu+0x30>
  pte_t *pte;
...
80107b4c:	68 4e 88 10 80       	push   $0x8010884e
...
80107b5d:	8d 76 00             	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80107b60:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107b63:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80107b69:	25 fc 0f 00 00       	and    $0xffc,%eax
80107b6e:	8d 84 02 00 00 00 80 	lea    -0x80000000(%edx,%eax,1),%eax
  if(pte == 0)
80107b75:	85 c0                	test   %eax,%eax
80107b77:	74 d0                	je     80107b49 <clearpteu+0x19>
  *pte &= ~PTE_U;
80107b79:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
80107b7c:	c9                   	leave  
80107b7d:	c3                   	ret    
...
80107b86:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80107b89:	e8 02 ff ff ff       	call   80107a90 <setupkvm>
80107b8e:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107b91:	85 c0                	test   %eax,%eax
80107b93:	0f 84 bd 00 00 00    	je     80107c56 <copyuvm+0xd6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107b99:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80107b9c:	85 c9                	test   %ecx,%ecx
80107b9e:	0f 84 b2 00 00 00    	je     80107c56 <copyuvm+0xd6>
80107ba4:	31 f6                	xor    %esi,%esi
80107ba6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107bad:	8d 76 00             	lea    0x0(%esi),%esi
  if(*pde & PTE_P){
80107bb0:	8b 4d 08             	mov    0x8(%ebp),%ecx
  pde = &pgdir[PDX(va)];
80107bb3:	89 f0                	mov    %esi,%eax
80107bb5:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80107bb8:	8b 04 81             	mov    (%ecx,%eax,4),%eax
80107bbb:	a8 01                	test   $0x1,%al
80107bbd:	75 11                	jne    80107bd0 <copyuvm+0x50>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80107bbf:	83 ec 0c             	sub    $0xc,%esp
80107bc2:	68 58 88 10 80       	push   $0x80108858
80107bc7:	e8 b4 87 ff ff       	call   80100380 <panic>
80107bcc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  return &pgtab[PTX(va)];
80107bd0:	89 f2                	mov    %esi,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107bd2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80107bd7:	c1 ea 0a             	shr    $0xa,%edx
80107bda:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80107be0:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80107be7:	85 c0                	test   %eax,%eax
80107be9:	74 d4                	je     80107bbf <copyuvm+0x3f>
    if(!(*pte & PTE_P))
80107beb:	8b 00                	mov    (%eax),%eax
80107bed:	a8 01                	test   $0x1,%al
80107bef:	0f 84 9f 00 00 00    	je     80107c94 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80107bf5:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
80107bf7:	25 ff 0f 00 00       	and    $0xfff,%eax
80107bfc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80107bff:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107c05:	e8 76 aa ff ff       	call   80102680 <kalloc>
80107c0a:	89 c3                	mov    %eax,%ebx
80107c0c:	85 c0                	test   %eax,%eax
80107c0e:	74 64                	je     80107c74 <copyuvm+0xf4>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
80107c10:	83 ec 04             	sub    $0x4,%esp
80107c13:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80107c19:	68 00 10 00 00       	push   $0x1000
80107c1e:	57                   	push   %edi
80107c1f:	50                   	push   %eax
80107c20:	e8 3b d5 ff ff       	call   80105160 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80107c25:	58                   	pop    %eax
80107c26:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80107c2c:	5a                   	pop    %edx
80107c2d:	ff 75 e4             	push   -0x1c(%ebp)
80107c30:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107c35:	89 f2                	mov    %esi,%edx
80107c37:	50                   	push   %eax
80107c38:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107c3b:	e8 60 f8 ff ff       	call   801074a0 <mappages>
80107c40:	83 c4 10             	add    $0x10,%esp
80107c43:	85 c0                	test   %eax,%eax
80107c45:	78 21                	js     80107c68 <copyuvm+0xe8>
  for(i = 0; i < sz; i += PGSIZE){
80107c47:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107c4d:	39 75 0c             	cmp    %esi,0xc(%ebp)
80107c50:	0f 87 5a ff ff ff    	ja     80107bb0 <copyuvm+0x30>
  return d;
...
80107c56:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107c59:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107c5c:	5b                   	pop    %ebx
80107c5d:	5e                   	pop    %esi
80107c5e:	5f                   	pop    %edi
80107c5f:	5d                   	pop    %ebp
...
80107c6c:	e8 4f a8 ff ff       	call   801024c0 <kfree>
      goto bad;
80107c71:	83 c4 10             	add    $0x10,%esp
  freevm(d);
80107c74:	83 ec 0c             	sub    $0xc,%esp
80107c77:	ff 75 e0             	push   -0x20(%ebp)
80107c7a:	e8 91 fd ff ff       	call   80107a10 <freevm>
  return 0;
80107c7f:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
80107c86:	83 c4 10             	add    $0x10,%esp
}
80107c89:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80107c97:	68 72 88 10 80       	push   $0x80108872
80107c9c:	e8 df 86 ff ff       	call   80100380 <panic>
...
80107cb3:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80107cb6:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
80107cb9:	89 c1                	mov    %eax,%ecx
80107cbb:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80107cbe:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
80107cc1:	f6 c2 01             	test   $0x1,%dl
80107cc4:	0f 84 00 01 00 00    	je     80107dca <uva2ka.cold>
  return &pgtab[PTX(va)];
80107cca:	c1 e8 0c             	shr    $0xc,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107ccd:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  if((*pte & PTE_P) == 0)
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
80107cd3:	5d                   	pop    %ebp
  return &pgtab[PTX(va)];
80107cd4:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
80107cd9:	8b 84 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%eax
  if((*pte & PTE_U) == 0)
80107ce0:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107ce2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
80107ce7:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107cea:	05 00 00 00 80       	add    $0x80000000,%eax
80107cef:	83 fa 05             	cmp    $0x5,%edx
80107cf2:	ba 00 00 00 00       	mov    $0x0,%edx
80107cf7:	0f 45 c2             	cmovne %edx,%eax
}
80107cfa:	c3                   	ret    
...
80107d09:	8b 75 14             	mov    0x14(%ebp),%esi
80107d0c:	8b 45 0c             	mov    0xc(%ebp),%eax
80107d0f:	8b 55 10             	mov    0x10(%ebp),%edx
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80107d12:	85 f6                	test   %esi,%esi
80107d14:	75 51                	jne    80107d67 <copyout+0x67>
80107d16:	e9 a5 00 00 00       	jmp    80107dc0 <copyout+0xc0>
80107d1b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107d1f:	90                   	nop
  return (char*)P2V(PTE_ADDR(*pte));
80107d20:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80107d26:	8d 8b 00 00 00 80    	lea    -0x80000000(%ebx),%ecx
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
80107d2c:	81 fb 00 00 00 80    	cmp    $0x80000000,%ebx
80107d32:	74 75                	je     80107da9 <copyout+0xa9>
      return -1;
    n = PGSIZE - (va - va0);
80107d34:	89 fb                	mov    %edi,%ebx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80107d36:	89 55 10             	mov    %edx,0x10(%ebp)
    n = PGSIZE - (va - va0);
80107d39:	29 c3                	sub    %eax,%ebx
80107d3b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107d41:	39 f3                	cmp    %esi,%ebx
80107d43:	0f 47 de             	cmova  %esi,%ebx
    memmove(pa0 + (va - va0), buf, n);
80107d46:	29 f8                	sub    %edi,%eax
80107d48:	83 ec 04             	sub    $0x4,%esp
80107d4b:	01 c1                	add    %eax,%ecx
80107d4d:	53                   	push   %ebx
80107d4e:	52                   	push   %edx
80107d4f:	51                   	push   %ecx
80107d50:	e8 0b d4 ff ff       	call   80105160 <memmove>
    len -= n;
    buf += n;
80107d55:	8b 55 10             	mov    0x10(%ebp),%edx
    va = va0 + PGSIZE;
80107d58:	8d 87 00 10 00 00    	lea    0x1000(%edi),%eax
  while(len > 0){
80107d5e:	83 c4 10             	add    $0x10,%esp
    buf += n;
80107d61:	01 da                	add    %ebx,%edx
  while(len > 0){
80107d63:	29 de                	sub    %ebx,%esi
80107d65:	74 59                	je     80107dc0 <copyout+0xc0>
  if(*pde & PTE_P){
80107d67:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pde = &pgdir[PDX(va)];
80107d6a:	89 c1                	mov    %eax,%ecx
    va0 = (uint)PGROUNDDOWN(va);
80107d6c:	89 c7                	mov    %eax,%edi
  pde = &pgdir[PDX(va)];
80107d6e:	c1 e9 16             	shr    $0x16,%ecx
    va0 = (uint)PGROUNDDOWN(va);
80107d71:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  if(*pde & PTE_P){
80107d77:	8b 0c 8b             	mov    (%ebx,%ecx,4),%ecx
80107d7a:	f6 c1 01             	test   $0x1,%cl
80107d7d:	0f 84 4e 00 00 00    	je     80107dd1 <copyout.cold>
  return &pgtab[PTX(va)];
80107d83:	89 fb                	mov    %edi,%ebx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107d85:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80107d8b:	c1 eb 0c             	shr    $0xc,%ebx
80107d8e:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
  if((*pte & PTE_P) == 0)
80107d94:	8b 9c 99 00 00 00 80 	mov    -0x80000000(%ecx,%ebx,4),%ebx
  if((*pte & PTE_U) == 0)
80107d9b:	89 d9                	mov    %ebx,%ecx
80107d9d:	83 e1 05             	and    $0x5,%ecx
80107da0:	83 f9 05             	cmp    $0x5,%ecx
80107da3:	0f 84 77 ff ff ff    	je     80107d20 <copyout+0x20>
  }
  return 0;
}
...
80107dca <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
80107dca:	a1 00 00 00 00       	mov    0x0,%eax
80107dcf:	0f 0b                	ud2    

80107dd1 <copyout.cold>:
80107dd1:	a1 00 00 00 00       	mov    0x0,%eax
80107dd6:	0f 0b                	ud2    
80107dd8:	66 90                	xchg   %ax,%ax
80107dda:	66 90                	xchg   %ax,%ax
80107ddc:	66 90                	xchg   %ax,%ax
...
80107de3:	83 ec 10             	sub    $0x10,%esp
    cprintf("%s\n", str);
80107de6:	ff 75 08             	push   0x8(%ebp)
80107de9:	68 af 88 10 80       	push   $0x801088af
80107dee:	e8 ad 88 ff ff       	call   801006a0 <cprintf>
    return 0xABCDABCD;
}
80107df3:	b8 cd ab cd ab       	mov    $0xabcdabcd,%eax
80107df8:	c9                   	leave  
80107df9:	c3                   	ret    
80107dfa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80107e00 <sys_myfunction>:
...
80107e03:	83 ec 20             	sub    $0x20,%esp
    char *str;
    // Decode argument using argstr
    if (argstr(0, &str) < 0)
80107e06:	8d 45 f4             	lea    -0xc(%ebp),%eax
80107e09:	50                   	push   %eax
80107e0a:	6a 00                	push   $0x0
80107e0c:	e8 2f d6 ff ff       	call   80105440 <argstr>
...
80107e1d:	78 18                	js     80107e37 <sys_myfunction+0x37>
    cprintf("%s\n", str);
80107e1f:	83 ec 08             	sub    $0x8,%esp
80107e22:	ff 75 f4             	push   -0xc(%ebp)
80107e25:	68 af 88 10 80       	push   $0x801088af
80107e2a:	e8 71 88 ff ff       	call   801006a0 <cprintf>
        return -1;
    return myfunction(str);
80107e2f:	83 c4 10             	add    $0x10,%esp
80107e32:	b8 cd ab cd ab       	mov    $0xabcdabcd,%eax
}
80107e37:	c9                   	leave  
80107e38:	c3                   	ret    
