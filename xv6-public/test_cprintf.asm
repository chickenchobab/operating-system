...
{   
   ...
   c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for (int i = 0; i < LOOP_NUM; i ++){
        printpinfo();
  10:	e8 16 03 00 00       	call   32b <printpinfo>
    for (int i = 0; i < LOOP_NUM; i ++){
 ...
 3f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 435:	57                   	push   %edi
 436:	56                   	push   %esi
 437:	e8 57 fe ff ff       	call   293 <write>
 ...
 48e:	e8 00 fe ff ff       	call   293 <write>
        putc(fd, c);
 ...
 54c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 54f:	e8 3f fd ff ff       	call   293 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 683:	e8 73 fc ff ff       	call   2fb <sbrk>
  if(p == (char*)-1)
