...
int main(int argc, char *argv[])
{
  ...
  for (i = 0; i < NUM_THREAD; i++)
    expected[i] = i;
  11:	c7 05 00 12 00 00 00 	movl   $0x0,0x1200
  18:	00 00 00 
  ...
  20:	6a 01                	push   $0x1
    expected[i] = i;
  22:	c7 05 04 12 00 00 01 	movl   $0x1,0x1204
  29:	00 00 00 
  2c:	c7 05 08 12 00 00 02 	movl   $0x2,0x1208
  33:	00 00 00 
  36:	c7 05 0c 12 00 00 03 	movl   $0x3,0x120c
  3d:	00 00 00 
  40:	c7 05 10 12 00 00 04 	movl   $0x4,0x1210
  47:	00 00 00 
  printf(1, "Test 1: Basic test\n");
  ...
  if (status != 1) {
  83:	a1 28 12 00 00       	mov    0x1228,%eax
  88:	83 c4 10             	add    $0x10,%esp
  8b:	83 f8 01             	cmp    $0x1,%eax
  8e:	74 13                	je     a3 <main+0xa3>
    printf(1, "%d : Join returned before thread exit, or the address space is not properly shared\n", status);
  90:	52                   	push   %edx
  91:	50                   	push   %eax
  92:	68 78 0d 00 00       	push   $0xd78
  97:	6a 01                	push   $0x1
  99:	e8 f2 07 00 00       	call   890 <printf>
    failed();
  ...
  a3:	50                   	push   %eax
  a4:	50                   	push   %eax
  a5:	68 a8 0c 00 00       	push   $0xca8
  aa:	6a 01                	push   $0x1
  ac:	e8 df 07 00 00       	call   890 <printf>

  printf(1, "Test 2: Fork test\n");
  b1:	58                   	pop    %eax
  b2:	5a                   	pop    %edx
  b3:	68 b8 0c 00 00       	push   $0xcb8
  b8:	6a 01                	push   $0x1
  ba:	e8 d1 07 00 00       	call   890 <printf>
  ...
  if (status != 2) {
  d9:	a1 28 12 00 00       	mov    0x1228,%eax
  ...
  eb:	51                   	push   %ecx
  ec:	50                   	push   %eax
  ed:	68 cb 0c 00 00       	push   $0xccb
  f2:	6a 01                	push   $0x1
  f4:	e8 97 07 00 00       	call   890 <printf>
 ...
 101:	50                   	push   %eax
 102:	50                   	push   %eax
 103:	68 cc 0d 00 00       	push   $0xdcc
 108:	6a 01                	push   $0x1
 10a:	e8 81 07 00 00       	call   890 <printf>
 ...
 114:	50                   	push   %eax
 115:	50                   	push   %eax
 116:	68 e8 0c 00 00       	push   $0xce8
 11b:	6a 01                	push   $0x1
 11d:	e8 6e 07 00 00       	call   890 <printf>

  printf(1, "Test 3: Sbrk test\n");
 122:	5a                   	pop    %edx
 123:	59                   	pop    %ecx
 124:	68 f8 0c 00 00       	push   $0xcf8
 129:	6a 01                	push   $0x1
 12b:	e8 60 07 00 00       	call   890 <printf>
 ...
 14a:	59                   	pop    %ecx
 14b:	58                   	pop    %eax
 14c:	68 0b 0d 00 00       	push   $0xd0b
 151:	6a 01                	push   $0x1
 153:	e8 38 07 00 00       	call   890 <printf>

  printf(1, "All tests passed!\n");
 158:	58                   	pop    %eax
 159:	5a                   	pop    %edx
 15a:	68 1b 0d 00 00       	push   $0xd1b
 15f:	6a 01                	push   $0x1
 161:	e8 2a 07 00 00       	call   890 <printf>
  exit();
 166:	e8 b8 05 00 00       	call   723 <exit>
...
00000170 <thread_basic>:
{
 ...
 1c0:	c7 05 28 12 00 00 01 	movl   $0x1,0x1228
 1c7:	00 00 00 
...
000001f0 <thread_fork>:
{
 ...
 213:	74 59                	je     26e <thread_fork+0x7e>
    status = 2;
 215:	c7 05 28 12 00 00 02 	movl   $0x2,0x1228
 21c:	00 00 00 
    if (wait() == -1) {
 ...
 288:	83 c4 0c             	add    $0xc,%esp
    status = 3;
 28b:	c7 05 28 12 00 00 03 	movl   $0x3,0x1228
 292:	00 00 00 
    printf(1, "Child of thread %d end\n", val);
 295:	53                   	push   %ebx
...
000002b0 <thread_sbrk>:
{
 ...
 2ce:	0f 84 d8 00 00 00    	je     3ac <thread_sbrk+0xfc>
    while (ptr == 0)
 2d4:	8b 15 fc 11 00 00    	mov    0x11fc,%edx
 ...
 2e3:	e8 cb 04 00 00       	call   7b3 <sleep>
    while (ptr == 0)
 2e8:	8b 15 fc 11 00 00    	mov    0x11fc,%edx
 ...
 2f3:	74 e9                	je     2de <thread_sbrk+0x2e>
{
 ...
 2f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  while (ptr != 0)
 300:	8b 15 fc 11 00 00    	mov    0x11fc,%edx
      ptr[i] = val;
 ...
 311:	75 ed                	jne    300 <thread_sbrk+0x50>
  while (ptr != 0)
 313:	a1 fc 11 00 00       	mov    0x11fc,%eax
 ...
 321:	e8 8d 04 00 00       	call   7b3 <sleep>
  while (ptr != 0)
 326:	a1 fc 11 00 00       	mov    0x11fc,%eax
 ...
 330:	75 ea                	jne    31c <thread_sbrk+0x6c>
{
 ...
 3b9:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
    ptr = (int *)malloc(65536);
 3c0:	a3 fc 11 00 00       	mov    %eax,0x11fc
    sleep(100);
 3c5:	e8 e9 03 00 00       	call   7b3 <sleep>
    free(ptr);
 3ca:	5a                   	pop    %edx
 3cb:	ff 35 fc 11 00 00    	push   0x11fc
 3d1:	e8 5a 06 00 00       	call   a30 <free>
    ptr = 0;
 3d6:	83 c4 10             	add    $0x10,%esp
 3d9:	c7 05 fc 11 00 00 00 	movl   $0x0,0x11fc
 3e0:	00 00 00 
  while (ptr != 0)
...
000003f0 <create_all>:
{
 ...
 40b:	8d 04 9d 14 12 00 00 	lea    0x1214(,%ebx,4),%eax
 412:	53                   	push   %ebx
 413:	57                   	push   %edi
 414:	50                   	push   %eax
 ...
 7ec:	89 d1                	mov    %edx,%ecx
{
 ...
 819:	0f b6 92 58 0e 00 00 	movzbl 0xe58(%edx),%edx
 ...
 899:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 909:	ff 24 85 00 0e 00 00 	jmp    *0xe00(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 a17:	90                   	nop
          s = "(null)";
 a18:	ba f6 0d 00 00       	mov    $0xdf6,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 a31:	a1 2c 12 00 00       	mov    0x122c,%eax
{
 ...
 a71:	5b                   	pop    %ebx
  freep = p;
 a72:	89 15 2c 12 00 00    	mov    %edx,0x122c
}
 a78:	5e                   	pop    %esi
 a79:	5f                   	pop    %edi
 a7a:	5d                   	pop    %ebp
 ...
 aa9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 aac:	89 15 2c 12 00 00    	mov    %edx,0x122c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 ac9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 acc:	8b 3d 2c 12 00 00    	mov    0x122c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 b0f:	73 4f                	jae    b60 <malloc+0xa0>
    ...
    if(p == freep)
 b11:	8b 3d 2c 12 00 00    	mov    0x122c,%edi
 ...
 b3a:	e8 f1 fe ff ff       	call   a30 <free>
  return freep;
 b3f:	8b 15 2c 12 00 00    	mov    0x122c,%edx
 ...
 b6c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 b6f:	89 15 2c 12 00 00    	mov    %edx,0x122c
}
 ...
 b7f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 b80:	c7 05 2c 12 00 00 30 	movl   $0x1230,0x122c
 b87:	12 00 00 
    base.s.size = 0;
 b8a:	bf 30 12 00 00       	mov    $0x1230,%edi
    base.s.ptr = freep = prevp = &base;
 b8f:	c7 05 30 12 00 00 30 	movl   $0x1230,0x1230
 b96:	12 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 b99:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 b9b:	c7 05 34 12 00 00 00 	movl   $0x0,0x1234
 ba2:	00 00 00 
    if(p->s.size >= nunits){
