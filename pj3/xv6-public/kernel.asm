...
80100056:	e8 15 48 00 00       	call   80104870 <initlock>
  bcache.head.next = &bcache.head;
...
801001be:	e8 5d 46 00 00       	call   80104820 <holdingsleep>
...
801001ff:	e8 1c 46 00 00       	call   80104820 <holdingsleep>
...
8010020f:	e8 cc 45 00 00       	call   801047e0 <releasesleep>

  acquire(&bcache.lock);
80100214:	c7 04 24 20 b5 10 80 	movl   $0x8010b520,(%esp)
8010021b:	e8 20 48 00 00       	call   80104a40 <acquire>
  b->refcnt--;
...
8010026b:	5d                   	pop    %ebp
  release(&bcache.lock);
8010026c:	e9 6f 47 00 00       	jmp    801049e0 <release>
    panic("brelse");
...
801002a0:	e8 9b 47 00 00       	call   80104a40 <acquire>
  while(n > 0){
...
801002f6:	e8 e5 46 00 00       	call   801049e0 <release>
        ilock(ip);
801002fb:	5a                   	pop    %edx
...
8010034c:	e8 8f 46 00 00       	call   801049e0 <release>
  ilock(ip);
80100351:	58                   	pop    %eax
...
801003c8:	e8 c3 44 00 00       	call   80104890 <getcallerpcs>
  for(i=0; i<10; i++)
...
8010041a:	e8 e1 5e 00 00       	call   80106300 <uartputc>
...
80100505:	e8 f6 5d 00 00       	call   80106300 <uartputc>
8010050a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100511:	e8 ea 5d 00 00       	call   80106300 <uartputc>
80100516:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010051d:	e8 de 5d 00 00       	call   80106300 <uartputc>
...
80100551:	e8 4a 46 00 00       	call   80104ba0 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100566:	e8 95 45 00 00       	call   80104b00 <memset>
  outb(CRTPORT+1, pos);
...
801005ab:	e8 90 44 00 00       	call   80104a40 <acquire>
  for(i = 0; i < n; i++)
...
801005e4:	e8 f7 43 00 00       	call   801049e0 <release>
  ilock(ip);
801005e9:	58                   	pop    %eax
...
801007e8:	e8 53 42 00 00       	call   80104a40 <acquire>
...
8010085b:	e8 80 41 00 00       	call   801049e0 <release>
...
80100893:	e8 a8 41 00 00       	call   80104a40 <acquire>
  while((c = getc()) >= 0){
...
801009d0:	e8 0b 40 00 00       	call   801049e0 <release>
  if(doprocdump) {
...
80100a70:	e8 fb 3d 00 00       	call   80104870 <initlock>
...
80100b32:	75 d2                	jne    80100b06 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100b34:	e8 57 69 00 00       	call   80107490 <setupkvm>
...
80100ba3:	e8 08 67 00 00       	call   801072b0 <allocuvm>
...
80100bd9:	e8 e2 65 00 00       	call   801071c0 <loaduvm>
...
80100c1b:	e8 f0 67 00 00       	call   80107410 <freevm>
  if(ip){
...
80100c62:	e8 49 66 00 00       	call   801072b0 <allocuvm>
...
80100cd3:	e8 28 40 00 00       	call   80104d00 <strlen>
...
80100ce4:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100ce7:	e8 14 40 00 00       	call   80104d00 <strlen>
...
80100cf8:	e8 03 6a 00 00       	call   80107700 <copyout>
...
80100d11:	e8 fa 66 00 00       	call   80107410 <freevm>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 98 69 00 00       	call   80107700 <copyout>
...
80100da1:	e8 1a 3f 00 00       	call   80104cc0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100dcd:	e8 5e 62 00 00       	call   80107030 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 36 66 00 00       	call   80107410 <freevm>
  return 0;
...
80100e20:	e8 4b 3a 00 00       	call   80104870 <initlock>
}
...
80100e71:	e8 6a 3b 00 00       	call   801049e0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 51 3b 00 00       	call   801049e0 <release>
}
...
80100eaf:	e8 8c 3b 00 00       	call   80104a40 <acquire>
  if(f->ref < 1)
...
80100ecc:	e8 0f 3b 00 00       	call   801049e0 <release>
  return f;
}
...
80100f01:	e8 3a 3b 00 00       	call   80104a40 <acquire>
  if(f->ref < 1)
...
80100f39:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f3c:	e8 9f 3a 00 00       	call   801049e0 <release>
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 6d 3a 00 00       	jmp    801049e0 <release>
...
80101325:	e8 d6 37 00 00       	call   80104b00 <memset>
  log_write(bp);
...
8010136a:	e8 d1 36 00 00       	call   80104a40 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013d7:	e8 04 36 00 00       	call   801049e0 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 d6 35 00 00       	call   801049e0 <release>
      return ip;
...
80101541:	e8 5a 36 00 00       	call   80104ba0 <memmove>
  brelse(bp);
...
80101576:	e8 f5 32 00 00       	call   80104870 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 ac 31 00 00       	call   80104740 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 df 35 00 00       	call   80104ba0 <memmove>
  brelse(bp);
...
8010168e:	e8 6d 34 00 00       	call   80104b00 <memset>
      dip->type = type;
...
80101731:	e8 6a 34 00 00       	call   80104ba0 <memmove>
  log_write(bp);
...
8010175f:	e8 dc 32 00 00       	call   80104a40 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010176f:	e8 6c 32 00 00       	call   801049e0 <release>
}
...
801017a2:	e8 d9 2f 00 00       	call   80104780 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 83 33 00 00       	call   80104ba0 <memmove>
    brelse(bp);
...
80101873:	e8 a8 2f 00 00       	call   80104820 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 4c 2f 00 00       	jmp    801047e0 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 bb 2e 00 00       	call   80104780 <acquiresleep>
...
801018da:	e8 01 2f 00 00       	call   801047e0 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
801018e6:	e8 55 31 00 00       	call   80104a40 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 db 30 00 00       	jmp    801049e0 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 09 11 80       	push   $0x80110960
80101910:	e8 2b 31 00 00       	call   80104a40 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010191f:	e8 bc 30 00 00       	call   801049e0 <release>
    if(r == 1){
...
80101a23:	e8 f8 2d 00 00       	call   80104820 <holdingsleep>
...
80101a3a:	e8 a1 2d 00 00       	call   801047e0 <releasesleep>
  iput(ip);
...
80101b37:	e8 64 30 00 00       	call   80104ba0 <memmove>
    brelse(bp);
...
80101c33:	e8 68 2f 00 00       	call   80104ba0 <memmove>
    log_write(bp);
...
80101cce:	e8 3d 2f 00 00       	call   80104c10 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 de 2e 00 00       	call   80104c10 <strncmp>
      continue;
...
80101dba:	e8 81 2c 00 00       	call   80104a40 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
80101dca:	e8 11 2c 00 00       	call   801049e0 <release>
...
80101e27:	e8 74 2d 00 00       	call   80104ba0 <memmove>
...
80101e8c:	e8 8f 29 00 00       	call   80104820 <holdingsleep>
...
80101eae:	e8 2d 29 00 00       	call   801047e0 <releasesleep>
  iput(ip);
...
80101edb:	e8 c0 2c 00 00       	call   80104ba0 <memmove>
    name[len] = 0;
...
80101f2b:	e8 f0 28 00 00       	call   80104820 <holdingsleep>
...
80101f4a:	e8 91 28 00 00       	call   801047e0 <releasesleep>
  iput(ip);
...
80101f6d:	e8 ae 28 00 00       	call   80104820 <holdingsleep>
...
80101f90:	e8 8b 28 00 00       	call   80104820 <holdingsleep>
...
80101fa7:	e8 34 28 00 00       	call   801047e0 <releasesleep>
}
...
8010203d:	e8 1e 2c 00 00       	call   80104c60 <strncpy>
...
80102088:	68 2a 7f 10 80       	push   $0x80107f2a
...
801021d0:	e8 9b 26 00 00       	call   80104870 <initlock>
...
8010224e:	e8 ed 27 00 00       	call   80104a40 <acquire>
...
801022cb:	e8 10 27 00 00       	call   801049e0 <release>
...
801022ee:	e8 2d 25 00 00       	call   80104820 <holdingsleep>
...
80102328:	e8 13 27 00 00       	call   80104a40 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 55 26 00 00       	jmp    801049e0 <release>
...
801024f2:	e8 09 26 00 00       	call   80104b00 <memset>
...
80102528:	e8 13 25 00 00       	call   80104a40 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 98 24 00 00       	jmp    801049e0 <release>
    panic("kfree");
...
80102625:	e8 46 22 00 00       	call   80104870 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 88 23 00 00       	call   80104a40 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 fa 22 00 00       	call   801049e0 <release>
  return (char*)r;
...
80102af7:	e8 54 20 00 00       	call   80104b50 <memcmp>
...
80102c24:	e8 77 1f 00 00       	call   80104ba0 <memmove>
...
80102cd4:	e8 97 1b 00 00       	call   80104870 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 d0 1c 00 00       	call   80104a40 <acquire>
...
80102dbc:	e8 1f 1c 00 00       	call   801049e0 <release>
      break;
    }
  }
}
...
80102dde:	e8 5d 1c 00 00       	call   80104a40 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 bf 1b 00 00       	call   801049e0 <release>
}
...
80102e36:	e8 05 1c 00 00       	call   80104a40 <acquire>
    wakeup(&log);
...
80102e58:	e8 83 1b 00 00       	call   801049e0 <release>
...
80102eb4:	e8 e7 1c 00 00       	call   80104ba0 <memmove>
...
80102f14:	e8 c7 1a 00 00       	call   801049e0 <release>
...
80102f76:	e8 c5 1a 00 00       	call   80104a40 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 26 1a 00 00       	jmp    801049e0 <release>
...
80103007:	e8 b4 09 00 00       	call   801039c0 <cpuid>
8010300c:	89 c3                	mov    %eax,%ebx
8010300e:	e8 ad 09 00 00       	call   801039c0 <cpuid>
...
80103022:	e8 b9 2e 00 00       	call   80105ee0 <idtinit>
  xchg(&(mycpu()->started), 1); // tell startothers() we're up
80103027:	e8 34 09 00 00       	call   80103960 <mycpu>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 d5 3f 00 00       	call   80107020 <switchkvm>
  seginit();
8010304b:	e8 40 3f 00 00       	call   80106f90 <seginit>
  lapicinit();
...
80103081:	e8 8a 44 00 00       	call   80107510 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 fb 3e 00 00       	call   80106f90 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 77 31 00 00       	call   80106220 <uartinit>
  pinit();         // process table
801030a9:	e8 92 08 00 00       	call   80103940 <pinit>
  tvinit();        // trap vectors
...
801030d4:	e8 c7 1a 00 00       	call   80104ba0 <memmove>
...
80103119:	e8 42 08 00 00       	call   80103960 <mycpu>
...
80103182:	e8 89 08 00 00       	call   80103a10 <userinit>
...
801031c4:	e8 87 19 00 00       	call   80104b50 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 cc 18 00 00       	call   80104b50 <memcmp>
...
801033c8:	e8 83 17 00 00       	call   80104b50 <memcmp>
...
801034a9:	e8 c2 13 00 00       	call   80104870 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 fc 14 00 00       	call   80104a40 <acquire>
  if(writable){
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 57 14 00 00       	jmp    801049e0 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 47 14 00 00       	call   801049e0 <release>
    kfree((char*)p);
...
801035dd:	e8 5e 14 00 00       	call   80104a40 <acquire>
  for(i = 0; i < n; i++){
...
80103621:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->readopen == 0 || myproc()->killed){
80103628:	e8 b3 03 00 00       	call   801039e0 <myproc>
...
8010366c:	e8 6f 13 00 00       	call   801049e0 <release>
        return -1;
...
801036c2:	e8 19 13 00 00       	call   801049e0 <release>
  return n;
...
801036e6:	e8 55 13 00 00       	call   80104a40 <acquire>
...
801036fe:	66 90                	xchg   %ax,%ax
    if(myproc()->killed){
80103700:	e8 db 02 00 00       	call   801039e0 <myproc>
...
8010377e:	e8 5d 12 00 00       	call   801049e0 <release>
  return i;
...
80103799:	e8 42 12 00 00       	call   801049e0 <release>
      return -1;
...
801037c0:	81 c2 8c 00 00 00    	add    $0x8c,%edx
801037c6:	81 fa 54 50 11 80    	cmp    $0x80115054,%edx
...
801037f6:	53                   	push   %ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037f7:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  acquire(&ptable.lock);
801037fc:	83 ec 0c             	sub    $0xc,%esp
801037ff:	68 20 2d 11 80       	push   $0x80112d20
80103804:	e8 37 12 00 00       	call   80104a40 <acquire>
80103809:	83 c4 10             	add    $0x10,%esp
8010380c:	eb 14                	jmp    80103822 <allocproc+0x32>
8010380e:	66 90                	xchg   %ax,%ax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103810:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
80103816:	81 fb 54 50 11 80    	cmp    $0x80115054,%ebx
...
80103827:	75 e7                	jne    80103810 <allocproc+0x20>
  p->state = EMBRYO;
80103829:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  if (isthread){
80103830:	85 f6                	test   %esi,%esi
80103832:	75 74                	jne    801038a8 <allocproc+0xb8>
    p->pid = nextpid++;
80103834:	a1 08 b0 10 80       	mov    0x8010b008,%eax
80103839:	8d 50 01             	lea    0x1(%eax),%edx
8010383c:	89 43 10             	mov    %eax,0x10(%ebx)
8010383f:	89 15 08 b0 10 80    	mov    %edx,0x8010b008
  release(&ptable.lock);
80103845:	83 ec 0c             	sub    $0xc,%esp
  p->mainproc = p;
80103848:	89 9b 84 00 00 00    	mov    %ebx,0x84(%ebx)
  release(&ptable.lock);
8010384e:	68 20 2d 11 80       	push   $0x80112d20
80103853:	e8 88 11 00 00       	call   801049e0 <release>
  if((p->kstack = kalloc()) == 0){
80103858:	e8 23 ee ff ff       	call   80102680 <kalloc>
8010385d:	83 c4 10             	add    $0x10,%esp
80103860:	89 43 08             	mov    %eax,0x8(%ebx)
80103863:	85 c0                	test   %eax,%eax
80103865:	74 74                	je     801038db <allocproc+0xeb>
  sp -= sizeof *p->tf;
80103867:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  memset(p->context, 0, sizeof *p->context);
8010386d:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
80103870:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103875:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103878:	c7 40 14 47 5e 10 80 	movl   $0x80105e47,0x14(%eax)
  p->context = (struct context*)sp;
8010387f:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103882:	6a 14                	push   $0x14
80103884:	6a 00                	push   $0x0
80103886:	50                   	push   %eax
80103887:	e8 74 12 00 00       	call   80104b00 <memset>
  p->context->eip = (uint)forkret;
8010388c:	8b 43 1c             	mov    0x1c(%ebx),%eax
  return p;
8010388f:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
80103892:	c7 40 10 f0 38 10 80 	movl   $0x801038f0,0x10(%eax)
}
...
801038a8:	a1 04 b0 10 80       	mov    0x8010b004,%eax
    p->pid = isthread;
801038ad:	89 73 10             	mov    %esi,0x10(%ebx)
    p->tid = nexttid++;
801038b0:	8d 50 01             	lea    0x1(%eax),%edx
801038b3:	89 43 7c             	mov    %eax,0x7c(%ebx)
801038b6:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
801038bc:	eb 87                	jmp    80103845 <allocproc+0x55>
...
801038ca:	e8 11 11 00 00       	call   801049e0 <release>
  return 0;
...
801038fb:	e8 e0 10 00 00       	call   801049e0 <release>
  if (first) {
...
80103946:	68 20 7d 10 80       	push   $0x80107d20
8010394b:	68 20 2d 11 80       	push   $0x80112d20
80103950:	e8 1b 0f 00 00       	call   80104870 <initlock>
}
...
8010396a:	75 46                	jne    801039b2 <mycpu+0x52>
  apicid = lapicid();
8010396c:	e8 7f ef ff ff       	call   801028f0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
...
801039e4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801039e7:	e8 04 0f 00 00       	call   801048f0 <pushcli>
  c = mycpu();
801039ec:	e8 6f ff ff ff       	call   80103960 <mycpu>
  p = c->proc;
801039f1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039f7:	e8 44 0f 00 00       	call   80104940 <popcli>
}
...
80103a16:	83 ec 04             	sub    $0x4,%esp
  p = allocproc(0);
80103a19:	e8 d2 fd ff ff       	call   801037f0 <allocproc>
80103a1e:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103a20:	a3 54 50 11 80       	mov    %eax,0x80115054
  if((p->pgdir = setupkvm()) == 0)
80103a25:	e8 66 3a 00 00       	call   80107490 <setupkvm>
80103a2a:	89 43 04             	mov    %eax,0x4(%ebx)
80103a2d:	85 c0                	test   %eax,%eax
80103a2f:	0f 84 bd 00 00 00    	je     80103af2 <userinit+0xe2>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80103a35:	83 ec 04             	sub    $0x4,%esp
80103a38:	68 2c 00 00 00       	push   $0x2c
80103a3d:	68 60 b4 10 80       	push   $0x8010b460
80103a42:	50                   	push   %eax
80103a43:	e8 f8 36 00 00       	call   80107140 <inituvm>
  memset(p->tf, 0, sizeof(*p->tf));
80103a48:	83 c4 0c             	add    $0xc,%esp
  p->sz = PGSIZE;
80103a4b:	c7 03 00 10 00 00    	movl   $0x1000,(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
80103a51:	6a 4c                	push   $0x4c
80103a53:	6a 00                	push   $0x0
80103a55:	ff 73 18             	push   0x18(%ebx)
80103a58:	e8 a3 10 00 00       	call   80104b00 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103a5d:	8b 43 18             	mov    0x18(%ebx),%eax
80103a60:	ba 1b 00 00 00       	mov    $0x1b,%edx
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a65:	83 c4 0c             	add    $0xc,%esp
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103a68:	b9 23 00 00 00       	mov    $0x23,%ecx
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103a6d:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103a71:	8b 43 18             	mov    0x18(%ebx),%eax
80103a74:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103a78:	8b 43 18             	mov    0x18(%ebx),%eax
80103a7b:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103a7f:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103a83:	8b 43 18             	mov    0x18(%ebx),%eax
80103a86:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103a8a:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80103a8e:	8b 43 18             	mov    0x18(%ebx),%eax
80103a91:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103a98:	8b 43 18             	mov    0x18(%ebx),%eax
80103a9b:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80103aa2:	8b 43 18             	mov    0x18(%ebx),%eax
80103aa5:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103aac:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103aaf:	6a 10                	push   $0x10
80103ab1:	68 50 7d 10 80       	push   $0x80107d50
80103ab6:	50                   	push   %eax
80103ab7:	e8 04 12 00 00       	call   80104cc0 <safestrcpy>
  p->cwd = namei("/");
80103abc:	c7 04 24 59 7d 10 80 	movl   $0x80107d59,(%esp)
80103ac3:	e8 d8 e5 ff ff       	call   801020a0 <namei>
80103ac8:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103acb:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ad2:	e8 69 0f 00 00       	call   80104a40 <acquire>
  p->state = RUNNABLE;
80103ad7:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103ade:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ae5:	e8 f6 0e 00 00       	call   801049e0 <release>
}
...
80103af5:	68 37 7d 10 80       	push   $0x80107d37
...
80103b05:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103b08:	e8 e3 0d 00 00       	call   801048f0 <pushcli>
  c = mycpu();
80103b0d:	e8 4e fe ff ff       	call   80103960 <mycpu>
  p = c->proc;
80103b12:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b18:	e8 23 0e 00 00       	call   80104940 <popcli>
  sz = curproc->sz;
...
80103b2b:	e8 00 35 00 00       	call   80107030 <switchuvm>
  return 0;
...
80103b4a:	e8 61 37 00 00       	call   801072b0 <allocuvm>
...
80103b6a:	e8 71 38 00 00       	call   801073e0 <deallocuvm>
...
80103b86:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b89:	e8 62 0d 00 00       	call   801048f0 <pushcli>
  c = mycpu();
80103b8e:	e8 cd fd ff ff       	call   80103960 <mycpu>
  p = c->proc;
80103b93:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b99:	e8 a2 0d 00 00       	call   80104940 <popcli>
  if((np = allocproc(0)) == 0){
80103b9e:	31 c0                	xor    %eax,%eax
80103ba0:	e8 4b fc ff ff       	call   801037f0 <allocproc>
80103ba5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103ba8:	85 c0                	test   %eax,%eax
80103baa:	0f 84 bd 00 00 00    	je     80103c6d <fork+0xed>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103bb0:	83 ec 08             	sub    $0x8,%esp
80103bb3:	ff 33                	push   (%ebx)
80103bb5:	89 c7                	mov    %eax,%edi
80103bb7:	ff 73 04             	push   0x4(%ebx)
80103bba:	e8 c1 39 00 00       	call   80107580 <copyuvm>
80103bbf:	83 c4 10             	add    $0x10,%esp
80103bc2:	89 47 04             	mov    %eax,0x4(%edi)
80103bc5:	85 c0                	test   %eax,%eax
80103bc7:	0f 84 a7 00 00 00    	je     80103c74 <fork+0xf4>
  np->sz = curproc->sz;
80103bcd:	8b 03                	mov    (%ebx),%eax
80103bcf:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103bd2:	89 01                	mov    %eax,(%ecx)
  *np->tf = *curproc->tf;
80103bd4:	8b 79 18             	mov    0x18(%ecx),%edi
  np->parent = curproc;
80103bd7:	89 c8                	mov    %ecx,%eax
80103bd9:	89 59 14             	mov    %ebx,0x14(%ecx)
  *np->tf = *curproc->tf;
80103bdc:	b9 13 00 00 00       	mov    $0x13,%ecx
80103be1:	8b 73 18             	mov    0x18(%ebx),%esi
80103be4:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103be6:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
80103be8:	8b 40 18             	mov    0x18(%eax),%eax
80103beb:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
...
80103c04:	e8 97 d2 ff ff       	call   80100ea0 <filedup>
...
80103c1e:	ff 73 68             	push   0x68(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103c21:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
80103c24:	e8 27 db ff ff       	call   80101750 <idup>
...
80103c7a:	ff 73 08             	push   0x8(%ebx)
80103c7d:	e8 3e e8 ff ff       	call   801024c0 <kfree>
    np->kstack = 0;
...
80103cce:	e8 6d 0d 00 00       	call   80104a40 <acquire>
...
80103cf0:	e8 3b 33 00 00       	call   80107030 <switchuvm>
...
80103cfb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103d02:	e8 14 10 00 00       	call   80104d1b <swtch>
      switchkvm();
80103d07:	e8 14 33 00 00       	call   80107020 <switchkvm>
      c->proc = 0;
...
80103d2f:	e8 ac 0c 00 00       	call   801049e0 <release>
    sti();
...
80103da3:	e8 73 0f 00 00       	call   80104d1b <swtch>
  mycpu()->intena = intena;
...
80103e14:	0f 84 d7 00 00 00    	je     80103ef1 <exit+0xf1>
...
80103e6a:	e8 d1 0b 00 00       	call   80104a40 <acquire>
  wakeup1(curproc->parent);
80103e6f:	8b 43 14             	mov    0x14(%ebx),%eax
80103e72:	e8 39 f9 ff ff       	call   801037b0 <wakeup1>
      p->parent = initproc;
80103e77:	8b 0d 54 50 11 80    	mov    0x80115054,%ecx
80103e7d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e80:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103e85:	eb 17                	jmp    80103e9e <exit+0x9e>
...
80103ee7:	68 a8 7d 10 80       	push   $0x80107da8
80103eec:	e8 8f c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ef1:	83 ec 0c             	sub    $0xc,%esp
80103ef4:	68 9b 7d 10 80       	push   $0x80107d9b
...
80103f04:	53                   	push   %ebx
  pushcli();
80103f05:	e8 e6 09 00 00       	call   801048f0 <pushcli>
  c = mycpu();
80103f0a:	e8 51 fa ff ff       	call   80103960 <mycpu>
  p = c->proc;
80103f0f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f15:	e8 26 0a 00 00       	call   80104940 <popcli>
  acquire(&ptable.lock);
80103f1a:	83 ec 0c             	sub    $0xc,%esp
80103f1d:	68 20 2d 11 80       	push   $0x80112d20
80103f22:	e8 19 0b 00 00       	call   80104a40 <acquire>
...
80103f66:	0f 84 a4 00 00 00    	je     80104010 <wait+0x110>
80103f6c:	8b 46 24             	mov    0x24(%esi),%eax
80103f6f:	85 c0                	test   %eax,%eax
80103f71:	0f 85 99 00 00 00    	jne    80104010 <wait+0x110>
  pushcli();
80103f77:	e8 74 09 00 00       	call   801048f0 <pushcli>
  c = mycpu();
80103f7c:	e8 df f9 ff ff       	call   80103960 <mycpu>
  p = c->proc;
80103f81:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f87:	e8 b4 09 00 00       	call   80104940 <popcli>
  if(p == 0)
80103f8c:	85 db                	test   %ebx,%ebx
80103f8e:	0f 84 93 00 00 00    	je     80104027 <wait+0x127>
  p->chan = chan;
80103f94:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
80103f97:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103f9e:	e8 9d fd ff ff       	call   80103d40 <sched>
  p->chan = 0;
...
80103fc9:	e8 42 34 00 00       	call   80107410 <freevm>
        p->pid = 0;
...
80104010:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104013:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104018:	68 20 2d 11 80       	push   $0x80112d20
8010401d:	e8 be 09 00 00       	call   801049e0 <release>
      return -1;
80104022:	83 c4 10             	add    $0x10,%esp
80104025:	eb e0                	jmp    80104007 <wait+0x107>
    panic("sleep");
80104027:	83 ec 0c             	sub    $0xc,%esp
8010402a:	68 b4 7d 10 80       	push   $0x80107db4
8010402f:	e8 4c c3 ff ff       	call   80100380 <panic>
80104034:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
8010404c:	e8 ef 09 00 00       	call   80104a40 <acquire>
  pushcli();
80104051:	e8 9a 08 00 00       	call   801048f0 <pushcli>
  c = mycpu();
80104056:	e8 05 f9 ff ff       	call   80103960 <mycpu>
  p = c->proc;
8010405b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104061:	e8 da 08 00 00       	call   80104940 <popcli>
  myproc()->state = RUNNABLE;
80104066:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
8010406d:	e8 ce fc ff ff       	call   80103d40 <sched>
  release(&ptable.lock);
80104072:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104079:	e8 62 09 00 00       	call   801049e0 <release>
}
...
8010409c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010409f:	e8 4c 08 00 00       	call   801048f0 <pushcli>
  c = mycpu();
801040a4:	e8 b7 f8 ff ff       	call   80103960 <mycpu>
  p = c->proc;
801040a9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040af:	e8 8c 08 00 00       	call   80104940 <popcli>
  if(p == 0)
...
8010410b:	5d                   	pop    %ebp
    acquire(lk);
8010410c:	e9 2f 09 00 00       	jmp    80104a40 <acquire>
...
8010411b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104122:	e8 19 fc ff ff       	call   80103d40 <sched>
  p->chan = 0;
...
80104139:	68 ba 7d 10 80       	push   $0x80107dba
8010413e:	e8 3d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104143:	83 ec 0c             	sub    $0xc,%esp
80104146:	68 b4 7d 10 80       	push   $0x80107db4
...
8010415f:	e8 dc 08 00 00       	call   80104a40 <acquire>
...
80104175:	3d 54 50 11 80       	cmp    $0x80115054,%eax
...
80104187:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010418e:	05 8c 00 00 00       	add    $0x8c,%eax
80104193:	3d 54 50 11 80       	cmp    $0x80115054,%eax
...
801041a4:	c9                   	leave  
  release(&ptable.lock);
801041a5:	e9 36 08 00 00       	jmp    801049e0 <release>
...
801041c2:	e8 79 08 00 00       	call   80104a40 <acquire>
801041c7:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041ca:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801041cf:	eb 13                	jmp    801041e4 <kill+0x34>
801041d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801041d8:	05 8c 00 00 00       	add    $0x8c,%eax
801041dd:	3d 54 50 11 80       	cmp    $0x80115054,%eax
801041e2:	74 2a                	je     8010420e <kill+0x5e>
    if(p->pid == pid){
801041e4:	39 58 10             	cmp    %ebx,0x10(%eax)
801041e7:	75 ef                	jne    801041d8 <kill+0x28>
      found = 1;
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
801041e9:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
801041ed:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      found = 1;
801041f4:	be 01 00 00 00       	mov    $0x1,%esi
      if(p->state == SLEEPING)
801041f9:	75 dd                	jne    801041d8 <kill+0x28>
        p->state = RUNNABLE;
801041fb:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104202:	05 8c 00 00 00       	add    $0x8c,%eax
80104207:	3d 54 50 11 80       	cmp    $0x80115054,%eax
8010420c:	75 d6                	jne    801041e4 <kill+0x34>
    }
  }
  release(&ptable.lock);
8010420e:	83 ec 0c             	sub    $0xc,%esp
80104211:	68 20 2d 11 80       	push   $0x80112d20
80104216:	e8 c5 07 00 00       	call   801049e0 <release>
  if (found) return 0;
  return -1;
}
8010421b:	8d 65 f8             	lea    -0x8(%ebp),%esp
  if (found) return 0;
8010421e:	8d 46 ff             	lea    -0x1(%esi),%eax
}
80104221:	5b                   	pop    %ebx
80104222:	5e                   	pop    %esi
80104223:	5d                   	pop    %ebp
...
8010424b:	68 43 81 10 80       	push   $0x80108143
80104250:	e8 4b c4 ff ff       	call   801006a0 <cprintf>
80104255:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104258:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
8010425e:	81 fb c0 50 11 80    	cmp    $0x801150c0,%ebx
80104264:	0f 84 96 00 00 00    	je     80104300 <procdump+0xd0>
    if(p->state == UNUSED)
8010426a:	8b 43 a0             	mov    -0x60(%ebx),%eax
8010426d:	85 c0                	test   %eax,%eax
8010426f:	74 e7                	je     80104258 <procdump+0x28>
      state = "???";
80104271:	ba cb 7d 10 80       	mov    $0x80107dcb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104276:	83 f8 05             	cmp    $0x5,%eax
80104279:	77 11                	ja     8010428c <procdump+0x5c>
8010427b:	8b 14 85 30 7e 10 80 	mov    -0x7fef81d0(,%eax,4),%edx
      state = "???";
80104282:	b8 cb 7d 10 80       	mov    $0x80107dcb,%eax
...
80104291:	ff 73 10             	push   0x10(%ebx)
80104294:	ff 73 a4             	push   -0x5c(%ebx)
80104297:	68 cf 7d 10 80       	push   $0x80107dcf
8010429c:	e8 ff c3 ff ff       	call   801006a0 <cprintf>
    if(p->state == SLEEPING){
801042a1:	83 c4 20             	add    $0x20,%esp
801042a4:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
801042a8:	75 9e                	jne    80104248 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801042aa:	83 ec 08             	sub    $0x8,%esp
801042ad:	8d 45 c0             	lea    -0x40(%ebp),%eax
801042b0:	8d 7d c0             	lea    -0x40(%ebp),%edi
801042b3:	50                   	push   %eax
801042b4:	8b 43 b0             	mov    -0x50(%ebx),%eax
801042b7:	8b 40 0c             	mov    0xc(%eax),%eax
801042ba:	83 c0 08             	add    $0x8,%eax
801042bd:	50                   	push   %eax
801042be:	e8 cd 05 00 00       	call   80104890 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042d4:	0f 84 6e ff ff ff    	je     80104248 <procdump+0x18>
        cprintf(" %p", pc[i]);
...
801042e1:	68 21 78 10 80       	push   $0x80107821
...
801042f2:	e9 51 ff ff ff       	jmp    80104248 <procdump+0x18>
...
80104316:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80104319:	e8 d2 05 00 00       	call   801048f0 <pushcli>
  c = mycpu();
8010431e:	e8 3d f6 ff ff       	call   80103960 <mycpu>
  p = c->proc;
80104323:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104329:	e8 12 06 00 00       	call   80104940 <popcli>
  uint sz, sp;
  struct proc *np;
  struct proc *curproc = myproc();
...
8010432e:	8b 43 7c             	mov    0x7c(%ebx),%eax
80104331:	85 c0                	test   %eax,%eax
80104333:	75 11                	jne    80104346 <thread_create+0x36>
80104335:	a1 04 b0 10 80       	mov    0x8010b004,%eax
8010433a:	8d 50 01             	lea    0x1(%eax),%edx
8010433d:	89 43 7c             	mov    %eax,0x7c(%ebx)
80104340:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  if((np = allocproc(curproc->pid)) == 0){
80104346:	8b 43 10             	mov    0x10(%ebx),%eax
80104349:	e8 a2 f4 ff ff       	call   801037f0 <allocproc>
8010434e:	85 c0                	test   %eax,%eax
80104350:	0f 84 34 01 00 00    	je     8010448a <thread_create+0x17a>
    return -1;
  }
  acquire(&ptable.lock);
80104356:	83 ec 0c             	sub    $0xc,%esp
80104359:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010435c:	68 20 2d 11 80       	push   $0x80112d20
80104361:	e8 da 06 00 00       	call   80104a40 <acquire>
  //   kfree(np->kstack);
  //   np->kstack = 0;
  //   np->state = UNUSED;
  //   return -1;
...
80104369:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  *np->tf = *curproc->tf;
8010436c:	b9 13 00 00 00       	mov    $0x13,%ecx
...
80104374:	89 42 04             	mov    %eax,0x4(%edx)
  *np->tf = *curproc->tf;
80104377:	8b 7a 18             	mov    0x18(%edx),%edi
8010437a:	8b 73 18             	mov    0x18(%ebx),%esi
8010437d:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  for(i = 0; i < NOFILE; i++)
8010437f:	31 f6                	xor    %esi,%esi
  np->parent = curproc->parent;
80104381:	8b 43 14             	mov    0x14(%ebx),%eax
  np->mainproc = curproc;
80104384:	89 9a 84 00 00 00    	mov    %ebx,0x84(%edx)
  np->created = 1;
8010438a:	c7 82 80 00 00 00 01 	movl   $0x1,0x80(%edx)
80104391:	00 00 00 
  np->parent = curproc->parent;
80104394:	89 42 14             	mov    %eax,0x14(%edx)
  for(i = 0; i < NOFILE; i++)
...
801043a6:	74 16                	je     801043be <thread_create+0xae>
      np->ofile[i] = filedup(curproc->ofile[i]);
801043a8:	83 ec 0c             	sub    $0xc,%esp
801043ab:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801043ae:	50                   	push   %eax
801043af:	e8 ec ca ff ff       	call   80100ea0 <filedup>
801043b4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801043b7:	83 c4 10             	add    $0x10,%esp
801043ba:	89 44 b2 28          	mov    %eax,0x28(%edx,%esi,4)
  for(i = 0; i < NOFILE; i++)
801043be:	83 c6 01             	add    $0x1,%esi
801043c1:	83 fe 10             	cmp    $0x10,%esi
801043c4:	75 da                	jne    801043a0 <thread_create+0x90>
  np->cwd = idup(curproc->cwd);
801043c6:	83 ec 0c             	sub    $0xc,%esp
801043c9:	ff 73 68             	push   0x68(%ebx)
801043cc:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801043cf:	e8 7c d3 ff ff       	call   80101750 <idup>
801043d4:	8b 55 e4             	mov    -0x1c(%ebp),%edx

  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
801043d7:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
801043da:	89 42 68             	mov    %eax,0x68(%edx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
801043dd:	8d 43 6c             	lea    0x6c(%ebx),%eax
801043e0:	6a 10                	push   $0x10
801043e2:	50                   	push   %eax
801043e3:	8d 42 6c             	lea    0x6c(%edx),%eax
801043e6:	50                   	push   %eax
801043e7:	e8 d4 08 00 00       	call   80104cc0 <safestrcpy>
...
801043f1:	83 c4 0c             	add    $0xc,%esp
  sz = PGROUNDUP(curproc->sz);
801043f4:	05 ff 0f 00 00       	add    $0xfff,%eax
801043f9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((sz = allocuvm(np->pgdir, sz, sz + 2*PGSIZE)) == 0)
801043fe:	8d 88 00 20 00 00    	lea    0x2000(%eax),%ecx
80104404:	51                   	push   %ecx
80104405:	50                   	push   %eax
80104406:	ff 72 04             	push   0x4(%edx)
80104409:	e8 a2 2e 00 00       	call   801072b0 <allocuvm>
8010440e:	83 c4 10             	add    $0x10,%esp
80104411:	89 c6                	mov    %eax,%esi
80104413:	85 c0                	test   %eax,%eax
80104415:	74 73                	je     8010448a <thread_create+0x17a>
    return -1;
  clearpteu(np->pgdir, (char*)(sz - 2*PGSIZE));
80104417:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010441a:	83 ec 08             	sub    $0x8,%esp
8010441d:	8d 80 00 e0 ff ff    	lea    -0x2000(%eax),%eax
80104423:	50                   	push   %eax
80104424:	ff 72 04             	push   0x4(%edx)
80104427:	e8 04 31 00 00       	call   80107530 <clearpteu>
  sp = sz;
  curproc->sz = sz;
  np->sz = sz;
8010442c:	8b 55 e4             	mov    -0x1c(%ebp),%edx

  // Pass thread ID to user program.
  *thread = np->tid;
8010442f:	8b 45 08             	mov    0x8(%ebp),%eax
  curproc->sz = sz;
80104432:	89 33                	mov    %esi,(%ebx)
  *thread = np->tid;
80104434:	8b 4a 7c             	mov    0x7c(%edx),%ecx
  np->sz = sz;
80104437:	89 32                	mov    %esi,(%edx)
  *thread = np->tid;
80104439:	89 08                	mov    %ecx,(%eax)

  // Set up trapframe to start executing start_routine
  // after returning to user space
  sp -= 4;
  if(copyout(np->pgdir, sp, &arg, sizeof(arg)) < 0)
8010443b:	8d 45 10             	lea    0x10(%ebp),%eax
8010443e:	6a 04                	push   $0x4
80104440:	50                   	push   %eax
  sp -= 4;
80104441:	8d 46 fc             	lea    -0x4(%esi),%eax
  if(copyout(np->pgdir, sp, &arg, sizeof(arg)) < 0)
80104444:	50                   	push   %eax
80104445:	ff 72 04             	push   0x4(%edx)
80104448:	e8 b3 32 00 00       	call   80107700 <copyout>
8010444d:	83 c4 20             	add    $0x20,%esp
80104450:	85 c0                	test   %eax,%eax
80104452:	78 36                	js     8010448a <thread_create+0x17a>
    return -1;
  sp -= 4;
  np->tf->esp = sp;
80104454:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  sp -= 4;
80104457:	83 ee 08             	sub    $0x8,%esi
  np->tf->eip = (uint)start_routine;
8010445a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
8010445d:	83 ec 0c             	sub    $0xc,%esp
  np->tf->esp = sp;
80104460:	8b 42 18             	mov    0x18(%edx),%eax
  sp -= 4;
80104463:	89 70 44             	mov    %esi,0x44(%eax)
  np->tf->eip = (uint)start_routine;
80104466:	8b 42 18             	mov    0x18(%edx),%eax
80104469:	89 48 38             	mov    %ecx,0x38(%eax)
  np->state = RUNNABLE;
8010446c:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
  release(&ptable.lock);
80104473:	68 20 2d 11 80       	push   $0x80112d20
80104478:	e8 63 05 00 00       	call   801049e0 <release>

  return 0;
8010447d:	83 c4 10             	add    $0x10,%esp
80104480:	31 c0                	xor    %eax,%eax
}
80104482:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104485:	5b                   	pop    %ebx
80104486:	5e                   	pop    %esi
80104487:	5f                   	pop    %edi
80104488:	5d                   	pop    %ebp
...
801044a6:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
801044a9:	e8 32 f5 ff ff       	call   801039e0 <myproc>
801044ae:	89 c3                	mov    %eax,%ebx
  ...
  for(fd = 0; fd < NOFILE; fd++){
801044b0:	8d 70 28             	lea    0x28(%eax),%esi
801044b3:	8d 78 68             	lea    0x68(%eax),%edi
801044b6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801044bd:	8d 76 00             	lea    0x0(%esi),%esi
    if(curproc->ofile[fd]){
801044c0:	8b 06                	mov    (%esi),%eax
801044c2:	85 c0                	test   %eax,%eax
801044c4:	74 12                	je     801044d8 <thread_exit+0x38>
      fileclose(curproc->ofile[fd]);
801044c6:	83 ec 0c             	sub    $0xc,%esp
801044c9:	50                   	push   %eax
801044ca:	e8 21 ca ff ff       	call   80100ef0 <fileclose>
      curproc->ofile[fd] = 0;
801044cf:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
801044d5:	83 c4 10             	add    $0x10,%esp
  for(fd = 0; fd < NOFILE; fd++){
801044d8:	83 c6 04             	add    $0x4,%esi
801044db:	39 fe                	cmp    %edi,%esi
801044dd:	75 e1                	jne    801044c0 <thread_exit+0x20>
    }
  }

  begin_op();
801044df:	e8 7c e8 ff ff       	call   80102d60 <begin_op>
  iput(curproc->cwd);
801044e4:	83 ec 0c             	sub    $0xc,%esp
801044e7:	ff 73 68             	push   0x68(%ebx)
801044ea:	e8 c1 d3 ff ff       	call   801018b0 <iput>
  end_op();
801044ef:	e8 dc e8 ff ff       	call   80102dd0 <end_op>
  curproc->cwd = 0;
801044f4:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)

  acquire(&ptable.lock);
801044fb:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104502:	e8 39 05 00 00       	call   80104a40 <acquire>

  // Main process might be sleeping in thread_join().
  // wakeup1(curproc->parent);
  wakeup1(curproc->mainproc);
80104507:	8b 83 84 00 00 00    	mov    0x84(%ebx),%eax
8010450d:	e8 9e f2 ff ff       	call   801037b0 <wakeup1>
...
80104515:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104518:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
      p->parent = initproc;
8010451d:	8b 0d 54 50 11 80    	mov    0x80115054,%ecx
  curproc->retval = retval;
80104523:	89 83 88 00 00 00    	mov    %eax,0x88(%ebx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104529:	eb 13                	jmp    8010453e <thread_exit+0x9e>
8010452b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010452f:	90                   	nop
80104530:	81 c2 8c 00 00 00    	add    $0x8c,%edx
80104536:	81 fa 54 50 11 80    	cmp    $0x80115054,%edx
8010453c:	74 3a                	je     80104578 <thread_exit+0xd8>
    if(p->parent == curproc){
8010453e:	39 5a 14             	cmp    %ebx,0x14(%edx)
80104541:	75 ed                	jne    80104530 <thread_exit+0x90>
      if(p->state == ZOMBIE)
80104543:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
80104547:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
8010454a:	75 e4                	jne    80104530 <thread_exit+0x90>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010454c:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104551:	eb 11                	jmp    80104564 <thread_exit+0xc4>
80104553:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104557:	90                   	nop
80104558:	05 8c 00 00 00       	add    $0x8c,%eax
8010455d:	3d 54 50 11 80       	cmp    $0x80115054,%eax
80104562:	74 cc                	je     80104530 <thread_exit+0x90>
    if(p->state == SLEEPING && p->chan == chan)
80104564:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80104568:	75 ee                	jne    80104558 <thread_exit+0xb8>
8010456a:	3b 48 20             	cmp    0x20(%eax),%ecx
8010456d:	75 e9                	jne    80104558 <thread_exit+0xb8>
      p->state = RUNNABLE;
8010456f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80104576:	eb e0                	jmp    80104558 <thread_exit+0xb8>
        wakeup1(initproc);
    }
  }
  ...
  curproc->state = ZOMBIE;
80104578:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
8010457f:	e8 bc f7 ff ff       	call   80103d40 <sched>
  panic("zombie exit");
80104584:	83 ec 0c             	sub    $0xc,%esp
80104587:	68 a8 7d 10 80       	push   $0x80107da8
...
801045a9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801045ac:	e8 3f 03 00 00       	call   801048f0 <pushcli>
  c = mycpu();
801045b1:	e8 aa f3 ff ff       	call   80103960 <mycpu>
  p = c->proc;
801045b6:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
801045bc:	e8 7f 03 00 00       	call   80104940 <popcli>
  struct proc *p;
  int found;
  struct proc *curproc = myproc();
...
801045c4:	68 20 2d 11 80       	push   $0x80112d20
801045c9:	e8 72 04 00 00       	call   80104a40 <acquire>
...
801045d1:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801045d3:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
801045d8:	eb 19                	jmp    801045f3 <thread_join+0x53>
801045da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->tid != thread)
        continue;
      found = 1;
801045e0:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801045e5:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
801045eb:	81 fb 54 50 11 80    	cmp    $0x80115054,%ebx
801045f1:	74 7d                	je     80104670 <thread_join+0xd0>
      if(p->tid != thread)
801045f3:	39 73 7c             	cmp    %esi,0x7c(%ebx)
801045f6:	75 ed                	jne    801045e5 <thread_join+0x45>
      if(p->state == ZOMBIE){
801045f8:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
801045fc:	75 e2                	jne    801045e0 <thread_join+0x40>
        // Found the thread.

        *retval = p->retval;
801045fe:	8b 93 88 00 00 00    	mov    0x88(%ebx),%edx
80104604:	8b 45 0c             	mov    0xc(%ebp),%eax
        kfree(p->kstack);
80104607:	83 ec 0c             	sub    $0xc,%esp
        *retval = p->retval;
8010460a:	89 10                	mov    %edx,(%eax)
        kfree(p->kstack);
8010460c:	ff 73 08             	push   0x8(%ebx)
8010460f:	e8 ac de ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
80104614:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        // freevm(p->pgdir);
        p->pid = 0;
8010461b:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->tid = 0;
80104622:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
        p->parent = 0;
80104629:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->mainproc = 0;
80104630:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
80104637:	00 00 00 
        p->name[0] = 0;
8010463a:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
8010463e:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->created = 0;
80104645:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
8010464c:	00 00 00 
        p->state = UNUSED;
8010464f:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104656:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010465d:	e8 7e 03 00 00       	call   801049e0 <release>
        return 0;
...
80104667:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010466a:	5b                   	pop    %ebx
8010466b:	5e                   	pop    %esi
8010466c:	5f                   	pop    %edi
8010466d:	5d                   	pop    %ebp
...
80104672:	74 3b                	je     801046af <thread_join+0x10f>
80104674:	8b 47 24             	mov    0x24(%edi),%eax
80104677:	85 c0                	test   %eax,%eax
80104679:	75 34                	jne    801046af <thread_join+0x10f>
  pushcli();
8010467b:	e8 70 02 00 00       	call   801048f0 <pushcli>
  c = mycpu();
80104680:	e8 db f2 ff ff       	call   80103960 <mycpu>
  p = c->proc;
80104685:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010468b:	e8 b0 02 00 00       	call   80104940 <popcli>
  if(p == 0)
80104690:	85 db                	test   %ebx,%ebx
80104692:	74 32                	je     801046c6 <thread_join+0x126>
  p->chan = chan;
80104694:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
80104697:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
8010469e:	e8 9d f6 ff ff       	call   80103d40 <sched>
  p->chan = 0;
801046a3:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
801046aa:	e9 22 ff ff ff       	jmp    801045d1 <thread_join+0x31>
      release(&ptable.lock);
801046af:	83 ec 0c             	sub    $0xc,%esp
801046b2:	68 20 2d 11 80       	push   $0x80112d20
801046b7:	e8 24 03 00 00       	call   801049e0 <release>
      return -1;
801046bc:	83 c4 10             	add    $0x10,%esp
801046bf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046c4:	eb a1                	jmp    80104667 <thread_join+0xc7>
    panic("sleep");
801046c6:	83 ec 0c             	sub    $0xc,%esp
801046c9:	68 b4 7d 10 80       	push   $0x80107db4
801046ce:	e8 ad bc ff ff       	call   80100380 <panic>
...
801046ef:	e8 4c 03 00 00       	call   80104a40 <acquire>
  if (curproc->tid == 0)
801046f4:	8b 43 7c             	mov    0x7c(%ebx),%eax
801046f7:	83 c4 10             	add    $0x10,%esp
801046fa:	85 c0                	test   %eax,%eax
801046fc:	74 29                	je     80104727 <merge+0x47>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
8010470a:	74 0f                	je     8010471b <merge+0x3b>
    if(p->pid == curproc->pid){
8010470c:	8b 53 10             	mov    0x10(%ebx),%edx
8010470f:	39 50 10             	cmp    %edx,0x10(%eax)
80104712:	75 07                	jne    8010471b <merge+0x3b>
      p->killed = 1;
80104714:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010471b:	05 8c 00 00 00       	add    $0x8c,%eax
80104720:	3d 54 50 11 80       	cmp    $0x80115054,%eax
80104725:	75 e1                	jne    80104708 <merge+0x28>
  merge1(curproc);
  release(&ptable.lock);
80104727:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
8010472e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104731:	c9                   	leave  
  release(&ptable.lock);
80104732:	e9 a9 02 00 00       	jmp    801049e0 <release>
...
8010474a:	68 48 7e 10 80       	push   $0x80107e48
8010474f:	8d 43 04             	lea    0x4(%ebx),%eax
80104752:	50                   	push   %eax
80104753:	e8 18 01 00 00       	call   80104870 <initlock>
  lk->name = name;
80104758:	8b 45 0c             	mov    0xc(%ebp),%eax
  lk->locked = 0;
8010475b:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
}
80104761:	83 c4 10             	add    $0x10,%esp
  lk->pid = 0;
80104764:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  lk->name = name;
8010476b:	89 43 38             	mov    %eax,0x38(%ebx)
}
...
8010478f:	e8 ac 02 00 00       	call   80104a40 <acquire>
  while (lk->locked) {
80104794:	8b 13                	mov    (%ebx),%edx
80104796:	83 c4 10             	add    $0x10,%esp
80104799:	85 d2                	test   %edx,%edx
8010479b:	74 16                	je     801047b3 <acquiresleep+0x33>
8010479d:	8d 76 00             	lea    0x0(%esi),%esi
    sleep(lk, &lk->lk);
801047a0:	83 ec 08             	sub    $0x8,%esp
801047a3:	56                   	push   %esi
801047a4:	53                   	push   %ebx
801047a5:	e8 e6 f8 ff ff       	call   80104090 <sleep>
  while (lk->locked) {
801047aa:	8b 03                	mov    (%ebx),%eax
801047ac:	83 c4 10             	add    $0x10,%esp
801047af:	85 c0                	test   %eax,%eax
801047b1:	75 ed                	jne    801047a0 <acquiresleep+0x20>
  }
  lk->locked = 1;
801047b3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801047b9:	e8 22 f2 ff ff       	call   801039e0 <myproc>
801047be:	8b 40 10             	mov    0x10(%eax),%eax
801047c1:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
801047c4:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
801047cc:	5d                   	pop    %ebp
  release(&lk->lk);
801047cd:	e9 0e 02 00 00       	jmp    801049e0 <release>
...
801047ef:	e8 4c 02 00 00       	call   80104a40 <acquire>
  lk->locked = 0;
801047f4:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
801047fa:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80104801:	89 1c 24             	mov    %ebx,(%esp)
80104804:	e8 47 f9 ff ff       	call   80104150 <wakeup>
  release(&lk->lk);
80104809:	89 75 08             	mov    %esi,0x8(%ebp)
...
80104814:	5d                   	pop    %ebp
  release(&lk->lk);
80104815:	e9 c6 01 00 00       	jmp    801049e0 <release>
...
80104824:	31 ff                	xor    %edi,%edi
80104826:	56                   	push   %esi
80104827:	53                   	push   %ebx
80104828:	83 ec 18             	sub    $0x18,%esp
8010482b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int r;
  
  acquire(&lk->lk);
8010482e:	8d 73 04             	lea    0x4(%ebx),%esi
80104831:	56                   	push   %esi
80104832:	e8 09 02 00 00       	call   80104a40 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104837:	8b 03                	mov    (%ebx),%eax
80104839:	83 c4 10             	add    $0x10,%esp
8010483c:	85 c0                	test   %eax,%eax
8010483e:	75 18                	jne    80104858 <holdingsleep+0x38>
  release(&lk->lk);
80104840:	83 ec 0c             	sub    $0xc,%esp
80104843:	56                   	push   %esi
80104844:	e8 97 01 00 00       	call   801049e0 <release>
  return r;
}
80104849:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010484c:	89 f8                	mov    %edi,%eax
8010484e:	5b                   	pop    %ebx
8010484f:	5e                   	pop    %esi
80104850:	5f                   	pop    %edi
80104851:	5d                   	pop    %ebp
...
80104857:	90                   	nop
  r = lk->locked && (lk->pid == myproc()->pid);
80104858:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
8010485b:	e8 80 f1 ff ff       	call   801039e0 <myproc>
80104860:	39 58 10             	cmp    %ebx,0x10(%eax)
80104863:	0f 94 c0             	sete   %al
80104866:	0f b6 c0             	movzbl %al,%eax
80104869:	89 c7                	mov    %eax,%edi
8010486b:	eb d3                	jmp    80104840 <holdingsleep+0x20>
...
{
80104899:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ebp = (uint*)v - 2;
8010489c:	83 e8 08             	sub    $0x8,%eax
  for(i = 0; i < 10; i++){
8010489f:	90                   	nop
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801048a0:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
801048a6:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
801048ac:	77 1a                	ja     801048c8 <getcallerpcs+0x38>
      break;
    pcs[i] = ebp[1];     // saved %eip
801048ae:	8b 58 04             	mov    0x4(%eax),%ebx
801048b1:	89 1c 91             	mov    %ebx,(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
801048b4:	83 c2 01             	add    $0x1,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
801048b7:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
801048b9:	83 fa 0a             	cmp    $0xa,%edx
...
801048c7:	90                   	nop
  for(; i < 10; i++)
801048c8:	8d 04 91             	lea    (%ecx,%edx,4),%eax
801048cb:	8d 51 28             	lea    0x28(%ecx),%edx
...
801048db:	75 f3                	jne    801048d0 <getcallerpcs+0x40>
}
...
801048f9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801048fa:	e8 61 f0 ff ff       	call   80103960 <mycpu>
801048ff:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80104905:	85 c0                	test   %eax,%eax
80104907:	74 17                	je     80104920 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80104909:	e8 52 f0 ff ff       	call   80103960 <mycpu>
8010490e:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
8010491a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80104920:	e8 3b f0 ff ff       	call   80103960 <mycpu>
80104925:	81 e3 00 02 00 00    	and    $0x200,%ebx
8010492b:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80104931:	eb d6                	jmp    80104909 <pushcli+0x19>
...
80104947:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80104948:	f6 c4 02             	test   $0x2,%ah
8010494b:	75 35                	jne    80104982 <popcli+0x42>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
8010494d:	e8 0e f0 ff ff       	call   80103960 <mycpu>
80104952:	83 a8 a4 00 00 00 01 	subl   $0x1,0xa4(%eax)
80104959:	78 34                	js     8010498f <popcli+0x4f>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
8010495b:	e8 00 f0 ff ff       	call   80103960 <mycpu>
80104960:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80104966:	85 d2                	test   %edx,%edx
80104968:	74 06                	je     80104970 <popcli+0x30>
    sti();
}
8010496a:	c9                   	leave  
8010496b:	c3                   	ret    
8010496c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104970:	e8 eb ef ff ff       	call   80103960 <mycpu>
80104975:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
8010497b:	85 c0                	test   %eax,%eax
8010497d:	74 eb                	je     8010496a <popcli+0x2a>
  asm volatile("sti");
8010497f:	fb                   	sti    
}
80104980:	c9                   	leave  
...
80104985:	68 53 7e 10 80       	push   $0x80107e53
8010498a:	e8 f1 b9 ff ff       	call   80100380 <panic>
    panic("popcli");
8010498f:	83 ec 0c             	sub    $0xc,%esp
80104992:	68 6a 7e 10 80       	push   $0x80107e6a
80104997:	e8 e4 b9 ff ff       	call   80100380 <panic>
...
801049a8:	31 db                	xor    %ebx,%ebx
  pushcli();
801049aa:	e8 41 ff ff ff       	call   801048f0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801049af:	8b 06                	mov    (%esi),%eax
801049b1:	85 c0                	test   %eax,%eax
801049b3:	75 0b                	jne    801049c0 <holding+0x20>
  popcli();
801049b5:	e8 86 ff ff ff       	call   80104940 <popcli>
}
...
801049bf:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
801049c0:	8b 5e 08             	mov    0x8(%esi),%ebx
801049c3:	e8 98 ef ff ff       	call   80103960 <mycpu>
801049c8:	39 c3                	cmp    %eax,%ebx
801049ca:	0f 94 c3             	sete   %bl
  popcli();
801049cd:	e8 6e ff ff ff       	call   80104940 <popcli>
  r = lock->locked && lock->cpu == mycpu();
801049d2:	0f b6 db             	movzbl %bl,%ebx
}
...
801049e5:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
801049e8:	e8 03 ff ff ff       	call   801048f0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801049ed:	8b 03                	mov    (%ebx),%eax
801049ef:	85 c0                	test   %eax,%eax
801049f1:	75 15                	jne    80104a08 <release+0x28>
  popcli();
801049f3:	e8 48 ff ff ff       	call   80104940 <popcli>
    panic("release");
801049f8:	83 ec 0c             	sub    $0xc,%esp
801049fb:	68 71 7e 10 80       	push   $0x80107e71
80104a00:	e8 7b b9 ff ff       	call   80100380 <panic>
80104a05:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80104a08:	8b 73 08             	mov    0x8(%ebx),%esi
80104a0b:	e8 50 ef ff ff       	call   80103960 <mycpu>
80104a10:	39 c6                	cmp    %eax,%esi
80104a12:	75 df                	jne    801049f3 <release+0x13>
  popcli();
80104a14:	e8 27 ff ff ff       	call   80104940 <popcli>
  lk->pcs[0] = 0;
...
80104a37:	5d                   	pop    %ebp
  popcli();
80104a38:	e9 03 ff ff ff       	jmp    80104940 <popcli>
...
80104a47:	e8 a4 fe ff ff       	call   801048f0 <pushcli>
  if(holding(lk))
80104a4c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80104a4f:	e8 9c fe ff ff       	call   801048f0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104a54:	8b 03                	mov    (%ebx),%eax
80104a56:	85 c0                	test   %eax,%eax
80104a58:	75 7e                	jne    80104ad8 <acquire+0x98>
  popcli();
80104a5a:	e8 e1 fe ff ff       	call   80104940 <popcli>
  asm volatile("lock; xchgl %0, %1" :
80104a5f:	b9 01 00 00 00       	mov    $0x1,%ecx
80104a64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  while(xchg(&lk->locked, 1) != 0)
80104a68:	8b 55 08             	mov    0x8(%ebp),%edx
80104a6b:	89 c8                	mov    %ecx,%eax
80104a6d:	f0 87 02             	lock xchg %eax,(%edx)
80104a70:	85 c0                	test   %eax,%eax
80104a72:	75 f4                	jne    80104a68 <acquire+0x28>
  __sync_synchronize();
80104a74:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104a79:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104a7c:	e8 df ee ff ff       	call   80103960 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80104a81:	8b 4d 08             	mov    0x8(%ebp),%ecx
  ebp = (uint*)v - 2;
80104a84:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
...
80104a9c:	77 1a                	ja     80104ab8 <acquire+0x78>
    pcs[i] = ebp[1];     // saved %eip
80104a9e:	8b 5a 04             	mov    0x4(%edx),%ebx
80104aa1:	89 5c 81 0c          	mov    %ebx,0xc(%ecx,%eax,4)
  for(i = 0; i < 10; i++){
80104aa5:	83 c0 01             	add    $0x1,%eax
    ebp = (uint*)ebp[0]; // saved %ebp
80104aa8:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
...
80104ab4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
80104ab8:	8d 44 81 0c          	lea    0xc(%ecx,%eax,4),%eax
80104abc:	8d 51 34             	lea    0x34(%ecx),%edx
80104abf:	90                   	nop
    pcs[i] = 0;
...
80104acb:	75 f3                	jne    80104ac0 <acquire+0x80>
}
...
80104ad2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80104ad8:	8b 5b 08             	mov    0x8(%ebx),%ebx
80104adb:	e8 80 ee ff ff       	call   80103960 <mycpu>
80104ae0:	39 c3                	cmp    %eax,%ebx
80104ae2:	0f 85 72 ff ff ff    	jne    80104a5a <acquire+0x1a>
  popcli();
80104ae8:	e8 53 fe ff ff       	call   80104940 <popcli>
    panic("acquire");
80104aed:	83 ec 0c             	sub    $0xc,%esp
80104af0:	68 79 7e 10 80       	push   $0x80107e79
80104af5:	e8 86 b8 ff ff       	call   80100380 <panic>
...
80104b0e:	89 d7                	mov    %edx,%edi
80104b10:	09 cf                	or     %ecx,%edi
80104b12:	83 e7 03             	and    $0x3,%edi
80104b15:	75 29                	jne    80104b40 <memset+0x40>
    c &= 0xFF;
80104b17:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104b1a:	c1 e0 18             	shl    $0x18,%eax
80104b1d:	89 fb                	mov    %edi,%ebx
80104b1f:	c1 e9 02             	shr    $0x2,%ecx
80104b22:	c1 e3 10             	shl    $0x10,%ebx
80104b25:	09 d8                	or     %ebx,%eax
80104b27:	09 f8                	or     %edi,%eax
80104b29:	c1 e7 08             	shl    $0x8,%edi
80104b2c:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80104b2e:	89 d7                	mov    %edx,%edi
80104b30:	fc                   	cld    
80104b31:	f3 ab                	rep stos %eax,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
80104b33:	5b                   	pop    %ebx
80104b34:	89 d0                	mov    %edx,%eax
80104b36:	5f                   	pop    %edi
80104b37:	5d                   	pop    %ebp
80104b38:	c3                   	ret    
...
80104b57:	8b 55 08             	mov    0x8(%ebp),%edx
...
80104bb2:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
80104bb5:	39 fa                	cmp    %edi,%edx
80104bb7:	73 1f                	jae    80104bd8 <memmove+0x38>
80104bb9:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
80104bbc:	85 c9                	test   %ecx,%ecx
80104bbe:	74 0c                	je     80104bcc <memmove+0x2c>
      *--d = *--s;
...
80104bd2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
80104bd8:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
...
80104c69:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;
...
80104c7a:	0f b6 57 ff          	movzbl -0x1(%edi),%edx
80104c7e:	88 50 ff             	mov    %dl,-0x1(%eax)
80104c81:	84 d2                	test   %dl,%dl
80104c83:	74 09                	je     80104c8e <strncpy+0x2e>
80104c85:	89 cb                	mov    %ecx,%ebx
80104c87:	83 e9 01             	sub    $0x1,%ecx
...
80104c92:	7e 17                	jle    80104cab <strncpy+0x4b>
80104c94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    *s++ = 0;
80104c98:	83 c2 01             	add    $0x1,%edx
80104c9b:	89 c1                	mov    %eax,%ecx
80104c9d:	c6 42 ff 00          	movb   $0x0,-0x1(%edx)
  while(n-- > 0)
80104ca1:	29 d1                	sub    %edx,%ecx
80104ca3:	8d 4c 0b ff          	lea    -0x1(%ebx,%ecx,1),%ecx
80104ca7:	85 c9                	test   %ecx,%ecx
80104ca9:	7f ed                	jg     80104c98 <strncpy+0x38>
  return os;
}
80104cab:	5b                   	pop    %ebx
...
80104d37:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104d3a:	e8 a1 ec ff ff       	call   801039e0 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104d3f:	8b 00                	mov    (%eax),%eax
80104d41:	39 d8                	cmp    %ebx,%eax
80104d43:	76 1b                	jbe    80104d60 <fetchint+0x30>
...
80104d77:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104d7a:	e8 61 ec ff ff       	call   801039e0 <myproc>

  if(addr >= curproc->sz)
80104d7f:	39 18                	cmp    %ebx,(%eax)
80104d81:	76 2d                	jbe    80104db0 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
...
80104d9b:	39 c2                	cmp    %eax,%edx
80104d9d:	76 11                	jbe    80104db0 <fetchstr+0x40>
    if(*s == 0)
...
80104dc5:	e8 16 ec ff ff       	call   801039e0 <myproc>
...
80104dd3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104dd6:	e8 05 ec ff ff       	call   801039e0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104e16:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104e19:	e8 c2 eb ff ff       	call   801039e0 <myproc>
...
80104e2e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104e31:	e8 aa eb ff ff       	call   801039e0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104e54:	76 1a                	jbe    80104e70 <argptr+0x60>
...
80104e84:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104e85:	e8 56 eb ff ff       	call   801039e0 <myproc>
...
80104e93:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104e96:	e8 45 eb ff ff       	call   801039e0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104eab:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104eae:	e8 2d eb ff ff       	call   801039e0 <myproc>
  if(addr >= curproc->sz)
...
80104ed5:	76 11                	jbe    80104ee8 <argstr+0x68>
    if(*s == 0)
...
80104f04:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104f07:	e8 d4 ea ff ff       	call   801039e0 <myproc>
...
80104f1c:	8b 14 85 a0 7e 10 80 	mov    -0x7fef8160(,%eax,4),%edx
...
80104f40:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104f41:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104f44:	50                   	push   %eax
80104f45:	ff 73 10             	push   0x10(%ebx)
80104f48:	68 81 7e 10 80       	push   $0x80107e81
80104f4d:	e8 4e b7 ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
...
80104f87:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104f8a:	e8 31 d1 ff ff       	call   801020c0 <nameiparent>
...
80104fac:	e8 2f cd ff ff       	call   80101ce0 <dirlookup>
...
80104fbe:	e8 4d ca ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80104fc3:	89 34 24             	mov    %esi,(%esp)
80104fc6:	e8 b5 c7 ff ff       	call   80101780 <ilock>
...
80104ff4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104ff6:	e8 15 ca ff ff       	call   80101a10 <iunlockput>
    return 0;
...
80105018:	ff 33                	push   (%ebx)
8010501a:	e8 f1 c5 ff ff       	call   80101610 <ialloc>
...
80105030:	e8 4b c7 ff ff       	call   80101780 <ilock>
  ip->major = major;
...
80105051:	e8 7a c6 ff ff       	call   801016d0 <iupdate>
...
80105063:	ff 76 04             	push   0x4(%esi)
80105066:	57                   	push   %edi
80105067:	53                   	push   %ebx
80105068:	e8 73 cf ff ff       	call   80101fe0 <dirlink>
...
80105078:	e8 93 c9 ff ff       	call   80101a10 <iunlockput>
  return ip;
...
80105099:	e8 32 c6 ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010509e:	83 c4 0c             	add    $0xc,%esp
801050a1:	ff 76 04             	push   0x4(%esi)
801050a4:	68 20 7f 10 80       	push   $0x80107f20
801050a9:	56                   	push   %esi
801050aa:	e8 31 cf ff ff       	call   80101fe0 <dirlink>
...
801050b9:	ff 73 04             	push   0x4(%ebx)
801050bc:	68 1f 7f 10 80       	push   $0x80107f1f
801050c1:	56                   	push   %esi
801050c2:	e8 19 cf ff ff       	call   80101fe0 <dirlink>
...
801050d1:	68 13 7f 10 80       	push   $0x80107f13
801050d6:	e8 a5 b2 ff ff       	call   80100380 <panic>
...
801050ef:	68 22 7f 10 80       	push   $0x80107f22
801050f4:	e8 87 b2 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
801050f9:	83 ec 0c             	sub    $0xc,%esp
801050fc:	68 04 7f 10 80       	push   $0x80107f04
...
8010511e:	e8 9d fc ff ff       	call   80104dc0 <argint>
...
80105130:	e8 ab e8 ff ff       	call   801039e0 <myproc>
...
8010513e:	74 20                	je     80105160 <sys_dup+0x50>
  struct proc *curproc = myproc();
80105140:	e8 9b e8 ff ff       	call   801039e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105170:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105173:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
80105177:	56                   	push   %esi
80105178:	e8 23 bd ff ff       	call   80100ea0 <filedup>
  return fd;
...
8010519e:	e8 1d fc ff ff       	call   80104dc0 <argint>
...
801051b0:	e8 2b e8 ff ff       	call   801039e0 <myproc>
...
801051c9:	e8 f2 fb ff ff       	call   80104dc0 <argint>
...
801051de:	e8 2d fc ff ff       	call   80104e10 <argptr>
...
801051f4:	e8 27 be ff ff       	call   80101020 <fileread>
...
8010521e:	e8 9d fb ff ff       	call   80104dc0 <argint>
...
80105230:	e8 ab e7 ff ff       	call   801039e0 <myproc>
...
80105249:	e8 72 fb ff ff       	call   80104dc0 <argint>
...
8010525e:	e8 ad fb ff ff       	call   80104e10 <argptr>
...
80105274:	e8 37 be ff ff       	call   801010b0 <filewrite>
...
8010529e:	e8 1d fb ff ff       	call   80104dc0 <argint>
...
801052b0:	e8 2b e7 ff ff       	call   801039e0 <myproc>
801052b5:	8b 55 f4             	mov    -0xc(%ebp),%edx
801052b8:	8d 5a 08             	lea    0x8(%edx),%ebx
801052bb:	8b 74 98 08          	mov    0x8(%eax,%ebx,4),%esi
801052bf:	85 f6                	test   %esi,%esi
801052c1:	74 25                	je     801052e8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
801052c3:	e8 18 e7 ff ff       	call   801039e0 <myproc>
  fileclose(f);
801052c8:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
801052cb:	c7 44 98 08 00 00 00 	movl   $0x0,0x8(%eax,%ebx,4)
801052d2:	00 
  fileclose(f);
...
801052fe:	e8 bd fa ff ff       	call   80104dc0 <argint>
...
80105310:	e8 cb e6 ff ff       	call   801039e0 <myproc>
...
80105328:	e8 e3 fa ff ff       	call   80104e10 <argptr>
...
8010533b:	e8 90 bc ff ff       	call   80100fd0 <filestat>
...
8010536f:	e8 0c fb ff ff       	call   80104e80 <argstr>
...
801053d8:	e8 f3 c2 ff ff       	call   801016d0 <iupdate>
  iunlock(ip);
...
801053eb:	e8 d0 cc ff ff       	call   801020c0 <nameiparent>
...
80105413:	e8 c8 cb ff ff       	call   80101fe0 <dirlink>
...
80105423:	e8 e8 c5 ff ff       	call   80101a10 <iunlockput>
  iput(ip);
80105428:	89 1c 24             	mov    %ebx,(%esp)
8010542b:	e8 80 c4 ff ff       	call   801018b0 <iput>
  end_op();
...
8010544c:	e8 bf c5 ff ff       	call   80101a10 <iunlockput>
    goto bad;
...
80105465:	e8 66 c2 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
8010546a:	89 1c 24             	mov    %ebx,(%esp)
8010546d:	e8 9e c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105472:	e8 59 d9 ff ff       	call   80102dd0 <end_op>
  return -1;
...
80105485:	e8 86 c5 ff ff       	call   80101a10 <iunlockput>
    end_op();
8010548a:	e8 41 d9 ff ff       	call   80102dd0 <end_op>
    return -1;
8010548f:	83 c4 10             	add    $0x10,%esp
80105492:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105497:	eb a1                	jmp    8010543a <sys_link+0xda>
    end_op();
80105499:	e8 32 d9 ff ff       	call   80102dd0 <end_op>
    return -1;
8010549e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054a3:	eb 95                	jmp    8010543a <sys_link+0xda>
...
801054bf:	e8 bc f9 ff ff       	call   80104e80 <argstr>
801054c4:	83 c4 10             	add    $0x10,%esp
801054c7:	85 c0                	test   %eax,%eax
801054c9:	0f 88 7a 01 00 00    	js     80105649 <sys_unlink+0x199>
  begin_op();
...
801054de:	e8 dd cb ff ff       	call   801020c0 <nameiparent>
801054e3:	83 c4 10             	add    $0x10,%esp
801054e6:	89 45 b4             	mov    %eax,-0x4c(%ebp)
801054e9:	85 c0                	test   %eax,%eax
801054eb:	0f 84 62 01 00 00    	je     80105653 <sys_unlink+0x1a3>
  ilock(dp);
801054f1:	8b 7d b4             	mov    -0x4c(%ebp),%edi
801054f4:	83 ec 0c             	sub    $0xc,%esp
801054f7:	57                   	push   %edi
801054f8:	e8 83 c2 ff ff       	call   80101780 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801054fd:	58                   	pop    %eax
801054fe:	5a                   	pop    %edx
801054ff:	68 20 7f 10 80       	push   $0x80107f20
80105504:	53                   	push   %ebx
80105505:	e8 b6 c7 ff ff       	call   80101cc0 <namecmp>
...
80105518:	68 1f 7f 10 80       	push   $0x80107f1f
8010551d:	53                   	push   %ebx
8010551e:	e8 9d c7 ff ff       	call   80101cc0 <namecmp>
...
80105537:	e8 a4 c7 ff ff       	call   80101ce0 <dirlookup>
...
8010554d:	e8 2e c2 ff ff       	call   80101780 <ilock>
  if(ip->nlink < 1)
80105552:	83 c4 10             	add    $0x10,%esp
80105555:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
8010555a:	0f 8e 1c 01 00 00    	jle    8010567c <sys_unlink+0x1cc>
...
801055a2:	e8 69 c4 ff ff       	call   80101a10 <iunlockput>
  ip->nlink--;
801055a7:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801055ac:	89 1c 24             	mov    %ebx,(%esp)
801055af:	e8 1c c1 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
801055b4:	89 1c 24             	mov    %ebx,(%esp)
801055b7:	e8 54 c4 ff ff       	call   80101a10 <iunlockput>
  end_op();
801055bc:	e8 0f d8 ff ff       	call   80102dd0 <end_op>
  return 0;
...
801055ed:	e8 9e c4 ff ff       	call   80101a90 <readi>
801055f2:	83 c4 10             	add    $0x10,%esp
801055f5:	83 f8 10             	cmp    $0x10,%eax
801055f8:	75 68                	jne    80105662 <sys_unlink+0x1b2>
    if(de.inum != 0)
...
80105605:	e8 06 c4 ff ff       	call   80101a10 <iunlockput>
    goto bad;
...
80105616:	e8 f5 c3 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010561b:	e8 b0 d7 ff ff       	call   80102dd0 <end_op>
  return -1;
...
8010563c:	e8 8f c0 ff ff       	call   801016d0 <iupdate>
...
8010564e:	e9 73 ff ff ff       	jmp    801055c6 <sys_unlink+0x116>
    end_op();
80105653:	e8 78 d7 ff ff       	call   80102dd0 <end_op>
    return -1;
80105658:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010565d:	e9 64 ff ff ff       	jmp    801055c6 <sys_unlink+0x116>
      panic("isdirempty: readi");
80105662:	83 ec 0c             	sub    $0xc,%esp
80105665:	68 44 7f 10 80       	push   $0x80107f44
8010566a:	e8 11 ad ff ff       	call   80100380 <panic>
    panic("unlink: writei");
8010566f:	83 ec 0c             	sub    $0xc,%esp
80105672:	68 56 7f 10 80       	push   $0x80107f56
80105677:	e8 04 ad ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
8010567c:	83 ec 0c             	sub    $0xc,%esp
8010567f:	68 32 7f 10 80       	push   $0x80107f32
...
80105695:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
...
8010569f:	e8 dc f7 ff ff       	call   80104e80 <argstr>
801056a4:	83 c4 10             	add    $0x10,%esp
801056a7:	85 c0                	test   %eax,%eax
801056a9:	0f 88 8e 00 00 00    	js     8010573d <sys_open+0xad>
801056af:	83 ec 08             	sub    $0x8,%esp
801056b2:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801056b5:	50                   	push   %eax
801056b6:	6a 01                	push   $0x1
801056b8:	e8 03 f7 ff ff       	call   80104dc0 <argint>
801056bd:	83 c4 10             	add    $0x10,%esp
801056c0:	85 c0                	test   %eax,%eax
801056c2:	78 79                	js     8010573d <sys_open+0xad>
    return -1;

  begin_op();
801056c4:	e8 97 d6 ff ff       	call   80102d60 <begin_op>

  if(omode & O_CREATE){
801056c9:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
801056cd:	75 79                	jne    80105748 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
801056d2:	ff 75 e0             	push   -0x20(%ebp)
801056d5:	e8 c6 c9 ff ff       	call   801020a0 <namei>
801056da:	83 c4 10             	add    $0x10,%esp
801056dd:	89 c6                	mov    %eax,%esi
801056df:	85 c0                	test   %eax,%eax
801056e1:	0f 84 7e 00 00 00    	je     80105765 <sys_open+0xd5>
      end_op();
      return -1;
    }
    ilock(ip);
...
801056eb:	e8 90 c0 ff ff       	call   80101780 <ilock>
...
80105724:	e8 c7 b7 ff ff       	call   80100ef0 <fileclose>
80105729:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010572c:	83 ec 0c             	sub    $0xc,%esp
8010572f:	56                   	push   %esi
80105730:	e8 db c2 ff ff       	call   80101a10 <iunlockput>
    end_op();
...
80105757:	e8 14 f8 ff ff       	call   80104f70 <create>
    if(ip == 0){
...
80105780:	e8 db c0 ff ff       	call   80101860 <iunlock>
  end_op();
...
801057de:	8d 45 f4             	lea    -0xc(%ebp),%eax
801057e1:	50                   	push   %eax
801057e2:	6a 00                	push   $0x0
801057e4:	e8 97 f6 ff ff       	call   80104e80 <argstr>
...
801057f8:	ba 01 00 00 00       	mov    $0x1,%edx
801057fd:	6a 00                	push   $0x0
801057ff:	e8 6c f7 ff ff       	call   80104f70 <create>
...
8010580f:	e8 fc c1 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105814:	e8 b7 d5 ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105844:	e8 37 f6 ff ff       	call   80104e80 <argstr>
...
80105859:	e8 62 f5 ff ff       	call   80104dc0 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010586e:	e8 4d f5 ff ff       	call   80104dc0 <argint>
     argint(1, &major) < 0 ||
...
8010588e:	e8 dd f6 ff ff       	call   80104f70 <create>
     argint(2, &minor) < 0 ||
...
8010589e:	e8 6d c1 ff ff       	call   80101a10 <iunlockput>
  end_op();
801058a3:	e8 28 d5 ff ff       	call   80102dd0 <end_op>
  return 0;
...
801058af:	90                   	nop
    end_op();
801058b0:	e8 1b d5 ff ff       	call   80102dd0 <end_op>
    return -1;
...
801058c5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801058c8:	e8 13 e1 ff ff       	call   801039e0 <myproc>
...
801058dd:	e8 9e f5 ff ff       	call   80104e80 <argstr>
...
801058ec:	ff 75 f4             	push   -0xc(%ebp)
801058ef:	e8 ac c7 ff ff       	call   801020a0 <namei>
801058f4:	83 c4 10             	add    $0x10,%esp
801058f7:	89 c3                	mov    %eax,%ebx
...
80105901:	e8 7a be ff ff       	call   80101780 <ilock>
  if(ip->type != T_DIR){
...
80105914:	e8 47 bf ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
80105919:	58                   	pop    %eax
8010591a:	ff 76 68             	push   0x68(%esi)
8010591d:	e8 8e bf ff ff       	call   801018b0 <iput>
  end_op();
80105922:	e8 a9 d4 ff ff       	call   80102dd0 <end_op>
  curproc->cwd = ip;
...
80105944:	e8 c7 c0 ff ff       	call   80101a10 <iunlockput>
    end_op();
80105949:	e8 82 d4 ff ff       	call   80102dd0 <end_op>
    return -1;
...
80105975:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
{
...
80105985:	e8 f6 f4 ff ff       	call   80104e80 <argstr>
...
80105998:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
8010599e:	50                   	push   %eax
8010599f:	6a 01                	push   $0x1
801059a1:	e8 1a f4 ff ff       	call   80104dc0 <argint>
...
801059b0:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
  for(i=0;; i++){
...
801059c0:	e8 3b f1 ff ff       	call   80104b00 <memset>
...
801059d3:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
801059d9:	8d 3c 9d 00 00 00 00 	lea    0x0(,%ebx,4),%edi
801059e0:	50                   	push   %eax
801059e1:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
801059e7:	01 f8                	add    %edi,%eax
801059e9:	50                   	push   %eax
801059ea:	e8 41 f3 ff ff       	call   80104d30 <fetchint>
801059ef:	83 c4 10             	add    $0x10,%esp
801059f2:	85 c0                	test   %eax,%eax
801059f4:	78 26                	js     80105a1c <sys_exec+0xac>
      return -1;
    if(uarg == 0){
801059f6:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
801059fc:	85 c0                	test   %eax,%eax
801059fe:	74 30                	je     80105a30 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80105a00:	83 ec 08             	sub    $0x8,%esp
80105a03:	8d 14 3e             	lea    (%esi,%edi,1),%edx
80105a06:	52                   	push   %edx
80105a07:	50                   	push   %eax
80105a08:	e8 63 f3 ff ff       	call   80104d70 <fetchstr>
80105a0d:	83 c4 10             	add    $0x10,%esp
80105a10:	85 c0                	test   %eax,%eax
80105a12:	78 08                	js     80105a1c <sys_exec+0xac>
  for(i=0;; i++){
80105a14:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80105a17:	83 fb 20             	cmp    $0x20,%ebx
80105a1a:	75 b4                	jne    801059d0 <sys_exec+0x60>
      return -1;
  }
  merge(myproc());
...
80105a29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      argv[i] = 0;
80105a30:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
80105a37:	00 00 00 00 
  merge(myproc());
80105a3b:	e8 a0 df ff ff       	call   801039e0 <myproc>
80105a40:	83 ec 0c             	sub    $0xc,%esp
80105a43:	50                   	push   %eax
80105a44:	e8 97 ec ff ff       	call   801046e0 <merge>
  return exec(path, argv);
80105a49:	58                   	pop    %eax
80105a4a:	5a                   	pop    %edx
80105a4b:	56                   	push   %esi
80105a4c:	ff b5 5c ff ff ff    	push   -0xa4(%ebp)
80105a52:	e8 59 b0 ff ff       	call   80100ab0 <exec>
...
80105a81:	e8 8a f3 ff ff       	call   80104e10 <argptr>
80105a86:	83 c4 10             	add    $0x10,%esp
80105a89:	85 c0                	test   %eax,%eax
80105a8b:	78 4a                	js     80105ad7 <sys_pipe+0x67>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80105a8d:	83 ec 08             	sub    $0x8,%esp
80105a90:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105a93:	50                   	push   %eax
80105a94:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105a97:	50                   	push   %eax
80105a98:	e8 93 d9 ff ff       	call   80103430 <pipealloc>
80105a9d:	83 c4 10             	add    $0x10,%esp
80105aa0:	85 c0                	test   %eax,%eax
80105aa2:	78 33                	js     80105ad7 <sys_pipe+0x67>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105aa4:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
80105aa7:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105aa9:	e8 32 df ff ff       	call   801039e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80105aae:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
80105ab0:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
80105ab4:	85 f6                	test   %esi,%esi
80105ab6:	74 28                	je     80105ae0 <sys_pipe+0x70>
  for(fd = 0; fd < NOFILE; fd++){
80105ab8:	83 c3 01             	add    $0x1,%ebx
80105abb:	83 fb 10             	cmp    $0x10,%ebx
80105abe:	75 f0                	jne    80105ab0 <sys_pipe+0x40>
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
80105ac0:	83 ec 0c             	sub    $0xc,%esp
80105ac3:	ff 75 e0             	push   -0x20(%ebp)
80105ac6:	e8 25 b4 ff ff       	call   80100ef0 <fileclose>
    fileclose(wf);
80105acb:	58                   	pop    %eax
80105acc:	ff 75 e4             	push   -0x1c(%ebp)
80105acf:	e8 1c b4 ff ff       	call   80100ef0 <fileclose>
    return -1;
80105ad4:	83 c4 10             	add    $0x10,%esp
80105ad7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105adc:	eb 53                	jmp    80105b31 <sys_pipe+0xc1>
...
80105ae7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105aea:	e8 f1 de ff ff       	call   801039e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105afe:	74 20                	je     80105b20 <sys_pipe+0xb0>
  for(fd = 0; fd < NOFILE; fd++){
80105b00:	83 c2 01             	add    $0x1,%edx
80105b03:	83 fa 10             	cmp    $0x10,%edx
80105b06:	75 f0                	jne    80105af8 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105b08:	e8 d3 de ff ff       	call   801039e0 <myproc>
80105b0d:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
80105b14:	00 
80105b15:	eb a9                	jmp    80105ac0 <sys_pipe+0x50>
80105b17:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105b1e:	66 90                	xchg   %ax,%ax
      curproc->ofile[fd] = f;
80105b20:	89 7c 90 28          	mov    %edi,0x28(%eax,%edx,4)
  }
  fd[0] = fd0;
80105b24:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105b27:	89 18                	mov    %ebx,(%eax)
  fd[1] = fd1;
80105b29:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105b2c:	89 50 04             	mov    %edx,0x4(%eax)
  return 0;
...
{
  return fork();
80105b40:	e9 3b e0 ff ff       	jmp    80103b80 <fork>
...
80105b5f:	e8 7c eb ff ff       	call   801046e0 <merge>
  if (myproc()->created)
80105b64:	e8 77 de ff ff       	call   801039e0 <myproc>
80105b69:	83 c4 10             	add    $0x10,%esp
80105b6c:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80105b72:	85 c0                	test   %eax,%eax
80105b74:	74 1a                	je     80105b90 <sys_exit+0x40>
    thread_exit(0);
80105b76:	83 ec 0c             	sub    $0xc,%esp
80105b79:	6a 00                	push   $0x0
80105b7b:	e8 20 e9 ff ff       	call   801044a0 <thread_exit>
...
80105b8e:	66 90                	xchg   %ax,%ax
    exit();
80105b90:	e8 6b e2 ff ff       	call   80103e00 <exit>
}
...
{
  return wait();
80105ba0:	e9 5b e3 ff ff       	jmp    80103f00 <wait>
...
80105bbc:	e8 ff f1 ff ff       	call   80104dc0 <argint>
...
80105bce:	e8 dd e5 ff ff       	call   801041b0 <kill>
...
80105bf3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105bf6:	e8 e5 dd ff ff       	call   801039e0 <myproc>
...
80105c26:	e8 d5 de ff ff       	call   80103b00 <growproc>
...
80105c5d:	e8 5e f1 ff ff       	call   80104dc0 <argint>
...
80105c70:	68 80 50 11 80       	push   $0x80115080
80105c75:	e8 c6 ed ff ff       	call   80104a40 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105c7a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105c7d:	8b 1d 60 50 11 80    	mov    0x80115060,%ebx
  while(ticks - ticks0 < n){
...
80105c93:	68 80 50 11 80       	push   $0x80115080
80105c98:	68 60 50 11 80       	push   $0x80115060
80105c9d:	e8 ee e3 ff ff       	call   80104090 <sleep>
  while(ticks - ticks0 < n){
80105ca2:	a1 60 50 11 80       	mov    0x80115060,%eax
...
80105caf:	73 2f                	jae    80105ce0 <sys_sleep+0x90>
    if(myproc()->killed){
80105cb1:	e8 2a dd ff ff       	call   801039e0 <myproc>
...
80105cc0:	68 80 50 11 80       	push   $0x80115080
80105cc5:	e8 16 ed ff ff       	call   801049e0 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105ce3:	68 80 50 11 80       	push   $0x80115080
80105ce8:	e8 f3 ec ff ff       	call   801049e0 <release>
  return 0;
...
80105d04:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105d07:	68 80 50 11 80       	push   $0x80115080
80105d0c:	e8 2f ed ff ff       	call   80104a40 <acquire>
  xticks = ticks;
80105d11:	8b 1d 60 50 11 80    	mov    0x80115060,%ebx
  release(&tickslock);
80105d17:	c7 04 24 80 50 11 80 	movl   $0x80115080,(%esp)
80105d1e:	e8 bd ec ff ff       	call   801049e0 <release>
  return xticks;
}
...
80105d3e:	e8 cd f0 ff ff       	call   80104e10 <argptr>
80105d43:	83 c4 10             	add    $0x10,%esp
80105d46:	85 c0                	test   %eax,%eax
80105d48:	78 46                	js     80105d90 <sys_thread_create+0x60>
    return -1;
...
80105d55:	e8 b6 f0 ff ff       	call   80104e10 <argptr>
80105d5a:	83 c4 10             	add    $0x10,%esp
80105d5d:	85 c0                	test   %eax,%eax
80105d5f:	78 2f                	js     80105d90 <sys_thread_create+0x60>
    return -1;
  if (argptr(2, &arg, sizeof(void*)) < 0) 
80105d61:	83 ec 04             	sub    $0x4,%esp
80105d64:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105d67:	6a 04                	push   $0x4
80105d69:	50                   	push   %eax
80105d6a:	6a 02                	push   $0x2
80105d6c:	e8 9f f0 ff ff       	call   80104e10 <argptr>
80105d71:	83 c4 10             	add    $0x10,%esp
80105d74:	85 c0                	test   %eax,%eax
80105d76:	78 18                	js     80105d90 <sys_thread_create+0x60>
    return -1;
  return thread_create((thread_t*)thread, (void*(*)(void*))start_routine, (void*)arg);
80105d78:	83 ec 04             	sub    $0x4,%esp
80105d7b:	ff 75 f4             	push   -0xc(%ebp)
80105d7e:	ff 75 f0             	push   -0x10(%ebp)
80105d81:	ff 75 ec             	push   -0x14(%ebp)
80105d84:	e8 87 e5 ff ff       	call   80104310 <thread_create>
...
80105dae:	e8 5d f0 ff ff       	call   80104e10 <argptr>
80105db3:	83 c4 10             	add    $0x10,%esp
80105db6:	85 c0                	test   %eax,%eax
80105db8:	78 16                	js     80105dd0 <sys_thread_exit+0x30>
    return -1;
  thread_exit((void*)retval);
80105dba:	83 ec 0c             	sub    $0xc,%esp
80105dbd:	ff 75 f4             	push   -0xc(%ebp)
80105dc0:	e8 db e6 ff ff       	call   801044a0 <thread_exit>
  return 0;
...
80105e70:	8b 14 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%edx
80105e77:	c7 04 c5 c2 50 11 80 	movl   $0x8e000008,-0x7feeaf3e(,%eax,8)
80105e7e:	08 00 00 8e 
80105e82:	66 89 14 c5 c0 50 11 	mov    %dx,-0x7feeaf40(,%eax,8)
80105e89:	80 
80105e8a:	c1 ea 10             	shr    $0x10,%edx
80105e8d:	66 89 14 c5 c6 50 11 	mov    %dx,-0x7feeaf3a(,%eax,8)
80105e94:	80 
  for(i = 0; i < 256; i++)
...
80105e9f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ea2:	a1 0c b1 10 80       	mov    0x8010b10c,%eax
80105ea7:	c7 05 c2 52 11 80 08 	movl   $0xef000008,0x801152c2
80105eae:	00 00 ef 
  initlock(&tickslock, "time");
80105eb1:	68 65 7f 10 80       	push   $0x80107f65
80105eb6:	68 80 50 11 80       	push   $0x80115080
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ebb:	66 a3 c0 52 11 80    	mov    %ax,0x801152c0
80105ec1:	c1 e8 10             	shr    $0x10,%eax
80105ec4:	66 a3 c6 52 11 80    	mov    %ax,0x801152c6
  initlock(&tickslock, "time");
80105eca:	e8 a1 e9 ff ff       	call   80104870 <initlock>
}
...
80105eeb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105eef:	b8 c0 50 11 80       	mov    $0x801150c0,%eax
...
80105f19:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80105f1c:	8b 43 30             	mov    0x30(%ebx),%eax
80105f1f:	83 f8 40             	cmp    $0x40,%eax
80105f22:	0f 84 f0 01 00 00    	je     80106118 <trap+0x208>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105f2e:	0f 87 8c 00 00 00    	ja     80105fc0 <trap+0xb0>
80105f34:	ff 24 85 0c 80 10 80 	jmp    *-0x7fef7ff4(,%eax,4)
...
80105f3f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105f40:	e8 fb c2 ff ff       	call   80102240 <ideintr>
    lapiceoi();
...
80105f4a:	e8 91 da ff ff       	call   801039e0 <myproc>
80105f4f:	85 c0                	test   %eax,%eax
80105f51:	74 1d                	je     80105f70 <trap+0x60>
80105f53:	e8 88 da ff ff       	call   801039e0 <myproc>
80105f58:	8b 70 24             	mov    0x24(%eax),%esi
80105f5b:	85 f6                	test   %esi,%esi
80105f5d:	74 11                	je     80105f70 <trap+0x60>
80105f5f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105f63:	83 e0 03             	and    $0x3,%eax
80105f66:	66 83 f8 03          	cmp    $0x3,%ax
80105f6a:	0f 84 e0 01 00 00    	je     80106150 <trap+0x240>
    else exit();
  }
...
80105f77:	74 0f                	je     80105f88 <trap+0x78>
80105f79:	e8 62 da ff ff       	call   801039e0 <myproc>
80105f7e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105f82:	0f 84 b8 00 00 00    	je     80106040 <trap+0x130>
      // procdump();
      yield();
    }
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER){
80105f88:	e8 53 da ff ff       	call   801039e0 <myproc>
80105f8d:	85 c0                	test   %eax,%eax
80105f8f:	74 1d                	je     80105fae <trap+0x9e>
80105f91:	e8 4a da ff ff       	call   801039e0 <myproc>
80105f96:	8b 50 24             	mov    0x24(%eax),%edx
80105f99:	85 d2                	test   %edx,%edx
80105f9b:	74 11                	je     80105fae <trap+0x9e>
80105f9d:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105fa1:	83 e0 03             	and    $0x3,%eax
80105fa4:	66 83 f8 03          	cmp    $0x3,%ax
80105fa8:	0f 84 ca 01 00 00    	je     80106178 <trap+0x268>
    if (myproc()->created) thread_exit(0);
    else exit();
  }
...
80105fc0:	e8 1b da ff ff       	call   801039e0 <myproc>
80105fc5:	8b 7b 38             	mov    0x38(%ebx),%edi
80105fc8:	85 c0                	test   %eax,%eax
80105fca:	0f 84 ea 01 00 00    	je     801061ba <trap+0x2aa>
80105fd0:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105fd4:	0f 84 e0 01 00 00    	je     801061ba <trap+0x2aa>
...
80105fe0:	e8 db d9 ff ff       	call   801039c0 <cpuid>
80105fe5:	8b 73 30             	mov    0x30(%ebx),%esi
80105fe8:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105feb:	8b 43 34             	mov    0x34(%ebx),%eax
80105fee:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            myproc()->pid, myproc()->name, tf->trapno,
80105ff1:	e8 ea d9 ff ff       	call   801039e0 <myproc>
80105ff6:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105ff9:	e8 e2 d9 ff ff       	call   801039e0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ffe:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80106001:	8b 55 dc             	mov    -0x24(%ebp),%edx
80106004:	51                   	push   %ecx
80106005:	57                   	push   %edi
80106006:	52                   	push   %edx
80106007:	ff 75 e4             	push   -0x1c(%ebp)
8010600a:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
8010600b:	8b 75 e0             	mov    -0x20(%ebp),%esi
8010600e:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106011:	56                   	push   %esi
80106012:	ff 70 10             	push   0x10(%eax)
80106015:	68 c8 7f 10 80       	push   $0x80107fc8
8010601a:	e8 81 a6 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
8010601f:	83 c4 20             	add    $0x20,%esp
80106022:	e8 b9 d9 ff ff       	call   801039e0 <myproc>
80106027:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER){
8010602e:	e8 ad d9 ff ff       	call   801039e0 <myproc>
80106033:	85 c0                	test   %eax,%eax
80106035:	0f 85 18 ff ff ff    	jne    80105f53 <trap+0x43>
8010603b:	e9 30 ff ff ff       	jmp    80105f70 <trap+0x60>
  if(myproc() && myproc()->state == RUNNING &&
80106040:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80106044:	0f 85 3e ff ff ff    	jne    80105f88 <trap+0x78>
      yield();
8010604a:	e8 f1 df ff ff       	call   80104040 <yield>
8010604f:	e9 34 ff ff ff       	jmp    80105f88 <trap+0x78>
80106054:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106058:	8b 7b 38             	mov    0x38(%ebx),%edi
8010605b:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
8010605f:	e8 5c d9 ff ff       	call   801039c0 <cpuid>
80106064:	57                   	push   %edi
80106065:	56                   	push   %esi
80106066:	50                   	push   %eax
80106067:	68 70 7f 10 80       	push   $0x80107f70
8010606c:	e8 2f a6 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80106071:	e8 9a c8 ff ff       	call   80102910 <lapiceoi>
    break;
80106076:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER){
80106079:	e8 62 d9 ff ff       	call   801039e0 <myproc>
8010607e:	85 c0                	test   %eax,%eax
80106080:	0f 85 cd fe ff ff    	jne    80105f53 <trap+0x43>
80106086:	e9 e5 fe ff ff       	jmp    80105f70 <trap+0x60>
8010608b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010608f:	90                   	nop
    uartintr();
80106090:	e8 cb 02 00 00       	call   80106360 <uartintr>
    lapiceoi();
80106095:	e8 76 c8 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER){
8010609a:	e8 41 d9 ff ff       	call   801039e0 <myproc>
8010609f:	85 c0                	test   %eax,%eax
801060a1:	0f 85 ac fe ff ff    	jne    80105f53 <trap+0x43>
801060a7:	e9 c4 fe ff ff       	jmp    80105f70 <trap+0x60>
801060ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801060b0:	e8 1b c7 ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
801060b5:	e8 56 c8 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER){
801060ba:	e8 21 d9 ff ff       	call   801039e0 <myproc>
801060bf:	85 c0                	test   %eax,%eax
801060c1:	0f 85 8c fe ff ff    	jne    80105f53 <trap+0x43>
801060c7:	e9 a4 fe ff ff       	jmp    80105f70 <trap+0x60>
801060cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
801060d0:	e8 eb d8 ff ff       	call   801039c0 <cpuid>
801060d5:	85 c0                	test   %eax,%eax
801060d7:	0f 85 68 fe ff ff    	jne    80105f45 <trap+0x35>
      acquire(&tickslock);
801060dd:	83 ec 0c             	sub    $0xc,%esp
801060e0:	68 80 50 11 80       	push   $0x80115080
801060e5:	e8 56 e9 ff ff       	call   80104a40 <acquire>
      wakeup(&ticks);
801060ea:	c7 04 24 60 50 11 80 	movl   $0x80115060,(%esp)
      ticks++;
801060f1:	83 05 60 50 11 80 01 	addl   $0x1,0x80115060
      wakeup(&ticks);
801060f8:	e8 53 e0 ff ff       	call   80104150 <wakeup>
      release(&tickslock);
801060fd:	c7 04 24 80 50 11 80 	movl   $0x80115080,(%esp)
80106104:	e8 d7 e8 ff ff       	call   801049e0 <release>
80106109:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
8010610c:	e9 34 fe ff ff       	jmp    80105f45 <trap+0x35>
80106111:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80106118:	e8 c3 d8 ff ff       	call   801039e0 <myproc>
8010611d:	8b 40 24             	mov    0x24(%eax),%eax
80106120:	85 c0                	test   %eax,%eax
80106122:	75 7c                	jne    801061a0 <trap+0x290>
    myproc()->tf = tf;
80106124:	e8 b7 d8 ff ff       	call   801039e0 <myproc>
80106129:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
8010612c:	e8 cf ed ff ff       	call   80104f00 <syscall>
    if(myproc()->killed)
80106131:	e8 aa d8 ff ff       	call   801039e0 <myproc>
80106136:	8b 78 24             	mov    0x24(%eax),%edi
80106139:	85 ff                	test   %edi,%edi
8010613b:	0f 84 6d fe ff ff    	je     80105fae <trap+0x9e>
}
...
80106147:	5d                   	pop    %ebp
      exit();
80106148:	e9 b3 dc ff ff       	jmp    80103e00 <exit>
8010614d:	8d 76 00             	lea    0x0(%esi),%esi
    if (myproc()->created) thread_exit(0);
80106150:	e8 8b d8 ff ff       	call   801039e0 <myproc>
80106155:	8b 88 80 00 00 00    	mov    0x80(%eax),%ecx
8010615b:	85 c9                	test   %ecx,%ecx
8010615d:	74 51                	je     801061b0 <trap+0x2a0>
8010615f:	83 ec 0c             	sub    $0xc,%esp
80106162:	6a 00                	push   $0x0
80106164:	e8 37 e3 ff ff       	call   801044a0 <thread_exit>
80106169:	83 c4 10             	add    $0x10,%esp
8010616c:	e9 ff fd ff ff       	jmp    80105f70 <trap+0x60>
80106171:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if (myproc()->created) thread_exit(0);
80106178:	e8 63 d8 ff ff       	call   801039e0 <myproc>
8010617d:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80106183:	85 c0                	test   %eax,%eax
80106185:	74 ba                	je     80106141 <trap+0x231>
80106187:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
}
...
80106194:	5d                   	pop    %ebp
    if (myproc()->created) thread_exit(0);
80106195:	e9 06 e3 ff ff       	jmp    801044a0 <thread_exit>
8010619a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
801061a0:	e8 5b dc ff ff       	call   80103e00 <exit>
801061a5:	e9 7a ff ff ff       	jmp    80106124 <trap+0x214>
801061aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    else exit();
801061b0:	e8 4b dc ff ff       	call   80103e00 <exit>
801061b5:	e9 b6 fd ff ff       	jmp    80105f70 <trap+0x60>
801061ba:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801061bd:	e8 fe d7 ff ff       	call   801039c0 <cpuid>
801061c2:	83 ec 0c             	sub    $0xc,%esp
801061c5:	56                   	push   %esi
801061c6:	57                   	push   %edi
801061c7:	50                   	push   %eax
801061c8:	ff 73 30             	push   0x30(%ebx)
801061cb:	68 94 7f 10 80       	push   $0x80107f94
801061d0:	e8 cb a4 ff ff       	call   801006a0 <cprintf>
      panic("trap");
801061d5:	83 c4 14             	add    $0x14,%esp
801061d8:	68 6a 7f 10 80       	push   $0x80107f6a
801061dd:	e8 9e a1 ff ff       	call   80100380 <panic>
801061e2:	66 90                	xchg   %ax,%ax
801061e4:	66 90                	xchg   %ax,%ax
...
{
  if(!uart)
801061f0:	a1 c0 58 11 80       	mov    0x801158c0,%eax
801061f5:	85 c0                	test   %eax,%eax
801061f7:	74 17                	je     80106210 <uartgetc+0x20>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801061f9:	ba fd 03 00 00       	mov    $0x3fd,%edx
801061fe:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
801061ff:	a8 01                	test   $0x1,%al
80106201:	74 0d                	je     80106210 <uartgetc+0x20>
80106203:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106208:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80106209:	0f b6 c0             	movzbl %al,%eax
8010620c:	c3                   	ret    
...
80106277:	74 78                	je     801062f1 <uartinit+0xd1>
  uart = 1;
80106279:	c7 05 c0 58 11 80 01 	movl   $0x1,0x801158c0
80106280:	00 00 00 
80106283:	89 fa                	mov    %edi,%edx
...
8010628c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
8010628f:	bf 8c 80 10 80       	mov    $0x8010808c,%edi
80106294:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80106299:	6a 00                	push   $0x0
8010629b:	6a 04                	push   $0x4
8010629d:	e8 de c1 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
801062a2:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
801062a6:	83 c4 10             	add    $0x10,%esp
801062a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
801062b0:	a1 c0 58 11 80       	mov    0x801158c0,%eax
801062b5:	bb 80 00 00 00       	mov    $0x80,%ebx
801062ba:	85 c0                	test   %eax,%eax
801062bc:	75 14                	jne    801062d2 <uartinit+0xb2>
801062be:	eb 23                	jmp    801062e3 <uartinit+0xc3>
    microdelay(10);
801062c0:	83 ec 0c             	sub    $0xc,%esp
801062c3:	6a 0a                	push   $0xa
801062c5:	e8 66 c6 ff ff       	call   80102930 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801062ca:	83 c4 10             	add    $0x10,%esp
801062cd:	83 eb 01             	sub    $0x1,%ebx
801062d0:	74 07                	je     801062d9 <uartinit+0xb9>
801062d2:	89 f2                	mov    %esi,%edx
801062d4:	ec                   	in     (%dx),%al
801062d5:	a8 20                	test   $0x20,%al
801062d7:	74 e7                	je     801062c0 <uartinit+0xa0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801062d9:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
801062dd:	ba f8 03 00 00       	mov    $0x3f8,%edx
801062e2:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
801062e3:	0f b6 47 01          	movzbl 0x1(%edi),%eax
801062e7:	83 c7 01             	add    $0x1,%edi
801062ea:	88 45 e7             	mov    %al,-0x19(%ebp)
801062ed:	84 c0                	test   %al,%al
801062ef:	75 bf                	jne    801062b0 <uartinit+0x90>
}
...
80106300 <uartputc>:
  if(!uart)
80106300:	a1 c0 58 11 80       	mov    0x801158c0,%eax
80106305:	85 c0                	test   %eax,%eax
80106307:	74 47                	je     80106350 <uartputc+0x50>
{
...
80106313:	bb 80 00 00 00       	mov    $0x80,%ebx
80106318:	eb 18                	jmp    80106332 <uartputc+0x32>
...
80106330:	74 07                	je     80106339 <uartputc+0x39>
80106332:	89 f2                	mov    %esi,%edx
80106334:	ec                   	in     (%dx),%al
80106335:	a8 20                	test   $0x20,%al
80106337:	74 e7                	je     80106320 <uartputc+0x20>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106339:	8b 45 08             	mov    0x8(%ebp),%eax
8010633c:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106341:	ee                   	out    %al,(%dx)
}
80106342:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106345:	5b                   	pop    %ebx
80106346:	5e                   	pop    %esi
80106347:	5d                   	pop    %ebp
80106348:	c3                   	ret    
...
8010636b:	e8 10 a5 ff ff       	call   80100880 <consoleintr>
}
...
80106377:	6a 00                	push   $0x0
  jmp alltraps
80106379:	e9 b1 fa ff ff       	jmp    80105e2f <alltraps>
...
80106380:	6a 01                	push   $0x1
  jmp alltraps
80106382:	e9 a8 fa ff ff       	jmp    80105e2f <alltraps>
...
80106389:	6a 02                	push   $0x2
  jmp alltraps
8010638b:	e9 9f fa ff ff       	jmp    80105e2f <alltraps>
...
80106392:	6a 03                	push   $0x3
  jmp alltraps
80106394:	e9 96 fa ff ff       	jmp    80105e2f <alltraps>
...
8010639b:	6a 04                	push   $0x4
  jmp alltraps
8010639d:	e9 8d fa ff ff       	jmp    80105e2f <alltraps>
...
801063a4:	6a 05                	push   $0x5
  jmp alltraps
801063a6:	e9 84 fa ff ff       	jmp    80105e2f <alltraps>
...
801063c6:	6a 09                	push   $0x9
  jmp alltraps
801063c8:	e9 62 fa ff ff       	jmp    80105e2f <alltraps>
...
801063cd:	6a 0a                	push   $0xa
  jmp alltraps
801063cf:	e9 5b fa ff ff       	jmp    80105e2f <alltraps>
...
801063d4:	6a 0b                	push   $0xb
  jmp alltraps
801063d6:	e9 54 fa ff ff       	jmp    80105e2f <alltraps>
...
801063db:	6a 0c                	push   $0xc
  jmp alltraps
801063dd:	e9 4d fa ff ff       	jmp    80105e2f <alltraps>
...
801063e9:	6a 0e                	push   $0xe
  jmp alltraps
801063eb:	e9 3f fa ff ff       	jmp    80105e2f <alltraps>
...
80106402:	6a 11                	push   $0x11
  jmp alltraps
80106404:	e9 26 fa ff ff       	jmp    80105e2f <alltraps>
...
8010640b:	6a 12                	push   $0x12
  jmp alltraps
8010640d:	e9 1d fa ff ff       	jmp    80105e2f <alltraps>
...
80106414:	6a 13                	push   $0x13
  jmp alltraps
80106416:	e9 14 fa ff ff       	jmp    80105e2f <alltraps>
...
8010641d:	6a 14                	push   $0x14
  jmp alltraps
8010641f:	e9 0b fa ff ff       	jmp    80105e2f <alltraps>
...
80106426:	6a 15                	push   $0x15
  jmp alltraps
80106428:	e9 02 fa ff ff       	jmp    80105e2f <alltraps>
...
8010642f:	6a 16                	push   $0x16
  jmp alltraps
80106431:	e9 f9 f9 ff ff       	jmp    80105e2f <alltraps>
...
80106438:	6a 17                	push   $0x17
  jmp alltraps
8010643a:	e9 f0 f9 ff ff       	jmp    80105e2f <alltraps>
...
80106441:	6a 18                	push   $0x18
  jmp alltraps
80106443:	e9 e7 f9 ff ff       	jmp    80105e2f <alltraps>
...
8010644a:	6a 19                	push   $0x19
  jmp alltraps
8010644c:	e9 de f9 ff ff       	jmp    80105e2f <alltraps>
...
80106453:	6a 1a                	push   $0x1a
  jmp alltraps
80106455:	e9 d5 f9 ff ff       	jmp    80105e2f <alltraps>
...
8010645c:	6a 1b                	push   $0x1b
  jmp alltraps
8010645e:	e9 cc f9 ff ff       	jmp    80105e2f <alltraps>
...
80106465:	6a 1c                	push   $0x1c
  jmp alltraps
80106467:	e9 c3 f9 ff ff       	jmp    80105e2f <alltraps>
...
8010646e:	6a 1d                	push   $0x1d
  jmp alltraps
80106470:	e9 ba f9 ff ff       	jmp    80105e2f <alltraps>
...
80106477:	6a 1e                	push   $0x1e
  jmp alltraps
80106479:	e9 b1 f9 ff ff       	jmp    80105e2f <alltraps>
...
80106480:	6a 1f                	push   $0x1f
  jmp alltraps
80106482:	e9 a8 f9 ff ff       	jmp    80105e2f <alltraps>
...
80106489:	6a 20                	push   $0x20
  jmp alltraps
8010648b:	e9 9f f9 ff ff       	jmp    80105e2f <alltraps>
...
80106492:	6a 21                	push   $0x21
  jmp alltraps
80106494:	e9 96 f9 ff ff       	jmp    80105e2f <alltraps>
...
8010649b:	6a 22                	push   $0x22
  jmp alltraps
8010649d:	e9 8d f9 ff ff       	jmp    80105e2f <alltraps>
...
801064a4:	6a 23                	push   $0x23
  jmp alltraps
801064a6:	e9 84 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064b6:	6a 25                	push   $0x25
  jmp alltraps
801064b8:	e9 72 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064bf:	6a 26                	push   $0x26
  jmp alltraps
801064c1:	e9 69 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064c8:	6a 27                	push   $0x27
  jmp alltraps
801064ca:	e9 60 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064d1:	6a 28                	push   $0x28
  jmp alltraps
801064d3:	e9 57 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064da:	6a 29                	push   $0x29
  jmp alltraps
801064dc:	e9 4e f9 ff ff       	jmp    80105e2f <alltraps>
...
801064e3:	6a 2a                	push   $0x2a
  jmp alltraps
801064e5:	e9 45 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064ec:	6a 2b                	push   $0x2b
  jmp alltraps
801064ee:	e9 3c f9 ff ff       	jmp    80105e2f <alltraps>
...
801064f5:	6a 2c                	push   $0x2c
  jmp alltraps
801064f7:	e9 33 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064fe:	6a 2d                	push   $0x2d
  jmp alltraps
80106500:	e9 2a f9 ff ff       	jmp    80105e2f <alltraps>
...
80106507:	6a 2e                	push   $0x2e
  jmp alltraps
80106509:	e9 21 f9 ff ff       	jmp    80105e2f <alltraps>
...
80106510:	6a 2f                	push   $0x2f
  jmp alltraps
80106512:	e9 18 f9 ff ff       	jmp    80105e2f <alltraps>
...
80106519:	6a 30                	push   $0x30
  jmp alltraps
8010651b:	e9 0f f9 ff ff       	jmp    80105e2f <alltraps>
...
80106522:	6a 31                	push   $0x31
  jmp alltraps
80106524:	e9 06 f9 ff ff       	jmp    80105e2f <alltraps>
...
8010652b:	6a 32                	push   $0x32
  jmp alltraps
8010652d:	e9 fd f8 ff ff       	jmp    80105e2f <alltraps>
...
80106534:	6a 33                	push   $0x33
  jmp alltraps
80106536:	e9 f4 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010653d:	6a 34                	push   $0x34
  jmp alltraps
8010653f:	e9 eb f8 ff ff       	jmp    80105e2f <alltraps>
...
80106546:	6a 35                	push   $0x35
  jmp alltraps
80106548:	e9 e2 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010654f:	6a 36                	push   $0x36
  jmp alltraps
80106551:	e9 d9 f8 ff ff       	jmp    80105e2f <alltraps>
...
80106558:	6a 37                	push   $0x37
  jmp alltraps
8010655a:	e9 d0 f8 ff ff       	jmp    80105e2f <alltraps>
...
80106561:	6a 38                	push   $0x38
  jmp alltraps
80106563:	e9 c7 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010656a:	6a 39                	push   $0x39
  jmp alltraps
8010656c:	e9 be f8 ff ff       	jmp    80105e2f <alltraps>
...
80106573:	6a 3a                	push   $0x3a
  jmp alltraps
80106575:	e9 b5 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010657c:	6a 3b                	push   $0x3b
  jmp alltraps
8010657e:	e9 ac f8 ff ff       	jmp    80105e2f <alltraps>
...
80106585:	6a 3c                	push   $0x3c
  jmp alltraps
80106587:	e9 a3 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010658e:	6a 3d                	push   $0x3d
  jmp alltraps
80106590:	e9 9a f8 ff ff       	jmp    80105e2f <alltraps>
...
80106597:	6a 3e                	push   $0x3e
  jmp alltraps
80106599:	e9 91 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065a0:	6a 3f                	push   $0x3f
  jmp alltraps
801065a2:	e9 88 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065a9:	6a 40                	push   $0x40
  jmp alltraps
801065ab:	e9 7f f8 ff ff       	jmp    80105e2f <alltraps>
...
801065b2:	6a 41                	push   $0x41
  jmp alltraps
801065b4:	e9 76 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065bb:	6a 42                	push   $0x42
  jmp alltraps
801065bd:	e9 6d f8 ff ff       	jmp    80105e2f <alltraps>
...
801065c4:	6a 43                	push   $0x43
  jmp alltraps
801065c6:	e9 64 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065cd:	6a 44                	push   $0x44
  jmp alltraps
801065cf:	e9 5b f8 ff ff       	jmp    80105e2f <alltraps>
...
801065d6:	6a 45                	push   $0x45
  jmp alltraps
801065d8:	e9 52 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065df:	6a 46                	push   $0x46
  jmp alltraps
801065e1:	e9 49 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065e8:	6a 47                	push   $0x47
  jmp alltraps
801065ea:	e9 40 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065f1:	6a 48                	push   $0x48
  jmp alltraps
801065f3:	e9 37 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065fa:	6a 49                	push   $0x49
  jmp alltraps
801065fc:	e9 2e f8 ff ff       	jmp    80105e2f <alltraps>
...
80106603:	6a 4a                	push   $0x4a
  jmp alltraps
80106605:	e9 25 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010660c:	6a 4b                	push   $0x4b
  jmp alltraps
8010660e:	e9 1c f8 ff ff       	jmp    80105e2f <alltraps>
...
80106615:	6a 4c                	push   $0x4c
  jmp alltraps
80106617:	e9 13 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010661e:	6a 4d                	push   $0x4d
  jmp alltraps
80106620:	e9 0a f8 ff ff       	jmp    80105e2f <alltraps>
...
80106627:	6a 4e                	push   $0x4e
  jmp alltraps
80106629:	e9 01 f8 ff ff       	jmp    80105e2f <alltraps>
...
80106630:	6a 4f                	push   $0x4f
  jmp alltraps
80106632:	e9 f8 f7 ff ff       	jmp    80105e2f <alltraps>
...
80106639:	6a 50                	push   $0x50
  jmp alltraps
8010663b:	e9 ef f7 ff ff       	jmp    80105e2f <alltraps>
...
80106642:	6a 51                	push   $0x51
  jmp alltraps
80106644:	e9 e6 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010664b:	6a 52                	push   $0x52
  jmp alltraps
8010664d:	e9 dd f7 ff ff       	jmp    80105e2f <alltraps>
...
80106654:	6a 53                	push   $0x53
  jmp alltraps
80106656:	e9 d4 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010665d:	6a 54                	push   $0x54
  jmp alltraps
8010665f:	e9 cb f7 ff ff       	jmp    80105e2f <alltraps>
...
80106666:	6a 55                	push   $0x55
  jmp alltraps
80106668:	e9 c2 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010666f:	6a 56                	push   $0x56
  jmp alltraps
80106671:	e9 b9 f7 ff ff       	jmp    80105e2f <alltraps>
...
80106678:	6a 57                	push   $0x57
  jmp alltraps
8010667a:	e9 b0 f7 ff ff       	jmp    80105e2f <alltraps>
...
80106681:	6a 58                	push   $0x58
  jmp alltraps
80106683:	e9 a7 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010668a:	6a 59                	push   $0x59
  jmp alltraps
8010668c:	e9 9e f7 ff ff       	jmp    80105e2f <alltraps>
...
80106693:	6a 5a                	push   $0x5a
  jmp alltraps
80106695:	e9 95 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010669c:	6a 5b                	push   $0x5b
  jmp alltraps
8010669e:	e9 8c f7 ff ff       	jmp    80105e2f <alltraps>
...
801066a5:	6a 5c                	push   $0x5c
  jmp alltraps
801066a7:	e9 83 f7 ff ff       	jmp    80105e2f <alltraps>
...
801066ae:	6a 5d                	push   $0x5d
  jmp alltraps
801066b0:	e9 7a f7 ff ff       	jmp    80105e2f <alltraps>
...
801066b7:	6a 5e                	push   $0x5e
  jmp alltraps
801066b9:	e9 71 f7 ff ff       	jmp    80105e2f <alltraps>
...
801066c0:	6a 5f                	push   $0x5f
  jmp alltraps
801066c2:	e9 68 f7 ff ff       	jmp    80105e2f <alltraps>
...
801066c9:	6a 60                	push   $0x60
  jmp alltraps
801066cb:	e9 5f f7 ff ff       	jmp    80105e2f <alltraps>
...
801066d2:	6a 61                	push   $0x61
  jmp alltraps
801066d4:	e9 56 f7 ff ff       	jmp    80105e2f <alltraps>
...
801066db:	6a 62                	push   $0x62
  jmp alltraps
801066dd:	e9 4d f7 ff ff       	jmp    80105e2f <alltraps>
...
801066e4:	6a 63                	push   $0x63
  jmp alltraps
801066e6:	e9 44 f7 ff ff       	jmp    80105e2f <alltraps>
...
801066ed:	6a 64                	push   $0x64
  jmp alltraps
801066ef:	e9 3b f7 ff ff       	jmp    80105e2f <alltraps>
...
801066f6:	6a 65                	push   $0x65
  jmp alltraps
801066f8:	e9 32 f7 ff ff       	jmp    80105e2f <alltraps>
...
801066ff:	6a 66                	push   $0x66
  jmp alltraps
80106701:	e9 29 f7 ff ff       	jmp    80105e2f <alltraps>
...
80106708:	6a 67                	push   $0x67
  jmp alltraps
8010670a:	e9 20 f7 ff ff       	jmp    80105e2f <alltraps>
...
80106711:	6a 68                	push   $0x68
  jmp alltraps
80106713:	e9 17 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010671a:	6a 69                	push   $0x69
  jmp alltraps
8010671c:	e9 0e f7 ff ff       	jmp    80105e2f <alltraps>
...
80106723:	6a 6a                	push   $0x6a
  jmp alltraps
80106725:	e9 05 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010672c:	6a 6b                	push   $0x6b
  jmp alltraps
8010672e:	e9 fc f6 ff ff       	jmp    80105e2f <alltraps>
...
80106735:	6a 6c                	push   $0x6c
  jmp alltraps
80106737:	e9 f3 f6 ff ff       	jmp    80105e2f <alltraps>
...
8010673e:	6a 6d                	push   $0x6d
  jmp alltraps
80106740:	e9 ea f6 ff ff       	jmp    80105e2f <alltraps>
...
80106747:	6a 6e                	push   $0x6e
  jmp alltraps
80106749:	e9 e1 f6 ff ff       	jmp    80105e2f <alltraps>
...
80106750:	6a 6f                	push   $0x6f
  jmp alltraps
80106752:	e9 d8 f6 ff ff       	jmp    80105e2f <alltraps>
...
80106759:	6a 70                	push   $0x70
  jmp alltraps
8010675b:	e9 cf f6 ff ff       	jmp    80105e2f <alltraps>
...
80106762:	6a 71                	push   $0x71
  jmp alltraps
80106764:	e9 c6 f6 ff ff       	jmp    80105e2f <alltraps>
...
8010676b:	6a 72                	push   $0x72
  jmp alltraps
8010676d:	e9 bd f6 ff ff       	jmp    80105e2f <alltraps>
...
80106774:	6a 73                	push   $0x73
  jmp alltraps
80106776:	e9 b4 f6 ff ff       	jmp    80105e2f <alltraps>
...
8010677d:	6a 74                	push   $0x74
  jmp alltraps
8010677f:	e9 ab f6 ff ff       	jmp    80105e2f <alltraps>
...
80106786:	6a 75                	push   $0x75
  jmp alltraps
80106788:	e9 a2 f6 ff ff       	jmp    80105e2f <alltraps>
...
8010678f:	6a 76                	push   $0x76
  jmp alltraps
80106791:	e9 99 f6 ff ff       	jmp    80105e2f <alltraps>
...
80106798:	6a 77                	push   $0x77
  jmp alltraps
8010679a:	e9 90 f6 ff ff       	jmp    80105e2f <alltraps>
...
801067a1:	6a 78                	push   $0x78
  jmp alltraps
801067a3:	e9 87 f6 ff ff       	jmp    80105e2f <alltraps>
...
801067aa:	6a 79                	push   $0x79
  jmp alltraps
801067ac:	e9 7e f6 ff ff       	jmp    80105e2f <alltraps>
...
801067b3:	6a 7a                	push   $0x7a
  jmp alltraps
801067b5:	e9 75 f6 ff ff       	jmp    80105e2f <alltraps>
...
801067bc:	6a 7b                	push   $0x7b
  jmp alltraps
801067be:	e9 6c f6 ff ff       	jmp    80105e2f <alltraps>
...
801067c5:	6a 7c                	push   $0x7c
  jmp alltraps
801067c7:	e9 63 f6 ff ff       	jmp    80105e2f <alltraps>
...
801067ce:	6a 7d                	push   $0x7d
  jmp alltraps
801067d0:	e9 5a f6 ff ff       	jmp    80105e2f <alltraps>
...
801067d7:	6a 7e                	push   $0x7e
  jmp alltraps
801067d9:	e9 51 f6 ff ff       	jmp    80105e2f <alltraps>
...
801067e0:	6a 7f                	push   $0x7f
  jmp alltraps
801067e2:	e9 48 f6 ff ff       	jmp    80105e2f <alltraps>
...
801067e9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801067ee:	e9 3c f6 ff ff       	jmp    80105e2f <alltraps>
...
801067f5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801067fa:	e9 30 f6 ff ff       	jmp    80105e2f <alltraps>
...
80106801:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106806:	e9 24 f6 ff ff       	jmp    80105e2f <alltraps>
...
8010680d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106812:	e9 18 f6 ff ff       	jmp    80105e2f <alltraps>
...
80106819:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010681e:	e9 0c f6 ff ff       	jmp    80105e2f <alltraps>
...
80106825:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010682a:	e9 00 f6 ff ff       	jmp    80105e2f <alltraps>
...
80106831:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106836:	e9 f4 f5 ff ff       	jmp    80105e2f <alltraps>
...
8010683d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106842:	e9 e8 f5 ff ff       	jmp    80105e2f <alltraps>
...
80106849:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010684e:	e9 dc f5 ff ff       	jmp    80105e2f <alltraps>
...
80106855:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010685a:	e9 d0 f5 ff ff       	jmp    80105e2f <alltraps>
...
80106861:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106866:	e9 c4 f5 ff ff       	jmp    80105e2f <alltraps>
...
8010686d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106872:	e9 b8 f5 ff ff       	jmp    80105e2f <alltraps>
...
80106879:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010687e:	e9 ac f5 ff ff       	jmp    80105e2f <alltraps>
...
80106885:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010688a:	e9 a0 f5 ff ff       	jmp    80105e2f <alltraps>
...
80106891:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106896:	e9 94 f5 ff ff       	jmp    80105e2f <alltraps>
...
8010689d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801068a2:	e9 88 f5 ff ff       	jmp    80105e2f <alltraps>
...
801068a9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801068ae:	e9 7c f5 ff ff       	jmp    80105e2f <alltraps>
...
801068b5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801068ba:	e9 70 f5 ff ff       	jmp    80105e2f <alltraps>
...
801068c1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801068c6:	e9 64 f5 ff ff       	jmp    80105e2f <alltraps>
...
801068cd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801068d2:	e9 58 f5 ff ff       	jmp    80105e2f <alltraps>
...
801068d9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801068de:	e9 4c f5 ff ff       	jmp    80105e2f <alltraps>
...
801068e5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801068ea:	e9 40 f5 ff ff       	jmp    80105e2f <alltraps>
...
801068f1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801068f6:	e9 34 f5 ff ff       	jmp    80105e2f <alltraps>
...
801068fd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106902:	e9 28 f5 ff ff       	jmp    80105e2f <alltraps>
...
80106909:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010690e:	e9 1c f5 ff ff       	jmp    80105e2f <alltraps>
...
80106915:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010691a:	e9 10 f5 ff ff       	jmp    80105e2f <alltraps>
...
80106921:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106926:	e9 04 f5 ff ff       	jmp    80105e2f <alltraps>
...
8010692d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106932:	e9 f8 f4 ff ff       	jmp    80105e2f <alltraps>
...
80106939:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010693e:	e9 ec f4 ff ff       	jmp    80105e2f <alltraps>
...
80106945:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010694a:	e9 e0 f4 ff ff       	jmp    80105e2f <alltraps>
...
80106951:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106956:	e9 d4 f4 ff ff       	jmp    80105e2f <alltraps>
...
8010695d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106962:	e9 c8 f4 ff ff       	jmp    80105e2f <alltraps>
...
80106969:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010696e:	e9 bc f4 ff ff       	jmp    80105e2f <alltraps>
...
80106975:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010697a:	e9 b0 f4 ff ff       	jmp    80105e2f <alltraps>
...
80106981:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106986:	e9 a4 f4 ff ff       	jmp    80105e2f <alltraps>
...
8010698d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106992:	e9 98 f4 ff ff       	jmp    80105e2f <alltraps>
...
80106999:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010699e:	e9 8c f4 ff ff       	jmp    80105e2f <alltraps>
...
801069a5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801069aa:	e9 80 f4 ff ff       	jmp    80105e2f <alltraps>
...
801069b1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801069b6:	e9 74 f4 ff ff       	jmp    80105e2f <alltraps>
...
801069bd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801069c2:	e9 68 f4 ff ff       	jmp    80105e2f <alltraps>
...
801069c9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801069ce:	e9 5c f4 ff ff       	jmp    80105e2f <alltraps>
...
801069d5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801069da:	e9 50 f4 ff ff       	jmp    80105e2f <alltraps>
...
801069e1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801069e6:	e9 44 f4 ff ff       	jmp    80105e2f <alltraps>
...
801069ed:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801069f2:	e9 38 f4 ff ff       	jmp    80105e2f <alltraps>
...
801069f9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801069fe:	e9 2c f4 ff ff       	jmp    80105e2f <alltraps>
...
80106a05:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106a0a:	e9 20 f4 ff ff       	jmp    80105e2f <alltraps>
...
80106a11:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106a16:	e9 14 f4 ff ff       	jmp    80105e2f <alltraps>
...
80106a1d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106a22:	e9 08 f4 ff ff       	jmp    80105e2f <alltraps>
...
80106a29:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106a2e:	e9 fc f3 ff ff       	jmp    80105e2f <alltraps>
...
80106a35:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106a3a:	e9 f0 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106a41:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106a46:	e9 e4 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106a4d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106a52:	e9 d8 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106a59:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106a5e:	e9 cc f3 ff ff       	jmp    80105e2f <alltraps>
...
80106a65:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106a6a:	e9 c0 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106a71:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106a76:	e9 b4 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106a7d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106a82:	e9 a8 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106a89:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106a8e:	e9 9c f3 ff ff       	jmp    80105e2f <alltraps>
...
80106a95:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106a9a:	e9 90 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106aa1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106aa6:	e9 84 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106aad:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106ab2:	e9 78 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106ab9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106abe:	e9 6c f3 ff ff       	jmp    80105e2f <alltraps>
...
80106ac5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106aca:	e9 60 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106ad1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106ad6:	e9 54 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106add:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106ae2:	e9 48 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106ae9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106aee:	e9 3c f3 ff ff       	jmp    80105e2f <alltraps>
...
80106af5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106afa:	e9 30 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106b01:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106b06:	e9 24 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106b0d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106b12:	e9 18 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106b19:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106b1e:	e9 0c f3 ff ff       	jmp    80105e2f <alltraps>
...
80106b25:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106b2a:	e9 00 f3 ff ff       	jmp    80105e2f <alltraps>
...
80106b31:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106b36:	e9 f4 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106b3d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106b42:	e9 e8 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106b49:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106b4e:	e9 dc f2 ff ff       	jmp    80105e2f <alltraps>
...
80106b55:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106b5a:	e9 d0 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106b61:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106b66:	e9 c4 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106b6d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106b72:	e9 b8 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106b79:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106b7e:	e9 ac f2 ff ff       	jmp    80105e2f <alltraps>
...
80106b85:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106b8a:	e9 a0 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106b91:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106b96:	e9 94 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106b9d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106ba2:	e9 88 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106ba9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106bae:	e9 7c f2 ff ff       	jmp    80105e2f <alltraps>
...
80106bb5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106bba:	e9 70 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106bc1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106bc6:	e9 64 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106bcd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106bd2:	e9 58 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106bd9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106bde:	e9 4c f2 ff ff       	jmp    80105e2f <alltraps>
...
80106be5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106bea:	e9 40 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106bf1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106bf6:	e9 34 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106bfd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106c02:	e9 28 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106c09:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106c0e:	e9 1c f2 ff ff       	jmp    80105e2f <alltraps>
...
80106c15:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106c1a:	e9 10 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106c21:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106c26:	e9 04 f2 ff ff       	jmp    80105e2f <alltraps>
...
80106c2d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106c32:	e9 f8 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106c39:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106c3e:	e9 ec f1 ff ff       	jmp    80105e2f <alltraps>
...
80106c45:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106c4a:	e9 e0 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106c51:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106c56:	e9 d4 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106c5d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106c62:	e9 c8 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106c69:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106c6e:	e9 bc f1 ff ff       	jmp    80105e2f <alltraps>
...
80106c75:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106c7a:	e9 b0 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106c81:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106c86:	e9 a4 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106c8d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106c92:	e9 98 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106c99:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106c9e:	e9 8c f1 ff ff       	jmp    80105e2f <alltraps>
...
80106ca5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106caa:	e9 80 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106cb1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106cb6:	e9 74 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106cbd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106cc2:	e9 68 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106cc9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106cce:	e9 5c f1 ff ff       	jmp    80105e2f <alltraps>
...
80106cd5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106cda:	e9 50 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106ce1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106ce6:	e9 44 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106ced:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106cf2:	e9 38 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106cf9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106cfe:	e9 2c f1 ff ff       	jmp    80105e2f <alltraps>
...
80106d05:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106d0a:	e9 20 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106d11:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106d16:	e9 14 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106d1d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106d22:	e9 08 f1 ff ff       	jmp    80105e2f <alltraps>
...
80106d29:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106d2e:	e9 fc f0 ff ff       	jmp    80105e2f <alltraps>
...
80106d35:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106d3a:	e9 f0 f0 ff ff       	jmp    80105e2f <alltraps>
...
80106d41:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106d46:	e9 e4 f0 ff ff       	jmp    80105e2f <alltraps>
...
80106d4d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106d52:	e9 d8 f0 ff ff       	jmp    80105e2f <alltraps>
...
80106d59:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106d5e:	e9 cc f0 ff ff       	jmp    80105e2f <alltraps>
...
80106d65:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106d6a:	e9 c0 f0 ff ff       	jmp    80105e2f <alltraps>
...
80106d71:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106d76:	e9 b4 f0 ff ff       	jmp    80105e2f <alltraps>
...
80106d7d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106d82:	e9 a8 f0 ff ff       	jmp    80105e2f <alltraps>
...
80106d89:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106d8e:	e9 9c f0 ff ff       	jmp    80105e2f <alltraps>
...
80106d95:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106d9a:	e9 90 f0 ff ff       	jmp    80105e2f <alltraps>
...
80106da1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106da6:	e9 84 f0 ff ff       	jmp    80105e2f <alltraps>
...
80106dad:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106db2:	e9 78 f0 ff ff       	jmp    80105e2f <alltraps>
...
80106db9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106dbe:	e9 6c f0 ff ff       	jmp    80105e2f <alltraps>
...
80106dc5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106dca:	e9 60 f0 ff ff       	jmp    80105e2f <alltraps>
...
80106dd1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106dd6:	e9 54 f0 ff ff       	jmp    80105e2f <alltraps>
...
80106ddd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106de2:	e9 48 f0 ff ff       	jmp    80105e2f <alltraps>
...
80106dfc:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106e02:	83 ec 1c             	sub    $0x1c,%esp
80106e05:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106e08:	39 d3                	cmp    %edx,%ebx
80106e0a:	73 49                	jae    80106e55 <deallocuvm.part.0+0x65>
80106e0c:	89 c7                	mov    %eax,%edi
80106e0e:	eb 0c                	jmp    80106e1c <deallocuvm.part.0+0x2c>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106e10:	83 c0 01             	add    $0x1,%eax
80106e13:	c1 e0 16             	shl    $0x16,%eax
80106e16:	89 c3                	mov    %eax,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106e18:	39 da                	cmp    %ebx,%edx
80106e1a:	76 39                	jbe    80106e55 <deallocuvm.part.0+0x65>
  pde = &pgdir[PDX(va)];
80106e1c:	89 d8                	mov    %ebx,%eax
80106e1e:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80106e21:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
80106e24:	f6 c1 01             	test   $0x1,%cl
80106e27:	74 e7                	je     80106e10 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
80106e29:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106e2b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80106e31:	c1 ee 0a             	shr    $0xa,%esi
80106e34:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
80106e3a:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
    if(!pte)
80106e41:	85 f6                	test   %esi,%esi
80106e43:	74 cb                	je     80106e10 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
80106e45:	8b 06                	mov    (%esi),%eax
80106e47:	a8 01                	test   $0x1,%al
80106e49:	75 15                	jne    80106e60 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
80106e4b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106e51:	39 da                	cmp    %ebx,%edx
80106e53:	77 c7                	ja     80106e1c <deallocuvm.part.0+0x2c>
      kfree(v);
      *pte = 0;
    }
  }
...
80106e55:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106e65:	74 25                	je     80106e8c <deallocuvm.part.0+0x9c>
      kfree(v);
80106e67:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106e6a:	05 00 00 00 80       	add    $0x80000000,%eax
80106e6f:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106e72:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80106e78:	50                   	push   %eax
80106e79:	e8 42 b6 ff ff       	call   801024c0 <kfree>
      *pte = 0;
80106e7e:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  for(; a  < oldsz; a += PGSIZE){
80106e84:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106e87:	83 c4 10             	add    $0x10,%esp
80106e8a:	eb 8c                	jmp    80106e18 <deallocuvm.part.0+0x28>
        panic("kfree");
80106e8c:	83 ec 0c             	sub    $0xc,%esp
80106e8f:	68 46 7a 10 80       	push   $0x80107a46
...
80106ec5:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106ec8:	eb 3d                	jmp    80106f07 <mappages+0x67>
...
80106efa:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106efc:	3b 5d dc             	cmp    -0x24(%ebp),%ebx
80106eff:	74 6f                	je     80106f70 <mappages+0xd0>
    a += PGSIZE;
80106f01:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80106f07:	8b 45 e0             	mov    -0x20(%ebp),%eax
  pde = &pgdir[PDX(va)];
80106f0a:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106f0d:	8d 34 18             	lea    (%eax,%ebx,1),%esi
80106f10:	89 d8                	mov    %ebx,%eax
80106f12:	c1 e8 16             	shr    $0x16,%eax
80106f15:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
80106f18:	8b 07                	mov    (%edi),%eax
80106f1a:	a8 01                	test   $0x1,%al
80106f1c:	75 b2                	jne    80106ed0 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80106f1e:	e8 5d b7 ff ff       	call   80102680 <kalloc>
80106f23:	85 c0                	test   %eax,%eax
80106f25:	74 39                	je     80106f60 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80106f27:	83 ec 04             	sub    $0x4,%esp
80106f2a:	89 45 d8             	mov    %eax,-0x28(%ebp)
80106f2d:	68 00 10 00 00       	push   $0x1000
80106f32:	6a 00                	push   $0x0
80106f34:	50                   	push   %eax
80106f35:	e8 c6 db ff ff       	call   80104b00 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106f3a:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
80106f3d:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106f40:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80106f46:	83 c8 07             	or     $0x7,%eax
80106f49:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
80106f4b:	89 d8                	mov    %ebx,%eax
80106f4d:	c1 e8 0a             	shr    $0xa,%eax
80106f50:	25 fc 0f 00 00       	and    $0xffc,%eax
80106f55:	01 d0                	add    %edx,%eax
80106f57:	eb 92                	jmp    80106eeb <mappages+0x4b>
...
80106f7d:	68 94 80 10 80       	push   $0x80108094
80106f82:	e8 f9 93 ff ff       	call   80100380 <panic>
...
80106f93:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106f96:	e8 25 ca ff ff       	call   801039c0 <cpuid>
  pd[0] = size-1;
...
80106faa:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80106fb1:	ff 00 00 
80106fb4:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
80106fbb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106fbe:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
80106fc5:	ff 00 00 
80106fc8:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
80106fcf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106fd2:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
80106fd9:	ff 00 00 
80106fdc:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
80106fe3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106fe6:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
80106fed:	ff 00 00 
80106ff0:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
80106ff7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106ffa:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
80107020:	a1 c4 58 11 80       	mov    0x801158c4,%eax
...
8010703e:	0f 84 cb 00 00 00    	je     8010710f <switchuvm+0xdf>
  if(p->kstack == 0)
80107044:	8b 46 08             	mov    0x8(%esi),%eax
80107047:	85 c0                	test   %eax,%eax
80107049:	0f 84 da 00 00 00    	je     80107129 <switchuvm+0xf9>
  if(p->pgdir == 0)
8010704f:	8b 46 04             	mov    0x4(%esi),%eax
80107052:	85 c0                	test   %eax,%eax
80107054:	0f 84 c2 00 00 00    	je     8010711c <switchuvm+0xec>
  pushcli();
8010705a:	e8 91 d8 ff ff       	call   801048f0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010705f:	e8 fc c8 ff ff       	call   80103960 <mycpu>
80107064:	89 c3                	mov    %eax,%ebx
80107066:	e8 f5 c8 ff ff       	call   80103960 <mycpu>
8010706b:	89 c7                	mov    %eax,%edi
8010706d:	e8 ee c8 ff ff       	call   80103960 <mycpu>
80107072:	83 c7 08             	add    $0x8,%edi
80107075:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107078:	e8 e3 c8 ff ff       	call   80103960 <mycpu>
...
8010714f:	8b 7d 08             	mov    0x8(%ebp),%edi
80107152:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80107155:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
8010715b:	77 4b                	ja     801071a8 <inituvm+0x68>
  mem = kalloc();
8010715d:	e8 1e b5 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
8010716f:	e8 8c d9 ff ff       	call   80104b00 <memset>
...
80107188:	e8 13 fd ff ff       	call   80106ea0 <mappages>
  memmove(mem, init, sz);
8010718d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107190:	89 75 10             	mov    %esi,0x10(%ebp)
80107193:	83 c4 10             	add    $0x10,%esp
80107196:	89 5d 08             	mov    %ebx,0x8(%ebp)
80107199:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
801071a2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801071a3:	e9 f8 d9 ff ff       	jmp    80104ba0 <memmove>
    panic("inituvm: more than a page");
801071a8:	83 ec 0c             	sub    $0xc,%esp
801071ab:	68 d9 80 10 80       	push   $0x801080d9
801071b0:	e8 cb 91 ff ff       	call   80100380 <panic>
801071b5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801071cc:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
801071cf:	a9 ff 0f 00 00       	test   $0xfff,%eax
801071d4:	0f 85 bb 00 00 00    	jne    80107295 <loaduvm+0xd5>
  for(i = 0; i < sz; i += PGSIZE){
801071da:	01 f0                	add    %esi,%eax
801071dc:	89 f3                	mov    %esi,%ebx
801071de:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
801071e1:	8b 45 14             	mov    0x14(%ebp),%eax
801071e4:	01 f0                	add    %esi,%eax
801071e6:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
801071e9:	85 f6                	test   %esi,%esi
801071eb:	0f 84 87 00 00 00    	je     80107278 <loaduvm+0xb8>
801071f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
801071f8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  if(*pde & PTE_P){
801071fb:	8b 4d 08             	mov    0x8(%ebp),%ecx
801071fe:	29 d8                	sub    %ebx,%eax
  pde = &pgdir[PDX(va)];
80107200:	89 c2                	mov    %eax,%edx
80107202:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80107205:	8b 14 91             	mov    (%ecx,%edx,4),%edx
80107208:	f6 c2 01             	test   $0x1,%dl
8010720b:	75 13                	jne    80107220 <loaduvm+0x60>
      panic("loaduvm: address should exist");
8010720d:	83 ec 0c             	sub    $0xc,%esp
80107210:	68 f3 80 10 80       	push   $0x801080f3
...
80107237:	74 d4                	je     8010720d <loaduvm+0x4d>
    pa = PTE_ADDR(*pte);
80107239:	8b 00                	mov    (%eax),%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
8010723b:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    if(sz - i < PGSIZE)
8010723e:	bf 00 10 00 00       	mov    $0x1000,%edi
    pa = PTE_ADDR(*pte);
80107243:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80107248:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
8010724e:	0f 46 fb             	cmovbe %ebx,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107251:	29 d9                	sub    %ebx,%ecx
80107253:	05 00 00 00 80       	add    $0x80000000,%eax
80107258:	57                   	push   %edi
80107259:	51                   	push   %ecx
8010725a:	50                   	push   %eax
8010725b:	ff 75 10             	push   0x10(%ebp)
8010725e:	e8 2d a8 ff ff       	call   80101a90 <readi>
80107263:	83 c4 10             	add    $0x10,%esp
80107266:	39 f8                	cmp    %edi,%eax
80107268:	75 1e                	jne    80107288 <loaduvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
8010726a:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80107270:	89 f0                	mov    %esi,%eax
80107272:	29 d8                	sub    %ebx,%eax
80107274:	39 c6                	cmp    %eax,%esi
80107276:	77 80                	ja     801071f8 <loaduvm+0x38>
}
...
80107298:	68 94 81 10 80       	push   $0x80108194
8010729d:	e8 de 90 ff ff       	call   80100380 <panic>
...
801072c4:	0f 88 b6 00 00 00    	js     80107380 <allocuvm+0xd0>
  if(newsz < oldsz)
801072ca:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
801072cd:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
801072d0:	0f 82 9a 00 00 00    	jb     80107370 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
801072d6:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
801072dc:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
801072e2:	39 75 10             	cmp    %esi,0x10(%ebp)
801072e5:	77 44                	ja     8010732b <allocuvm+0x7b>
801072e7:	e9 87 00 00 00       	jmp    80107373 <allocuvm+0xc3>
...
801072fb:	e8 00 d8 ff ff       	call   80104b00 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80107300:	58                   	pop    %eax
80107301:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80107307:	5a                   	pop    %edx
80107308:	6a 06                	push   $0x6
8010730a:	b9 00 10 00 00       	mov    $0x1000,%ecx
8010730f:	89 f2                	mov    %esi,%edx
80107311:	50                   	push   %eax
80107312:	89 f8                	mov    %edi,%eax
80107314:	e8 87 fb ff ff       	call   80106ea0 <mappages>
80107319:	83 c4 10             	add    $0x10,%esp
8010731c:	85 c0                	test   %eax,%eax
8010731e:	78 78                	js     80107398 <allocuvm+0xe8>
  for(; a < newsz; a += PGSIZE){
80107320:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107326:	39 75 10             	cmp    %esi,0x10(%ebp)
80107329:	76 48                	jbe    80107373 <allocuvm+0xc3>
    mem = kalloc();
8010732b:	e8 50 b3 ff ff       	call   80102680 <kalloc>
80107330:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80107332:	85 c0                	test   %eax,%eax
80107334:	75 ba                	jne    801072f0 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80107336:	83 ec 0c             	sub    $0xc,%esp
80107339:	68 11 81 10 80       	push   $0x80108111
8010733e:	e8 5d 93 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
80107343:	8b 45 0c             	mov    0xc(%ebp),%eax
80107346:	83 c4 10             	add    $0x10,%esp
80107349:	39 45 10             	cmp    %eax,0x10(%ebp)
8010734c:	74 32                	je     80107380 <allocuvm+0xd0>
8010734e:	8b 55 10             	mov    0x10(%ebp),%edx
80107351:	89 c1                	mov    %eax,%ecx
80107353:	89 f8                	mov    %edi,%eax
80107355:	e8 96 fa ff ff       	call   80106df0 <deallocuvm.part.0>
      return 0;
8010735a:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
...
8010736c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return oldsz;
80107370:	89 45 e4             	mov    %eax,-0x1c(%ebp)
}
80107373:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107376:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107379:	5b                   	pop    %ebx
8010737a:	5e                   	pop    %esi
8010737b:	5f                   	pop    %edi
8010737c:	5d                   	pop    %ebp
...
8010737e:	66 90                	xchg   %ax,%ax
    return 0;
80107380:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
80107387:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
8010739b:	68 29 81 10 80       	push   $0x80108129
801073a0:	e8 fb 92 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
801073a5:	8b 45 0c             	mov    0xc(%ebp),%eax
801073a8:	83 c4 10             	add    $0x10,%esp
801073ab:	39 45 10             	cmp    %eax,0x10(%ebp)
801073ae:	74 0c                	je     801073bc <allocuvm+0x10c>
801073b0:	8b 55 10             	mov    0x10(%ebp),%edx
801073b3:	89 c1                	mov    %eax,%ecx
801073b5:	89 f8                	mov    %edi,%eax
801073b7:	e8 34 fa ff ff       	call   80106df0 <deallocuvm.part.0>
      kfree(mem);
801073bc:	83 ec 0c             	sub    $0xc,%esp
801073bf:	53                   	push   %ebx
801073c0:	e8 fb b0 ff ff       	call   801024c0 <kfree>
      return 0;
801073c5:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
...
801073f0:	5d                   	pop    %ebp
801073f1:	e9 fa f9 ff ff       	jmp    80106df0 <deallocuvm.part.0>
...
8010742b:	e8 c0 f9 ff ff       	call   80106df0 <deallocuvm.part.0>
...
8010745e:	e8 5d b0 ff ff       	call   801024c0 <kfree>
80107463:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NPDENTRIES; i++){
80107466:	39 df                	cmp    %ebx,%edi
...
80107473:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107474:	e9 47 b0 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80107479:	83 ec 0c             	sub    $0xc,%esp
8010747c:	68 45 81 10 80       	push   $0x80108145
...
80107495:	e8 e6 b1 ff ff       	call   80102680 <kalloc>
...
801074b0:	e8 4b d6 ff ff       	call   80104b00 <memset>
...
801074c1:	ff 73 0c             	push   0xc(%ebx)
801074c4:	8b 13                	mov    (%ebx),%edx
...
8010751b:	a3 c4 58 11 80       	mov    %eax,0x801158c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010754c:	68 56 81 10 80       	push   $0x80108156
...
80107593:	0f 84 bd 00 00 00    	je     80107656 <copyuvm+0xd6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
801075c2:	68 60 81 10 80       	push   $0x80108160
...
801075ff:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107605:	e8 76 b0 ff ff       	call   80102680 <kalloc>
...
80107620:	e8 7b d5 ff ff       	call   80104ba0 <memmove>
...
80107650:	0f 87 5a ff ff ff    	ja     801075b0 <copyuvm+0x30>
  return d;
...
8010766c:	e8 4f ae ff ff       	call   801024c0 <kfree>
      goto bad;
...
8010767a:	e8 91 fd ff ff       	call   80107410 <freevm>
  return 0;
8010767f:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
80107697:	68 7a 81 10 80       	push   $0x8010817a
...
801076c4:	0f 84 00 01 00 00    	je     801077ca <uva2ka.cold>
  return &pgtab[PTX(va)];
...
801076d4:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
801076d9:	8b 84 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%eax
  if((*pte & PTE_U) == 0)
801076e0:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801076e2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
801076e7:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801076ea:	05 00 00 00 80       	add    $0x80000000,%eax
801076ef:	83 fa 05             	cmp    $0x5,%edx
801076f2:	ba 00 00 00 00       	mov    $0x0,%edx
801076f7:	0f 45 c2             	cmovne %edx,%eax
}
801076fa:	c3                   	ret    
...
80107716:	e9 a5 00 00 00       	jmp    801077c0 <copyout+0xc0>
...
80107732:	74 75                	je     801077a9 <copyout+0xa9>
      return -1;
    n = PGSIZE - (va - va0);
...
80107736:	89 55 10             	mov    %edx,0x10(%ebp)
    n = PGSIZE - (va - va0);
80107739:	29 c3                	sub    %eax,%ebx
8010773b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107741:	39 f3                	cmp    %esi,%ebx
80107743:	0f 47 de             	cmova  %esi,%ebx
    memmove(pa0 + (va - va0), buf, n);
80107746:	29 f8                	sub    %edi,%eax
80107748:	83 ec 04             	sub    $0x4,%esp
8010774b:	01 c1                	add    %eax,%ecx
8010774d:	53                   	push   %ebx
8010774e:	52                   	push   %edx
8010774f:	51                   	push   %ecx
80107750:	e8 4b d4 ff ff       	call   80104ba0 <memmove>
    len -= n;
    buf += n;
...
80107765:	74 59                	je     801077c0 <copyout+0xc0>
  if(*pde & PTE_P){
...
8010777d:	0f 84 4e 00 00 00    	je     801077d1 <copyout.cold>
  return &pgtab[PTX(va)];
...
8010779d:	83 e1 05             	and    $0x5,%ecx
801077a0:	83 f9 05             	cmp    $0x5,%ecx
801077a3:	0f 84 77 ff ff ff    	je     80107720 <copyout+0x20>
  }
  return 0;
}
801077a9:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
801077ac:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
801077b1:	5b                   	pop    %ebx
801077b2:	5e                   	pop    %esi
801077b3:	5f                   	pop    %edi
...
801077ca <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
801077ca:	a1 00 00 00 00       	mov    0x0,%eax
801077cf:	0f 0b                	ud2    

801077d1 <copyout.cold>:
801077d1:	a1 00 00 00 00       	mov    0x0,%eax
801077d6:	0f 0b                	ud2    
