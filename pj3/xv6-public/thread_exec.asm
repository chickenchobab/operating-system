   ...
   e:	31 db                	xor    %ebx,%ebx
{
  ...
  26:	8d 04 9d 78 0b 00 00 	lea    0xb78(,%ebx,4),%eax
  2d:	53                   	push   %ebx
  for (i = 0; i < NUM_THREAD; i++) {
...
00000070 <thread_main>:
{
  ...
  8c:	74 25                	je     b3 <thread_main+0x43>
    sleep(200);
  ...
  b6:	6a 64                	push   $0x64
  b8:	e8 16 03 00 00       	call   3d3 <sleep>
    printf(1, "Executing...\n");
  bd:	58                   	pop    %eax
  be:	5a                   	pop    %edx
  bf:	68 f7 07 00 00       	push   $0x7f7
  c4:	6a 01                	push   $0x1
    char *args[2] = {pname, 0};
  c6:	c7 45 f0 e9 07 00 00 	movl   $0x7e9,-0x10(%ebp)
  cd:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    printf(1, "Executing...\n");
  d4:	e8 d7 03 00 00       	call   4b0 <printf>
    exec(pname, args);
  d9:	59                   	pop    %ecx
  da:	58                   	pop    %eax
  db:	8d 45 f0             	lea    -0x10(%ebp),%eax
  de:	50                   	push   %eax
  df:	68 e9 07 00 00       	push   $0x7e9
  e4:	e8 92 02 00 00       	call   37b <exec>
  e9:	83 c4 10             	add    $0x10,%esp
  ec:	eb b0                	jmp    9e <thread_main+0x2e>
  ee:	66 90                	xchg   %ax,%ax
 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 439:	0f b6 92 b0 08 00 00 	movzbl 0x8b0(%edx),%edx
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 529:	ff 24 85 58 08 00 00 	jmp    *0x858(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 637:	90                   	nop
          s = "(null)";
 638:	ba 4f 08 00 00       	mov    $0x84f,%edx
        while(*s != 0){
