...
_yield_test:     file format elf32-i386
...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
    ...
    pid = fork();
   f:	e8 b7 02 00 00       	call   2cb <fork>
    if (pid < 0){
  14:	85 c0                	test   %eax,%eax
  16:	78 53                	js     6b <main+0x6b>
        printf(2, "Fork Failed!\n");
        exit();
    }
    else if (pid == 0) {
  18:	bb 64 00 00 00       	mov    $0x64,%ebx
  1d:	75 29                	jne    48 <main+0x48>
  1f:	90                   	nop
        for (int i = 0; i < LOOP_NUM; i ++){
            printf(1, "Child\n");
  20:	83 ec 08             	sub    $0x8,%esp
  23:	68 a6 07 00 00       	push   $0x7a6
  28:	6a 01                	push   $0x1
  2a:	e8 41 04 00 00       	call   470 <printf>
            yield();
  2f:	e8 4f 03 00 00       	call   383 <yield>
        for (int i = 0; i < LOOP_NUM; i ++){
  34:	83 c4 10             	add    $0x10,%esp
  37:	83 eb 01             	sub    $0x1,%ebx
  3a:	75 e4                	jne    20 <main+0x20>
            printf(1, "Parent\n");
            yield();
        }
        wait();   
    ...
    exit();
  3c:	e8 92 02 00 00       	call   2d3 <exit>
  41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            printf(1, "Parent\n");
  48:	83 ec 08             	sub    $0x8,%esp
  4b:	68 ad 07 00 00       	push   $0x7ad
  50:	6a 01                	push   $0x1
  52:	e8 19 04 00 00       	call   470 <printf>
            yield();
  57:	e8 27 03 00 00       	call   383 <yield>
        for (int i = 0; i < LOOP_NUM; i ++){
  5c:	83 c4 10             	add    $0x10,%esp
  5f:	83 eb 01             	sub    $0x1,%ebx
  62:	75 e4                	jne    48 <main+0x48>
        wait();   
  64:	e8 72 02 00 00       	call   2db <wait>
  69:	eb d1                	jmp    3c <main+0x3c>
        printf(2, "Fork Failed!\n");
  6b:	50                   	push   %eax
  6c:	50                   	push   %eax
  6d:	68 98 07 00 00       	push   $0x798
  72:	6a 02                	push   $0x2
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 bc 07 00 00 	jmp    *0x7bc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba b5 07 00 00       	mov    $0x7b5,%edx
        while(*s != 0){
 ...
 611:	a1 c0 0a 00 00       	mov    0xac0,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 c0 0a 00 00    	mov    %edx,0xac0
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 c0 0a 00 00    	mov    %edx,0xac0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d c0 0a 00 00    	mov    0xac0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d c0 0a 00 00    	mov    0xac0,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 c0 0a 00 00    	mov    0xac0,%edx
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf c4 0a 00 00       	mov    $0xac4,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 c8 0a 00 00 00 	movl   $0x0,0xac8
 782:	00 00 00 
    if(p->s.size >= nunits){
